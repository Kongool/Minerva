...
//
// Occult Crescent phantom-job ids and statuses. Pure data: modules name these to ask "is this player a
// Phantom Berserker", which changes who a mechanic should be baited onto. Ported whole rather than trimmed
// to the members currently referenced -- a partial enum is a trap, because the next module to name a
// missing member fails to compile for a reason that looks like a framework gap.
