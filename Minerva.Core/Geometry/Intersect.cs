...
public static class Intersect
{
    ...
    // RayPolygon is omitted: it takes a RelSimplifiedComplexPolygon, BossmodReborn's polygon-clipper type,
    // which Minerva does not have. Nothing in the ported tree calls it -- the ray casts that are used are
    // against circles, rects and lines below.
