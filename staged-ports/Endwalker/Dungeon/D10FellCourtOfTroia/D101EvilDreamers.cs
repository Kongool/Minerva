...
namespace Minerva.Endwalker.Dungeon.D10FellCourtOfTroia.D101EvilDreamers;
...
sealed class UniteMare1(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.UniteMare1, 6f, riskyWithSecondsLeft: 2.5d); // delay to improve melee greeding during enrage
sealed class UniteMare2(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.UniteMare2, 18f, riskyWithSecondsLeft: 5d);

sealed class UniteMare3(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class DarkVision1(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.DarkVision1, new AOEShapeRect(40f, 2.5f));
sealed class DarkVision2(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.DarkVision2, new AOEShapeRect(41f, 2.5f));
sealed class VoidGravity(ModuleBase module) : Components.SpreadFromCastTargets(module, (uint)AID.VoidGravity, 6f);
sealed class EndlessNightmare(ModuleBase module) : Components.CastHint(module, (uint)AID.EndlessNightmare, "Enrage!", true);

sealed class D101EvilDreamersStates : StateMachineBuilder
{
    public D101EvilDreamersStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 869u, NameID = 11382u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus, LTS) (ported from BMR)")]
public sealed class D101EvilDreamers(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
