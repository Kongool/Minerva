...
namespace Minerva.Endwalker.Dungeon.D10FellCourtOfTroia.D100TroianScavanger;
...
sealed class Condemnation(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Condemnation, new AOEShapeCone(6f, 45f.Degrees()));
sealed class EvilPhlegm(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.EvilPhlegm, 5f);
sealed class DarkArrivisme(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.DarkArrivisme, 5f);

sealed class D100TroianScavangerStates : StateMachineBuilder
{
    public D100TroianScavangerStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 869u, NameID = 11358u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class D100TroianScavanger(WorldState ws, Actor primary) : ModuleBase(ws, primary, IsArena1(primary) ? arena1.Center : arena2.Center, IsArena1(primary) ? arena1 : arena2)
{
