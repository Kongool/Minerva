...
class C032LalaStates : StateMachineBuilder
{
    ...
    public C032LalaStates(ModuleBase module, bool savage) : base(module)
    {
        _savage = savage;
...
class C032NLalaStates(ModuleBase module) : C032LalaStates(module, false);
class C032SLalaStates(ModuleBase module) : C032LalaStates(module, true);
