...
abstract class AzureAuspice(ModuleBase module, uint aid) : Components.SimpleAOEs(module, aid, new AOEShapeDonut(6f, 40f));
sealed class NAzureAuspice(ModuleBase module) : AzureAuspice(module, (uint)AID.NAzureAuspice);
sealed class SAzureAuspice(ModuleBase module) : AzureAuspice(module, (uint)AID.SAzureAuspice);

abstract class BoundlessAzure(ModuleBase module, uint aid) : Components.SimpleAOEs(module, aid, new AOEShapeRect(60f, 5f));
sealed class NBoundlessAzure(ModuleBase module) : BoundlessAzure(module, (uint)AID.NBoundlessAzureAOE);
sealed class SBoundlessAzure(ModuleBase module) : BoundlessAzure(module, (uint)AID.SBoundlessAzureAOE);
...
sealed class Upwell(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override ReadOnlySpan<AOEInstance> ActiveAOEs(int slot, Actor actor)
    {
        ...
        var imminentDeadline = World.FutureTime(5d);
    ...
    private void Advance(LineSequence line)
    {
        ...
        line.NextActivation = World.FutureTime(2d);
        var offset = (line.NextOrigin - Center).Abs();
