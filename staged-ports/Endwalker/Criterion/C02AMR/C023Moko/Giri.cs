...
sealed class TripleKasumiGiri(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnCastFinished(Actor caster, ActorCastInfo spell)
    {
        ...
        if (NumCasts < _directionOffsets.Count)
        {
            var activation = World.FutureTime(3.1d);
...
class IaiGiriBait : Components.GenericBaitAway
{
    ...
    public IaiGiriBait(ModuleBase module, float jumpOffset, float distance) : base(module)
    {
        Distance = distance;
    ...
    public override void OnTethered(Actor source, in ActorTetherInfo tether)
    {
        ...
        {
            InstanceFor(source).Target = World.Actors.Find(tether.Target);
            _baitsDirty = true;
        }
    }
...
sealed class IaiGiriResolve(ModuleBase module) : Components.GenericAOEs(module)
{
    public sealed class Instance(Actor source)
    {
        public Actor Source = source;
    ...
    public override void OnEventCast(Actor caster, ActorCastEvent spell)
    {
        switch (spell.Action.ID)
        {
            ...
            case (uint)AID.DoubleIaiGiri:
                ...
                var nextActivation = World.FutureTime(2.7d);
...
sealed class FleetingIaiGiriBait(ModuleBase module) : IaiGiriBait(module, 3f, 60f)
{
    public override void AddGlobalHints(GlobalHints hints)
    {
...
sealed class DoubleIaiGiriBait(ModuleBase module) : IaiGiriBait(module, 1f, 23f)
{
    public override void AddGlobalHints(GlobalHints hints)
    {
        var count = Instances.Count;
