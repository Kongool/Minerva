...
abstract class C023MokoStates : StateMachineBuilder
{
    ...
    public C023MokoStates(ModuleBase module, bool savage) : base(module)
    {
        _savage = savage;
...
sealed class C023NMokoStates(ModuleBase module) : C023MokoStates(module, false);
sealed class C023SMokoStates(ModuleBase module) : C023MokoStates(module, true);
