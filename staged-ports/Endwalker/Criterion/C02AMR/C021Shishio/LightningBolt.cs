...
abstract class LightningBolt(ModuleBase module, uint aid) : Components.SimpleAOEs(module, aid, 6f);
sealed class NLightningBolt(ModuleBase module) : LightningBolt(module, (uint)AID.NLightningBoltAOE);
sealed class SLightningBolt(ModuleBase module) : LightningBolt(module, (uint)AID.SLightningBoltAOE);

sealed class CloudToCloud(ModuleBase module) : Components.GenericAOEs(module)
{
