...
abstract class C013ShadowcasterStates : StateMachineBuilder
{
    ...
    public C013ShadowcasterStates(ModuleBase module, bool savage) : base(module)
    {
        _savage = savage;
...
sealed class C013NShadowcasterStates(ModuleBase module) : C013ShadowcasterStates(module, false);
sealed class C013SShadowcasterStates(ModuleBase module) : C013ShadowcasterStates(module, true);
