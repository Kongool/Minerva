...
sealed class FiresteelStrike : Components.UniformStackSpread
{
    ...
    public FiresteelStrike(ModuleBase module) : base(module, default, 10f)
    {
    ...
    public override void OnEventCast(Actor caster, ActorCastEvent spell)
    {
        switch (spell.Action.ID)
        {
            ...
            case (uint)AID.SFiresteelStrikeAOE2:
                if ((spell.Targets.Count > 0 ? World.Actors.Find(spell.Targets[0].ID) : null) is var target && target != null)
                {
