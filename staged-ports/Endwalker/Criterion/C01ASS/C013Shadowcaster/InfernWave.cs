...
abstract class InfernWave(ModuleBase module, bool savage, bool showHints, int maxActive) : Components.CastCounter(module, savage ? (uint)AID.SInfernWaveAOE : (uint)AID.NInfernWaveAOE)
{
    ...
    public override void Update()
    {
        ...
        {
            _beacons.Add(new(s, World.FutureTime(17.1d)));
        }
...
sealed class NInfernWave1(ModuleBase module) : InfernWave(module, false, false, 2);
sealed class SInfernWave1(ModuleBase module) : InfernWave(module, true, false, 2);
sealed class NInfernWave2(ModuleBase module) : InfernWave(module, false, true, 1);
sealed class SInfernWave2(ModuleBase module) : InfernWave(module, true, true, 1);
