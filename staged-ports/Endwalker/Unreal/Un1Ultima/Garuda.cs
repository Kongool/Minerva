...
class Garuda(ModuleBase module) : ModuleComponent(module)
{
    ...
    public override void AddHints(int slot, Actor actor, TextHints hints)
    {
        ...
        {
            var adjPos = _vulcanBurstImminent ? ClampToBounds(Components.GenericKnockback.AwayFromSource(actor.Position, _mistralSong, 30)) : actor.Position;
    ...
    {
        var adjPos = _vulcanBurstImminent ? ClampToBounds(Components.GenericKnockback.AwayFromSource(pc.Position, _mistralSong, 30)) : pc.Position;
