...
{
    public UpwellFirst(ModuleBase module) : base(module, (uint)AID.UpwellFirst, new AOEShapeRect(60f, 5f))
    {
        Color = Colors.Danger;
    }
}

sealed class UpwellRest(ModuleBase module) : Components.Exaflare(module, new AOEShapeRect(30f, 2.5f, 30f))
{
    ...
    public override void OnCastStarted(Actor caster, ActorCastInfo spell)
    {
        if (spell.Action.ID == (uint)AID.UpwellFirst)
        {
            ...
            var check = pos.AlmostEqual(Center, 1f);
