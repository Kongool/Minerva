...
sealed class ArcaneFont(ModuleBase module) : Components.GenericAOEs(module)
{
    private readonly List<AOEInstance> _aoes = [];
    private static readonly AOEShapeRect rect = new(100f, 5f);
    private readonly List<Actor> cachedPortals = [];
    private readonly List<Actor> fireballs = [];
    ...
    public override void OnActorCreated(Actor actor)
    {
        switch (actor.OID)
        {
            case (uint)OID.ArcaneFont:
                ...
                _aoes.Add(new(rect, (actor.Position - 50f * rot.Round(90f).ToDirection()).Quantized(), rot, World.FutureTime(countP == 0 ? 10.1d : 12.8d)));
                break;
            ...
            case (uint)OID.Portal:
                ...
                if (count != 0)
                {
                    ...
                    var act = World.FutureTime(12.5d);
