...
class ClassicalConcepts(ModuleBase module, bool invert) : ModuleComponent(module)
{
...
class ClassicalConcepts1(ModuleBase module) : ClassicalConcepts(module, false);
class ClassicalConcepts2(ModuleBase module) : ClassicalConcepts(module, true);

class Implode(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Implode, 4f);

class PalladianRayBait(ModuleBase module) : Components.GenericBaitAway(module, (uint)AID.PalladianRayAOEFirst)
{
...
class PalladianRayAOE(ModuleBase module) : Components.GenericAOEs(module, (uint)AID.PalladianRayAOERest)
{
