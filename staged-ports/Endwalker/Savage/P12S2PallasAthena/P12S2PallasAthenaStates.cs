...
{
    public P12S2PallasAthenaStates(ModuleBase module) : base(module)
    {
    ...
    private void Gaiaochos1(uint id, float delay)
    {
        Cast(id, (uint)AID.Gaiaochos, delay, 7, "Raidwide + small arena 1 start")
            ...
            .OnExit(() => (Module.Center, Module.Bounds) = (new(100, 90), P12S2PallasAthena.SmallBounds))
            .SetHint(StateMachine.StateHint.Raidwide);
        ...
        ComponentCondition<GaiaochosEnd>(id + 0x210, 2.2f, comp => comp.Finished, "Small arena 1 resolve")
            ...
            .OnExit(() => (Module.Center, Module.Bounds) = (new(100, 95), P12S2PallasAthena.DefaultBounds));
    }
