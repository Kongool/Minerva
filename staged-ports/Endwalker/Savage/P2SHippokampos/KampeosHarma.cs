...
class KampeosHarma(ModuleBase module) : Components.CastCounter(module, (uint)AID.KampeosHarmaChargeBoss)
{
    ...
    public override void OnEventIcon(Actor actor, uint iconID, ulong targetID)
    {
        ...
        {
            _startingOffset = Module.PrimaryActor.Position - Center;
