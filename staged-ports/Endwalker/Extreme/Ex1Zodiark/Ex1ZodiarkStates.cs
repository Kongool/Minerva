...
{
    public Ex1ZodiarkStates(ModuleBase module) : base(module)
    {
    ...
    private State AstralFlow(uint id, float delay)
    {
        ...
        return Condition(id + 0x10, 6.2f, () => Module.World.Party.WithoutSlot(false, true, true).All(a => a.FindStatus(SID.TenebrousGrasp) == null), "Rotate resolve", 5, 1)
