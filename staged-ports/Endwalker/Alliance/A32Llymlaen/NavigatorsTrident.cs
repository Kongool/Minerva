...
sealed class DireStraits(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class NavigatorsTridentAOE(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.NavigatorsTridentAOE, new AOEShapeRect(40f, 5f));

sealed class NavigatorsTridentKnockback(ModuleBase module) : Components.GenericKnockback(module)
{
        ...
        if (_sources.Count != 0)
        {
            ...
            if (!IsImmune(slot, act))
            {
                if (_serpentsTide != null && _serpentsTide.AOEs.Count != 0)
                {
                    ...
                    hints.AddForbiddenZone(new SDKnockbackInAABBRectLeftRightAlongZAxisPlusAOERects(Center, 20f, 19f, 28f, rects, 80f, 10f, len), act);
                }
                else
                {
                    hints.AddForbiddenZone(new SDKnockbackInAABBRectLeftRightAlongZAxis(Center, 20f, 19f, 28f), act);
                }
            }
        }
    }
