...
abstract class SolarWings(ModuleBase module, uint aid) : Components.SimpleAOEs(module, aid, new AOEShapeCone(30f, 75f.Degrees()));
sealed class SolarWingsL(ModuleBase module) : SolarWings(module, (uint)AID.SolarWingsL);
sealed class SolarWingsR(ModuleBase module) : SolarWings(module, (uint)AID.SolarWingsR);

sealed class SolarFlair(ModuleBase module) : Components.GenericAOEs(module)
{
