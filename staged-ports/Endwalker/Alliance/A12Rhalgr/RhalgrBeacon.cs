...
sealed class RhalgrBeaconAOE(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.RhalgrsBeaconAOE, 10f);

sealed class RhalgrBeaconShock(ModuleBase module) : Components.GenericAOEs(module, (uint)AID.Shock)
{
    ...
    public override void OnActorCreated(Actor actor)
    {
        ...
        {
            _aoes.Add(new(_shape, actor.Position.Quantized(), default, World.FutureTime(12.7d), actorID: actor.InstanceID));
        }
    }
...
sealed class RhalgrBeaconKnockback(ModuleBase module) : Components.GenericKnockback(module, (uint)AID.RhalgrsBeaconKnockback, stopAfterWall: true)
{
