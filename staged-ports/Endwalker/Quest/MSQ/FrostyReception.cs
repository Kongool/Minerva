...
namespace Minerva.Endwalker.Quest.MSQ.AFrostyReception;
...
class GigaTempest(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.GigaTempest);
class Ruination(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Ruination1, new AOEShapeCross(40f, 4f));
class Ruination2(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Ruination2, new AOEShapeRect(30f, 4f));
class ResinBomb(ModuleBase module) : Components.SpreadFromCastTargets(module, (uint)AID.ResinBomb, 5f);
class MagitekCannon(ModuleBase module) : Components.SpreadFromCastTargets(module, (uint)AID.MagitekCannon, 6f);
class Bombardment(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Bombardment, 6f);

class LockOn(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnActorCreated(Actor actor)
    {
        if (actor.OID == (uint)OID.LockOn)
            _casters.Add((actor, World.FutureTime(6.6d)));
    }
...
{
    public VergiliaVanCorculumStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.Quest, CFCID = 69919u, NameID = 10572u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "ported from BossmodReborn")]
public class VergiliaVanCorculum(WorldState ws, Actor primary) : ModuleBase(ws, primary, arenaCenter, arena)
{
