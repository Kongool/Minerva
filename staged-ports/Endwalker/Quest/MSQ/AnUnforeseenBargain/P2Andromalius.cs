...
namespace Minerva.Endwalker.Quest.MSQ.AnUnforeseenBargain.P2Andromalius;
...
sealed class Voidblood(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Voidblood, 6f);
sealed class VoidSlash(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.VoidSlash, new AOEShapeCone(9.7f, 45f.Degrees()));
sealed class EvilMist(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.EvilMist);
sealed class VoidEvocation(ModuleBase module) : Components.RaidwideInstant(module, (uint)AID.VoidEvocation, 5.1d)
{
...
sealed class Explosion(ModuleBase module) : Components.CastTowers(module, (uint)AID.Explosion, 5f);
sealed class Dark(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Dark, 10f);
sealed class Hellsnap(ModuleBase module) : Components.StackWithCastTargets(module, (uint)AID.Hellsnap, 6f);

sealed class StraightSpindle(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class Decay(ModuleBase module) : Components.CastHint(module, (uint)AID.Decay, "Kill the Voidskipper!", true)
{
...
sealed class ProtectZero(ModuleBase module) : ModuleComponent(module)
{
    public override void AddAIHints(int slot, Actor actor, PartyRolesConfig.Assignment assignment, AIHints hints)
    {
...
{
    public AndromaliusStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 70209u, NameID = 12071u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "ported from BossmodReborn")]
public sealed class Andromalius(WorldState ws, Actor primary) : ModuleBase(ws, primary, P1Furcas.Furcas.ArenaBounds.Center, P1Furcas.Furcas.ArenaBounds)
{
