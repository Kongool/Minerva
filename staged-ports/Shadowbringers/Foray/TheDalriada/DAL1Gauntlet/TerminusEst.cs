...
sealed class TerminusEst(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class TerminusEstUnseen(ModuleBase module) : Components.CastWeakpoint(module, (uint)AID.TerminusEst, TerminusEst.Rect, default, (uint)SID.BackUnseen, (uint)SID.LeftUnseen, (uint)SID.RightUnseen)
{
