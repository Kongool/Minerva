...
sealed class Stormcall(ModuleBase module) : Components.GenericAOEs(module, (uint)AID.Stormcall)
{
    ...
    public override void OnTethered(Actor source, in ActorTetherInfo tether)
    {
        ...
        {
            AOEs.Add(new(circle, (source.Position + 48f * source.Rotation.ToDirection()).Quantized(), default, World.FutureTime(source.OID == (uint)OID.VorticalOrb ? 20.9d : 13.7d), actorID: source.InstanceID));
            if (AOEs.Count > 1)
            {
