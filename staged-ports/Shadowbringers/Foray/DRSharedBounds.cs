...
namespace Minerva.Shadowbringers.Foray.DelubrumReginae;

public abstract class TrinitySeeker : ModuleBase
{
...
public abstract class Dahu : ModuleBase
{
...
public abstract class QueensGuard : ModuleBase
{
...
public abstract class Phantom(WorldState ws, Actor primary) : ModuleBase(ws, primary, new(202f, -374f), new ArenaBoundsRect(23.5f, 29.5f))
{
    public static AOEShapeCustom GetArenaChangeAOE()
    {
        return new AOEShapeCustom(new WPos(202f, -374f), [new Rectangle(new(202f, -374f), 24f, 30f)], [new Rectangle(new(202f, -370f), 24f, 24f)]);
    }
}

public abstract class TrinityAvowed(WorldState ws, Actor primary) : ModuleBase(ws, primary, new(-272f, -82f), new ArenaBoundsSquare(29.5f))
{
    public static AOEShapeCustom GetArenaChangeAOE()
    {
...
public abstract class Queen(WorldState ws, Actor primary) : ModuleBase(ws, primary, new(-272f, -415f), new ArenaBoundsSquare(29.5f))
{
