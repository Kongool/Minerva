...
abstract class FeralHowlHystericAssault(ModuleBase module, uint aidCast, uint aidAOE, double delay) : Components.GenericKnockback(module, aidAOE, stopAtWall: true)
{
...
sealed class FeralHowl(ModuleBase module) : FeralHowlHystericAssault(module, (uint)AID.FeralHowl, (uint)AID.FeralHowlAOE, 2.1d);
sealed class HystericAssault(ModuleBase module) : FeralHowlHystericAssault(module, (uint)AID.HystericAssault, (uint)AID.HystericAssaultAOE, 0.9d);
