...
abstract class Chess(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class QueensEdict(ModuleBase module) : Chess(module)
{
    ...
    private WPos CellCenter((int x, int z) cell) => Center + 10 * new WDir(cell.x, cell.z);
