...
sealed class ScarletPlumeTailFeather(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    private readonly List<WPos> plumeCache = [];
    ...
    public override void AddAIHints(int slot, Actor actor, PartyRolesConfig.Assignment assignment, AIHints hints)
    {
        ...
        if (_spread.IsSpreadTarget(actor))
        {
            ...
            {
                hints.GoalZones.Add(AIHints.GoalProximity(Center, 7.12f, 100f));
            }
        }
