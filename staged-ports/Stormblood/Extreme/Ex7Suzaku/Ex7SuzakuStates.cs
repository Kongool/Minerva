...
{
    public Ex7SuzakuStates(ModuleBase module) : base(module)
    {
    ...
    private void LimitBreakPhase(uint id, float delay)
    {
        ...
        ActorCast(id + 0x30u, () => Helper(Module), (uint)AID.ScarletFever, 4.9f, 7f, true, "Raidwide")
            ...
            .SetHint(StateMachine.StateHint.Raidwide);
        static Actor? Helper(ModuleBase module)
        {
        ...
        Condition(id + 0x40u, 0.7f, () => Module.Bounds == Ex7Suzaku.Phase2Bounds, "Donut arena")
