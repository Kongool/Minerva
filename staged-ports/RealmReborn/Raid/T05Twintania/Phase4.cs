...
// P4 mechanics
class P4Twisters(ModuleBase module) : ModuleComponent(module)
{
...
class P4Dreadknights(ModuleBase module) : ModuleComponent(module)
{
    ...
    public override void OnEventCast(Actor caster, ActorCastEvent spell)
    {
        if ((AID)spell.Action.ID == AID.UnwovenWill)
            _target = World.Actors.Find(spell.MainTargetID);
    }
}

class P4AI(ModuleBase module) : ModuleComponent(module)
{
