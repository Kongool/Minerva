...
// P1 mechanics
class P1LiquidHellAdds(ModuleBase module) : Components.VoidzoneAtCastTarget(module, 6, (uint)AID.LiquidHellAdds, m => m.Enemies((uint)OID.LiquidHell).Where(z => z.EventState != 7), 0); // note: voidzone appears ~1.2s after cast ends, but we want to try avoiding initial damage too
...
class P1AI(ModuleBase module) : ModuleComponent(module)
{
