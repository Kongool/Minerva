...
[ModuleInfo(Group = ModuleGroup.ForayFATE, CFCID = 1093u, NameID = 2084u, PrimaryActorOID = (uint)OID.Cresceregina, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Equilius (ported from BMR)")]
[SkipLocalsInit]
