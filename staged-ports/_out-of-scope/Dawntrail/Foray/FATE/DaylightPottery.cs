...
[ModuleInfo(Group = ModuleGroup.ForayFATE, CFCID = 1093u, NameID = 2072u, PrimaryActorOID = (uint)OID.CrimsonGremlin, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = " (ported from BMR)")]
[SkipLocalsInit]
