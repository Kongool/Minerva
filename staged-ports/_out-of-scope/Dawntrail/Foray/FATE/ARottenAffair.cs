...
[ModuleInfo(Group = ModuleGroup.ForayFATE, CFCID = 1093u, NameID = 2081u, PrimaryActorOID = (uint)OID.PatientKuribu, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Equilius (ported from BMR)")]
[SkipLocalsInit]
