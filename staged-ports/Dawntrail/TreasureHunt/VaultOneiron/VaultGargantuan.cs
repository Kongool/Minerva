...
namespace Minerva.Dawntrail.TreasureHunt.VaultOneiron.VaultGargantuan;
...
sealed class MoltenSilk(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.MoltenSilk1, (uint)AID.MoltenSilk2], new AOEShapeCone(9f, 135f.Degrees()));
sealed class FlyingPress(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.FlyingPress, 6f);
...
sealed class Mash(ModuleBase module) : Components.SingleTargetDelayableCast(module, (uint)AID.Mash);
sealed class Brushfire(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.Brushfire);
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 1060u, CFCID = 1060u, NameID = 13986u, PrimaryActorOID = (uint)OID.VaultCrab, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
