...
sealed class ForwardBackwardHalf(ModuleBase module) : Components.GenericAOEs(module, (uint)AID.HalfFullShortAOE)
{
...
sealed class HalfFull(ModuleBase module) : Components.GenericAOEs(module, (uint)AID.HalfFullLongAOE)
{
    private readonly List<AOEInstance> _aoes = [];
