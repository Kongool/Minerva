...
sealed class TyrannysGraspAOE(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.TyrannysGraspAOE, new AOEShapeRect(20f, 20f));

sealed class TyrannysGraspTowers(ModuleBase module) : Components.GenericTowers(module)
{
