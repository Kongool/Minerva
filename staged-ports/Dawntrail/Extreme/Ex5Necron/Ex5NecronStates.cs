...
sealed class Ex5NecronStates : StateMachineBuilder
{
    ...
    public Ex5NecronStates(Ex5Necron module) : base(module)
    {
        bool IsWipedOrLeftRaid()
        {
            ...
            return (wipe?.Wiped ?? false) || module.World.CurrentCFCID != 1062u;
        }
    ...
    private void MementoMori(uint id, float delay)
    {
        ...
        ComponentCondition<MementoMori>(id + 0x10u, 1.1f, comp => Module.Bounds is not ArenaBoundsRect, "Arena split");
        ...
        ComponentCondition<MementoMori>(id + 0x40u, 4f, comp => Module.Bounds is ArenaBoundsRect, "Restore arena")
    ...
    private void GrandCross(uint id, float delay)
    {
        ...
        ComponentCondition<GrandCrossArenaChange>(id + 0x10u, 1.1f, comp => Module.Bounds is not ArenaBoundsRect, "Arena change")
        ...
        ComponentCondition<NeutronRing>(id + 0x100u, 12.5f, comp => comp.NumCasts != 0, "Raidwide + restore Arena")
            ...
            .SetHint(StateMachine.StateHint.Raidwide)
            .OnEnter(() => Module.Bounds = new ArenaBoundsRect(18f, 15f))
    ...
    private void MassMacabre(uint id, float delay)
    {
        ...
        ComponentCondition<MementoMori>(id + 0x10u, 6f, comp => comp.NumCasts != 0, "Line AOE")
            ...
            .ActivateOnEnter<MementoMori>();
        ComponentCondition<MementoMori>(id + 0x20u, 1.1f, comp => Module.Bounds is not ArenaBoundsRect, "Arena split");
        ...
        ComponentCondition<ChokingGraspMM>(id + 0x40u, 1.5f, comp => comp.NumCasts != 0, "Line AOEs")
            .DeactivateOnExit<ChokingGraspMM>();
        ComponentCondition<MementoMori>(id + 0x50u, 5f, comp => Module.Bounds is ArenaBoundsRect, "Restore arena")
            .DeactivateOnExit<MementoMori>();
