...
sealed class MementoMori(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnMapEffect(byte index, uint state)
    {
        if (index == 0x18)
        {
            ...
            {
                Bounds = Trial.T05Necron.Necron.SplitArena;
                _aoe = [];
            }
...
sealed class SmiteOfGloom(ModuleBase module) : Components.GenericStackSpread(module, true, true)
{
    public int NumCasts;
...
sealed class ChokingGraspMM(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnActorCreated(Actor actor)
    {
        ...
        {
            _aoes.Add(new(ChokingGrasp.Rect, actor.Position.Quantized(), actor.Rotation, World.FutureTime(11.1d), risky: isRisky));
        }
    }
