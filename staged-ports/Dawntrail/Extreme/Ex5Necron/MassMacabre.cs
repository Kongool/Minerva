...
sealed class MassMacabre(ModuleBase module) : Components.GenericTowers(module)
{
    ...
    private void AddTower(WPos pos, int soakers, ulong index, double delay) => Towers.Add(new(pos.Quantized(), 3f, soakers, soakers, activation: World.FutureTime(delay), actorID: index));
