...
sealed class WyvernsRadianceRush(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class WyvernsRadianceConcentric(ModuleBase module) : Components.ConcentricAOEs(module,
