...
sealed class WyvernsRadianceExaflare1(ModuleBase module) : Components.Exaflare(module, new AOEShapeRect(8f, 20f))
{
...
sealed class WyvernsRadianceExaflare2(ModuleBase module) : Components.GenericAOEs(module)
{
