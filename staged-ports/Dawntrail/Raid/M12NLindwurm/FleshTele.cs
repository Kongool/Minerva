...
sealed class FleshTele(ModuleBase module) : Components.GenericKnockback(module, stopAfterWall: true)
{
    ...
    public override void AddAIHints(int slot, Actor actor, PartyRolesConfig.Assignment assignment, AIHints hints)
    {
        ...
        Bounds.Shape.AddForbiddenDirections(actor.Position - Center, forwardKb[slot] ? default : 180f.Degrees(), hints, _activation, 15f, 1f);
