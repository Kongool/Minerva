...
[SkipLocalsInit]
sealed class BurstingGrotesquerie(ModuleBase module) : Components.SpreadFromIcon(module, (uint)IconID.SpreadBurstingGrotesquerie, (uint)AID.DramaticLysis, 5f, 5d)
{
...
sealed class SharedGrotesquerie(ModuleBase module) : Components.StackWithIcon(module, (uint)IconID.SharedGrotesquerie, (uint)AID.FourthWallFusion, 6f, 5d);
sealed class DirectedGrotesquerie(ModuleBase module) : Components.GenericBaitAway(module, centerAtTarget: true)
{
    ...
    public override void OnEventIcon(Actor actor, uint iconID, ulong targetID)
    {
        if (iconID == (uint)IconID.Countdown)
        {
            ...
            CurrentBaits.Add(new(actor, actor, cone, World.FutureTime(5.5d)));
        }
    }
