...
[ModuleInfo(Group = ModuleGroup.TheForkedTowerMagic, CFCID = 1114u, NameID = 14717u, PrimaryActorOID = (uint)OID.Index, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = " (ported from BMR)")]
[SkipLocalsInit]
public sealed class FTME4Index(WorldState ws, Actor primary) : ModuleBase(ws, primary, InitialCenter, InitialBounds)
{
    ...
    protected override bool CheckPull() => base.CheckPull() && Raid.Player()!.Position.InCircle(Module.Center, 28f);
}
