...
namespace Minerva.Dawntrail.Foray.FATE.KingOfTheCrescent;
...
sealed class GlidingSwoop(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.GlidingSwoop, 25f);
...
sealed class FeatherRain(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.FeatherRain, 11f);

sealed class Airburst(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnActorCreated(Actor actor)
    {
        ...
        {
            _aoes.Add(new(circle, actor.Position.Quantized(), default, World.FutureTime(9.8d), actorID: actor.InstanceID));
        }
    }
...
{
    public KingOfTheCrescentStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.ForayFATE, CFCID = 1018u, NameID = 1964u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
