...
sealed class ElementalImpact(ModuleBase module) : Components.GenericTowersOpenWorld(module)
{
...
sealed class FireSpread(ModuleBase module) : Components.GenericBaitAway(module)
{
    private static readonly AOEShapeCone cone = new(60f, 60f.Degrees());
    private readonly List<(WPos, DateTime)> towerPositions = [];
...
sealed class PhaseChange(ModuleBase module) : ModuleComponent(module)
{
