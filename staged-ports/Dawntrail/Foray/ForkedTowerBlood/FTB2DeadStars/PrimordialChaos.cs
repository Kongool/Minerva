...
sealed class PrimordialChaos(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    private readonly List<Polygon> circlesRed = [], circlesBlue = [];
    ...
    private void InitIfReady()
    {
        ...
        {
            var act = World.FutureTime(NumCasts == 0 ? 9d : 5.6d);
            var center = Center;
