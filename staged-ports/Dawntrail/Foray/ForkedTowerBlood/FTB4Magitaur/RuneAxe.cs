...
sealed class RuneAxeStatus(ModuleBase module) : ModuleComponent(module)
{
...
sealed class RuneAxeAOEs(ModuleBase module) : Components.GenericAOEs(module)
{
    private readonly RuneAxeStatus _status = module.FindComponent<RuneAxeStatus>()!;
    private AOEInstance[] _aoePrepare = [];
    private readonly List<AOEInstance>[] _aoeHintsForStatus = [[], [], [], []];
    private readonly List<AOEInstance>[] _aoeHintsNoStatus = [[], []];
...
sealed class RuneAxeSmallSpreadAOEs(ModuleBase module) : Components.GenericAOEs(module)
{
    private readonly RuneAxeStatus _status = module.FindComponent<RuneAxeStatus>()!;
    public bool Show = true;
