...
namespace Minerva.Endwalker.DeepDungeon.PilgrimsTraverse.DD30ForgivenTreachery;
...
[SkipLocalsInit]
sealed class BoundsOfIndulgence(ModuleBase module) : Components.GenericAOEs(module)
{
...
[SkipLocalsInit]
sealed class DivineFavor(ModuleBase module) : Components.StandardChasingAOEs(module, 4f, (uint)AID.DivineFavorFirst, (uint)AID.DivineFavorRest, 3.5f, 0.6d, 8, true, (uint)IconID.DivineFavor);

[SkipLocalsInit]
sealed class GripOfSalvationsReach(ModuleBase module) : Components.GenericAOEs(module)
{
    private readonly List<AOEInstance> _aoes = [];
...
{
    public DD30ForgivenTreacheryStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 1034u, NameID = 13863u, PrimaryActorOID = (uint)OID.ForgivenTreachery, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
[SkipLocalsInit]
public sealed class DD30ForgivenTreachery : ModuleBase
{
