...
namespace Minerva.Endwalker.DeepDungeon.PilgrimsTraverse.DD70ForgivenZeal;
...
[SkipLocalsInit]
sealed class BrutalHalo(ModuleBase module) : Components.GenericAOEs(module)
{
...
{
    public ZealousGlower(ModuleBase module) : base(module, [(uint)AID.ZealousGlower1, (uint)AID.ZealousGlower2,(uint)AID.ZealousGlower3, (uint)AID.ZealousGlower4,
...
{
    public ArdorousEye(ModuleBase module) : base(module, [(uint)AID.ArdorousEye1, (uint)AID.ArdorousEye2,(uint)AID.ArdorousEye3, (uint)AID.ArdorousEye4,
...
[SkipLocalsInit]
sealed class DisorientingGroan(ModuleBase module) : Components.SimpleKnockbacks(module, (uint)AID.DisorientingGroan, 7f)
{
...
[SkipLocalsInit]
sealed class TwothousandMinaSwing(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.TwothousandMinaSwing, 8f);

[SkipLocalsInit]
sealed class DD70ForgivenZealStates : StateMachineBuilder
{
    public DD70ForgivenZealStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 1038u, CFCID = 1038u, NameID = 13971u, PrimaryActorOID = (uint)OID.ForgivenZeal, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
[SkipLocalsInit]
public sealed class DD70ForgivenZeal(WorldState ws, Actor primary) : ModuleBase(ws, primary, arenaCenter, new ArenaBoundsCustom([new Polygon(arenaCenter, 10.0015f, 72)]))
{
