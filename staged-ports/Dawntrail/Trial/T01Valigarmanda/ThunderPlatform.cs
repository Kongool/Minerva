...
sealed class BlightedBolt1(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class BlightedBolt2(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.BlightedBolt2, 7f);
