 ...
 */
class CarGeometry : ModuleComponent
{
    public int Car
    {
        get => field;
    ...
    public CarGeometry(ModuleBase module) : base(module)
    {
    ...
    void Car3()
    {
        ...
        Center = carThreeCenter;
        Bounds = carThreeOutline;
    }

    void Car4()
    {
        Bounds = new ArenaBoundsRect(10f, 14.6f);
        Center = new(100f, 250f);
    }
    ...
    void Car5()
    {
        ...
        Center = carFiveCenter;
        Bounds = carFiveOutline;
    }
}
