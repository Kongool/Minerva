...
sealed class ChokingGrasp(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnActorCreated(Actor actor)
    {
        ...
        {
            _aoes.Add(new(rect, actor.Position.Quantized(), actor.Rotation, World.FutureTime(fearOfDeath ? 13.7d : 11.1d)));
        }
    }
