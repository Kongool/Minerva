...
class SeaShackles(ModuleBase module) : Components.StretchTetherDuo(module, minimumDistance: 16f, activationDelay: 28f, tetherIDBad: (uint)TetherID.Far, tetherIDGood: (uint)TetherID.Safe)
{
    public override void OnTethered(Actor source, in ActorTetherInfo tether)
    {
        ...
        {
            ActivationDelayOnActor.Add((player, World.FutureTime(ActivationDelay)));
        }
...
class HydrobulletStack(ModuleBase module) : Components.UniformStackSpread(module, 15, 0, 1)
{
