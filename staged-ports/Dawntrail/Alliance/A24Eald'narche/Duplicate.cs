...
sealed class Duplicate(ModuleBase module) : Components.GenericAOEs(module)
{
            ...
            case >= 0x35 and <= 0x3D:
                switch (state)
                {
                    ...
                    case 0x00020001u:
                        ...
                        _aoes.Add(new(Rect, new WPos(784f + tile3 % 3 * 16f, -816f + tile3 / 3 * 16f) + new WDir(default, -8f), default, World.FutureTime(7.8d)));
                        break;
                }
                break;
    ...
    private void AddAOEs(int row, int col)
    {
        ...
        for (var i = 0; i < 5; ++i)
        {
            ...
            {
                _aoes.Add(new(Rect, (new WPos(784f + nCol * 16f, -816f + nRow * 16f) + new WDir(default, -8f)).Quantized(), Angle.AnglesCardinals[1], World.FutureTime(phase2 ? 11.1d : 10.4d)));
            }
        }
    }
}
