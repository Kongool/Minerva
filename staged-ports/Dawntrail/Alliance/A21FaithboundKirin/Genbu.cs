...
sealed class MoontideFont(ModuleBase module) : Components.SimpleAOEGroupsByTimewindow(module, [(uint)AID.MoontideFont1, (uint)AID.MoontideFont2], 9f);

sealed class MidwinterMarchNorthernCurrent(ModuleBase module) : Components.ConcentricAOEs(module, _shapes)
{
    ...
    public override void OnCastFinished(Actor caster, ActorCastInfo spell)
    {
        if (Sequences.Count != 0)
        {
            ...
            AdvanceSequence(order, spell.LocXZ, World.FutureTime(5d));
        }
    }
