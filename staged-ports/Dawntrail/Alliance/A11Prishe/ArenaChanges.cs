...
sealed class ArenaChanges(ModuleBase module) : Components.GenericAOEs(module, (uint)AID.Thornbite)
{
    public bool Active => _aoe.Length != 0 || Bounds is not ArenaBoundsSquare;
    ...
    public override void OnMapEffect(byte index, uint state)
    {
        ...
        {
            case 0x00020001u:
                SetAOE(new(Center, GetDefaultSquare(), GetDifferenceENVC00020001()));
                break;
            case 0x02000100u:
                SetAOE(new(Center, GetDefaultSquare(), GetDifferenceENVC02000100()));
                break;
            case 0x00200010u:
            ...
            case 0x00080004u or 0x00800004u:
                Bounds = new ArenaBoundsSquare(35f);
                break;
        }
        ...
        void SetAOE(AOEShapeCustom shape) => _aoe = [new(shape, Center, default, World.FutureTime(5d), shapeDistance: shape.Distance(Center, default))];
    }
...
sealed class CrystallineThornsHint(ModuleBase module) : Components.GenericAOEs(module)
{
    private AOEInstance[] _aoe = [];
    ...
    public override void OnMapEffect(byte index, uint state)
    {
        ...
        {
            case 0x00020001u:
                SetAOE(new(Center, ArenaChanges.GetMiddleENVC00020001(), invertForbiddenZone: true));
                break;
            case 0x02000100u:
                SetAOE(new(Center, ArenaChanges.GetMiddleENVC02000100(), invertForbiddenZone: true));
                break;
            case 0x00200010u:
            case 0x08000400u:
                _aoe = [];
        ...
        void SetAOE(AOEShapeCustom shape) => _aoe = [new(shape, Center, default, World.FutureTime(5d), Colors.SafeFromAOE, shapeDistance: shape.Distance(Center, default))];
    }
