...
sealed class LightningStorm(ModuleBase module) : Components.BaitAwayIcon(module, 8f, (uint)IconID.LightningStorm, (uint)AID.LightningStorm, 9.1f);

sealed class LightningStormHint(ModuleBase module) : Components.GenericAOEs(module)
{
