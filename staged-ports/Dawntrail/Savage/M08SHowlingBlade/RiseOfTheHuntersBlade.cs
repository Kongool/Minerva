...
sealed class ProwlingGaleLast(ModuleBase module) : Components.GenericTowers(module, (uint)AID.ProwlingGaleLast1)
{
...
sealed class LamentOfTheCloseDistant(ModuleBase module) : ModuleComponent(module)
{
    private readonly M08SHowlingBladeConfig _config = Service.Config.Get<M08SHowlingBladeConfig>();
