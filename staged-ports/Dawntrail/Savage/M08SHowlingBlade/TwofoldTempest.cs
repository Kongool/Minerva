...
sealed class TwofoldTempestVoidzone(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class TwofoldTempestTetherAOE(ModuleBase module) : Components.InterceptTetherAOE(module, (uint)AID.TwofoldTempestCircle, (uint)TetherID.TwofoldTempest, 6f)
{
...
sealed class TwofoldTempestTetherVoidzone(ModuleBase module) : Components.InterceptTetherAOE(module, (uint)AID.TwofoldTempestCircle, (uint)TetherID.TwofoldTempest, 9f)
{
    public override void AddHints(int slot, Actor actor, TextHints hints) { }
    public override void AddAIHints(int slot, Actor actor, PartyRolesConfig.Assignment assignment, AIHints hints) { }
...
sealed class TwofoldTempestRect(ModuleBase module) : Components.GenericBaitStack(module, (uint)AID.TwofoldTempestRect, onlyShowOutlines: true)
{
