...
sealed class IdyllicDreamStaging(ModuleBase module) : StagingAssignment<Replication3Role>(module, playerGroupSize: 4, cloneGroupSize: 2, hasBossTether: false)
{
...
sealed class IdyllicDreamPowerGusherSnakingKick(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class IdyllicDreamWurmStackSpread : Components.UniformStackSpread
{
    ...
    public IdyllicDreamWurmStackSpread(ModuleBase module) : base(module, 5f, 20f, 3)
    {
        ...
        var firstCast = module.World.FutureTime(10.5f);
...
sealed class IdyllicDreamManaBurstPlayer(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public void Predict(int spawnOrder)
    {
        ...
        for (var i = 0; i < count; ++i)
        {
            ...
            _predicted.Add(new AOEInstance(
                ...
                default,
                Module.World.FutureTime(10d) // TODO: correct activation timing
            ));
        }
    }
    ...
    public override void OnEventCast(Actor caster, ActorCastEvent spell)
    {
        ...
        var target = Module.World.Actors.Find(spell.MainTargetID);
        if (target == null)
            return;
...
sealed class IdyllicDreamHeavySlamPlayer(ModuleBase module) : Components.GenericTowers(module)
{
    public override void AddHints(int slot, Actor actor, TextHints hints)
    {
    ...
    public void Predict(int spawnOrder)
    {
        ...
        for (var i = 0; i < count; ++i)
        {
            ...
            Towers.Add(new(
                ...
                2,
                6,
                activation: Module.World.FutureTime(10f) // TODO: correct timing
            ));
        }
    }
...
sealed class IdyllicDreamPlayerCastCounter(ModuleBase module) : Components.CastCounterMulti(module, [(uint)AID.ManaBurstReplay, (uint)AID.HeavySlamReplay]);