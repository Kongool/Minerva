...
sealed class FulminousField(ModuleBase module) : Components.GenericAOEs(module)
{
    private Angle _dir;
...
{
    public ConductionPoint(ModuleBase module) : base(module, default, 6f)
    {
        AddSpreads(Raid.WithoutSlot(true, true, true), World.FutureTime(12d));
    }
}

sealed class ForkedFissures : Components.GenericWildCharge
{
    public ForkedFissures(ModuleBase module) : base(module, 5f, (uint)AID.ForkedFissures, 40f)
    {
