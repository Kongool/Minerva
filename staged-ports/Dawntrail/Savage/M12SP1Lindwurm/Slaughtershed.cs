...
sealed class FourthWallFusion1(ModuleBase module) : Components.StackWithIcon(module, (uint)IconID.FourthWallFusion1_Icon, (uint)AID.FourthWallFusion1, 6f, 5d, 4, 4);
sealed class FourthWallFusion2(ModuleBase module) : Components.StackWithIcon(module, (uint)IconID.FourthWallFusion2_Icon, (uint)AID.FourthWallFusion2, 6f, 5d, 6, 6);
sealed class VisceralBurst(ModuleBase module) : Components.SpreadFromIcon(module, (uint)IconID.VisceralBurst_Icon, (uint)AID.VisceralBurst, 6f, 5d);
sealed class DramaticLysis(ModuleBase module) : Components.SpreadFromIcon(module, (uint)IconID.DramaticLysis_Icon, (uint)AID.DramaticLysis4, 6f, 5d);
sealed class Slaughtershed(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.Slaughtershed2);
...
sealed class RaptorKnuckles(ModuleBase module) : Components.GenericKnockback(module)
{
