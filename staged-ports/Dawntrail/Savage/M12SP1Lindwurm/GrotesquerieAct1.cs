...
sealed class BurstingGrotesquerieAct1(ModuleBase module) : Components.UniformStackSpread(module, default, 6f)
{
    ...
    public override void Update()
    {
        foreach (var actor in _targets)
        {
            ...
            var remaining = (status.Value.ExpireAt - World.CurrentTime).TotalSeconds;
...
sealed class SharedGrotesquerieAct1(ModuleBase module) : Components.UniformStackSpread(module, 6f, default, 4, 4)
{
    private const float ShowThreshold = 6f;
...
sealed class DirectedGrotesquerieAct1(ModuleBase module) : Components.GenericBaitAway(module, centerAtTarget: true)
{
