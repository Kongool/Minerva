...
sealed class GrotesquerieCurtainCall(ModuleBase module) : Components.UniformStackSpread(module, default, 6f)
{
    ...
    public override void DrawArenaForeground(int pcSlot, Actor pc)
    {
        ...
        {
            var timeUntilChains = (_chainActivationTime - World.CurrentTime).TotalSeconds;
    ...
    private void DrawChainBreakIndicator(int pcSlot, Actor pc)
    {
        ...
        for (var i = 0; i < 8; ++i)
        {
            ...
            breakPos = ClampToBounds(breakPos);
