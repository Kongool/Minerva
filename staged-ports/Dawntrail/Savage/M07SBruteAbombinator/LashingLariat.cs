...
sealed class LashingLariat(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    private void InitIfReady()
    {
        ...
        {
            _aoe = [new(rectPrediction, tetheredWall.Position, tetheredWall.Rotation + angle, World.FutureTime(13.8d))];
        }
    }
