...
namespace Minerva.Dawntrail.Hunt.RankA.RraxYitya;
...
sealed class LaughingLeap(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.LaughingLeap, new AOEShapeRect(15f, 2.5f));

sealed class Wingblade(ModuleBase module) : Components.GenericAOEs(module)
{
    private readonly List<AOEInstance> _aoes = [];
    private readonly List<Angle> offsets = [];
...
{
    public RraxYityaStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.Hunt, CFCID = 0u, NameID = 12753u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Shinryin, Malediktus (ported from BMR)")]
