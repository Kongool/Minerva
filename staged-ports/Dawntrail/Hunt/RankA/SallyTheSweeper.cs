...
namespace Minerva.Dawntrail.Hunt.RankA.SallyTheSweeper;
...
sealed class TargetedAdvance(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.TargetedAdvance, 18f);

sealed class ExecutionModel(ModuleBase module) : Components.GenericAOEs(module)
{
...
{
    public SallyTheSweeperStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.Hunt, CFCID = 0u, NameID = 13435u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Shinryin (ported from BMR)")]
