...
namespace Minerva.Dawntrail.Hunt.RankA.Yehehetoauapyo;
...
sealed class WhirlingOmenRaidwide(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.WhirlingOmenRaidwide, "Raidwide, no turn buffs this time!");

sealed class WhirlingOmen(ModuleBase module) : Components.GenericAOEs(module)
{
    private readonly List<AOEInstance> _aoes = [];
    private List<Angle> offsets = [];
...
{
    public YehehetoauapyoStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.Hunt, CFCID = 0u, NameID = 13400u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Shinryin, Malediktus (ported from BMR)")]
