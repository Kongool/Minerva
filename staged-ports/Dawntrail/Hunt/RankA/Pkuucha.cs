...
namespace Minerva.Dawntrail.Hunt.RankA.Pkuucha;
...
sealed class GlidingSwoop(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.GlidingSwoop, new AOEShapeRect(18f, 8f));
sealed class PeckingFlurry(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.PeckingFlurryFirst, "Raidwide (3x)");

sealed class MesmerizingMarchStirringSamba(ModuleBase module) : Components.GenericAOEs(module)
{
...
{
    public PkuuchaStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.Hunt, CFCID = 0u, NameID = 13443u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Shinryin, Malediktus (ported from BMR)")]
