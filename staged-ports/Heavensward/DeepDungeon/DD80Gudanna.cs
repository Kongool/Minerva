...
namespace Minerva.Heavensward.DeepDungeon.PalaceOfTheDead.DD80Gudanna;
...
class Charybdis(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Charybdis, 6f);
...
class EclipticMeteor(ModuleBase module) : Components.CastHint(module, (uint)AID.EclipticMeteor, "Kill him before he kills you! 80% max HP damage incoming!");
...
{
    public DD80GudannaStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 206u, NameID = 5333u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "legendoficeman, Malediktus (ported from BMR)")]
public class DD80Gudanna : ModuleBase
{
