...
class MeteorImpact(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.MeteorImpact, 20);
class HolyKB(ModuleBase module) : Components.SimpleKnockbacks(module, (uint)AID.Holy, 3);
class Holy(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.Holy);
class ExecrationAOE(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.ExecrationAOE, new AOEShapeRect(40.5f, 5));

class AccelerationBomb(ModuleBase module) : Components.StayMove(module)
{
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 168u, CFCID = 168u, NameID = 4896u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (ported from BMR)")]
[SkipLocalsInit]
public sealed class A24Ozma : ModuleBase
{
