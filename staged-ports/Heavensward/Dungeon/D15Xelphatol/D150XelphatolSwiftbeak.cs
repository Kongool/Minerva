...
namespace Minerva.Heavensward.Dungeon.D15Xelphatol.D150XelphatolSwiftbeak;
...
sealed class Gust(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Gust, 5f);

sealed class D150XelphatolSwiftbeakStates : StateMachineBuilder
{
    public D150XelphatolSwiftbeakStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 182u, CFCID = 182u, NameID = 5261u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class D150XelphatolSwiftbeak : ModuleBase
{
