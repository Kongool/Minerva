...
namespace Minerva.Heavensward.Dungeon.D11Antitower.D152DotoliCiloc;
...
sealed class DarkWings(ModuleBase module) : Components.SpreadFromIcon(module, (uint)IconID.DarkWings, (uint)AID.DarkWings, 6f, 5.1d);
sealed class Whirlwind(ModuleBase module) : Components.Voidzone(module, 6f, GetWhirlwinds)
{
    private static List<Actor> GetWhirlwinds(ModuleBase module) => module.Enemies((uint)OID.Whirlwind);
}
sealed class Stormcoming(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Stormcoming, 6f);
sealed class OnLow(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.OnLow, new AOEShapeCone(10.98f, 60f.Degrees()));

sealed class OnLowHaste(ModuleBase module) : Components.Cleave(module, (uint)AID.Swiftfeather, new AOEShapeCone(10.98f, 60f.Degrees()))
{
    private bool active;
...
sealed class OnHigh(ModuleBase module) : Components.GenericKnockback(module)
{
...
sealed class OnHighHint(ModuleBase module) : Components.GenericAOEs(module)
{
...
{
    public D152DotoliCilocStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 182u, NameID = 5269u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class D152DotoliCiloc : ModuleBase
{
