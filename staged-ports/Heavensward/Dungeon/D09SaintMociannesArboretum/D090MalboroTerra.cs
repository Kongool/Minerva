...
namespace Minerva.Heavensward.Dungeon.D09SaintMociannesArboretum.D090MalboroTerra;
...
sealed class OffalBreath(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.OffalBreath, 6f);
sealed class Spiritus(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Spiritus, new AOEShapeCone(6f, 30f.Degrees()));

sealed class D090MalboroTerraStates : StateMachineBuilder
{
    private WallRemoval? walls;

    public D090MalboroTerraStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
            ...
            .Raw.Update = () =>
            {
                ...
                return walls!.Complete || module.World.CurrentCFCID != 41u;
            };
    }
}

[ModuleInfo(CFCID = 41u, NameID = 4637u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class D090MalboroTerra : ModuleBase
{
