...
namespace Minerva.Heavensward.Dungeon.D08FractalContinuum.D080EmeraldControlUnit;
...
class Exhaust(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Exhaust, new AOEShapeRect(33f, 6f));
...
class ClockworkReservoir(ModuleBase module) : Components.Voidzone(module, 3f, GetVoidzones)
{
...
{
    public D080EmeraldControlUnitStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
public class D080EmeraldControlUnit(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
