...
namespace Minerva.Heavensward.Dungeon.D08FractalContinuum.D080VioletControlUnit;
...
{
    public D080VioletControlUnitStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
public class D080VioletControlUnit(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena1.Center, arena1)
{
