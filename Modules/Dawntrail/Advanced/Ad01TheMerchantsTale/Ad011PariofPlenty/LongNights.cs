...
sealed class LeftRightFireflight(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.LeftFireflightFourLongNights, (uint)AID.RightFireflightFourLongNights], new AOEShapeRect(40f, 2f)); //simple aoe for first cast
