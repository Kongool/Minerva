...
sealed class FireFlight(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class FireFlightFactOrFiction(ModuleBase module) : Components.GenericAOEs(module)
{
    private readonly List<AOEInstance> _aoes = [];
    private WPos _nextLanding = default;
    private DateTime _firstActivation = default;
...
sealed class DoubleFableFlight(ModuleBase module) : Components.GenericAOEs(module)
{
    private readonly List<AOEInstance> _aoes = [];
...
sealed class FalseFlameDisplay(ModuleBase module) : Components.AddsPointless(module, (uint)OID.FalseFlame);
