...
namespace Minerva.Dawntrail.Quest.MSQ.TheWarmthOfTheFamily.Tturuhhetso;
...
sealed class CandescentRayLineStack(ModuleBase module) : Components.LineStack(module, aidMarker: default, (uint)AID.CandescentRayLineStack, minStackSize: 3, maxStackSize: 3);
sealed class CandescentRayTB(ModuleBase module) : Components.CastSharedTankbuster(module, (uint)AID.CandescentRayTB, new AOEShapeRect(50f, 4f))
{
...
sealed class SearingSwell(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.SearingSwell, new AOEShapeCone(40f, 22.5f.Degrees()));
sealed class Ensnare(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Ensnare, 6f);
sealed class TriceraSnare(ModuleBase module) : Components.SpreadFromIcon(module, (uint)IconID.Spreadmarker, (uint)AID.TriceraSnare, 6f, 4.7f)
{
...
sealed class PrimordialRoar1(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.PrimordialRoar1);
sealed class PrimordialRoar2(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.PrimordialRoar2);

sealed class OrbCollecting(ModuleBase module) : ModuleComponent(module)
{
...
sealed class FlameBlast(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnActorCreated(Actor actor)
    {
        if (actor.OID == (uint)OID.BallOfFire)
            _aoes.Add(new(rect, actor.Position, actor.Rotation + a90, World.FutureTime(6.7d)));
    }
...
sealed class Firestorm(ModuleBase module) : Components.SimpleAOEGroupsByTimewindow(module, [(uint)AID.Firestorm], 10f, 1d, 10);

sealed class TturuhhetsoStates : StateMachineBuilder
{
    public TturuhhetsoStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.Quest, GroupID = 70785u, CFCID = 70785u, NameID = 13593u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class Tturuhhetso(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
