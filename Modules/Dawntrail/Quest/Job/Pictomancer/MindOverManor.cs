...
namespace Minerva.Dawntrail.Quest.Job.Pictomancer.MindOverManor;
...
sealed class RubbleRouseRockAndRefrain(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.RubbleRouse, (uint)AID.RockAndRefrain1, (uint)AID.RockAndRefrain2], 10f);

sealed class MindOverManorStates : StateMachineBuilder
{
    public MindOverManorStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.Quest, GroupID = 70391u, CFCID = 70391u, NameID = 13032u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class MindOverManor(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
