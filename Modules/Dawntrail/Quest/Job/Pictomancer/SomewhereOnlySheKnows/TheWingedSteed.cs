...
namespace Minerva.Dawntrail.Quest.Job.Pictomancer.SomewhereOnlySheKnows.TheWingedSteed;
...
{
    public TheWingedSteedStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.Quest, GroupID = 70395u, CFCID = 70395u, NameID = 13033u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class TheWingedSteed(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
