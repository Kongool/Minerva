...
namespace Minerva.Dawntrail.Quest.Job.Pictomancer.SomewhereOnlySheKnows.FlightOfTheGriffin;
...
sealed class Feathercut(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Feathercut, new AOEShapeRect(10f, 2.5f));
sealed class FrigidPulse(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.FrigidPulse, new AOEShapeDonut(12f, 60f));
sealed class FervidPulse(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.FervidPulse, new AOEShapeCross(50f, 7f));
...
{
    public FlightOfTheGriffinStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.Quest, GroupID = 70395u, CFCID = 70395u, NameID = 13035u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class FlightOfTheGriffin(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
