...
namespace Minerva.Dawntrail.Quest.Job.Pictomancer.SomewhereOnlySheKnows.JanquetilaquesPortrait;
...
sealed class FreezeInCyan(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.FreezeInCyan, new AOEShapeCone(40f, 22.5f.Degrees()));
sealed class NineIvies(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.NineIvies, new AOEShapeCone(50f, 10f.Degrees()), 9);
sealed class TornadoInGreen(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.TornadoInGreen, new AOEShapeDonut(10f, 40f));
sealed class SculptureCast(ModuleBase module) : Components.CastGaze(module, (uint)AID.SculptureCast);
sealed class BlazeInRed(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.BlazeInRed);

sealed class BloodyCaress(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnActorCreated(Actor actor)
    {
        ...
        {
            _aoe = [new(cone, actor.Position, actor.Rotation, World.FutureTime(9.8d))];
        }
    }
...
sealed class Earthquake(ModuleBase module) : Components.ConcentricAOEs(module, _shapes)
{
...
{
    public FloodInBlueFirst(ModuleBase module) : base(module, (uint)AID.FloodInBlueFirst, new AOEShapeRect(50f, 5f)) { Color = Colors.Danger; }
}

sealed class FloodInBlueRest(ModuleBase module) : Components.Exaflare(module, new AOEShapeRect(25f, 2.5f, 25f))
{
    public override void OnCastStarted(Actor caster, ActorCastInfo spell)
    {
...
{
    public JanquetilaquesPortraitStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.Quest, GroupID = 70395u, CFCID = 70395u, NameID = 13037u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class JanquetilaquesPortrait(WorldState ws, Actor primary) : ModuleBase(ws, primary, new(default, -340f), new ArenaBoundsSquare(24.5f));
