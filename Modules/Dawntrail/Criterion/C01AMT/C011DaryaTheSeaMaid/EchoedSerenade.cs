...
class EchoedSerenade(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnEventCast(Actor caster, ActorCastEvent spell)
    {
        ...
        {
            if ((World.CurrentTime - lastVFX) < cooldown)
            {
                return;
            }
...
{
    public EchoedSerenade2(ModuleBase module) : base(module)
    {
        maxShow = 1;
    }
}

class Hydrobullet(ModuleBase module) : Components.SpreadFromCastTargets(module, (uint)AID.Hydrobullet1, 15f);