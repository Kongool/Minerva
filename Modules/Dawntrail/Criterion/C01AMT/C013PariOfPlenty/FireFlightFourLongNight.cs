...
class WitchHunt(ModuleBase module) : Components.GenericBaitAway(module, (uint)AID.FellFirework)
{
    ...
    public override void OnCastStarted(Actor caster, ActorCastInfo spell)
    {
        ...
        {
            NextActivation = World.FutureTime(19.2d);
        }
    }
...
class WitchHuntStack(ModuleBase module) : Components.GenericBaitStack(module, (uint)AID.FellFirework, true)
{
    private DateTime NextActivation;
    ...
    public override void OnCastStarted(Actor caster, ActorCastInfo spell)
    {
        if (spell.Action.ID is (uint)AID.FireflightFourLongNightsRight or (uint)AID.FireflightFourLongNightsLeft)
        {
            NextActivation = World.FutureTime(17.0f + 2.2f);
        }
    }
...
class FireFlightFourLongNight(ModuleBase module) : Components.GenericAOEs(module)
{
...
class CharmedFlightFourNights(ModuleBase module) : FireFlightFourLongNight(module)
{
    public override void OnCastStarted(Actor caster, ActorCastInfo spell)
    {
