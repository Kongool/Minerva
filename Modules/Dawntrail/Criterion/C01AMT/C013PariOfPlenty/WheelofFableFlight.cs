...
class WheelOfFableFlight(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnEventIcon(Actor actor, uint iconID, ulong targetID)
    {
        ...
        {
            aoes.Add(new AOEInstance(new AOEShapeRect(40, 40, 0, offset), actor.Position, actor.Rotation - 90.Degrees(), World.CurrentTime, Colors.AOE));
        }
...
class WheelofFableFlightStackSpread(ModuleBase module) : Components.UniformStackSpread(module, 6f, 6f, 2)
{
    public override void OnCastStarted(Actor caster, ActorCastInfo spell)
    {
