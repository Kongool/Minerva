...
namespace Minerva.Dawntrail.Dungeon.D05Origenics.D050OrigenicsAerostat;
...
sealed class GrenadoShot(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.GrenadoShot, 5f);
...
[ModuleInfo(CFCID = 825u, NameID = 12895u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class D050OrigenicsAerostat(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
