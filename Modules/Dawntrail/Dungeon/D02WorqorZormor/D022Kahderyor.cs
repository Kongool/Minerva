...
namespace Minerva.Dawntrail.Dungeon.D02WorqorZormor.D022Kahderyor;
...
sealed class WindEarthShot(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    {
        var activation = World.FutureTime(5.9d);
...
sealed class WindShotStack(ModuleBase module) : Components.DonutStack(module, (uint)AID.WindShot, (uint)IconID.WindShot, 5f, 10f, 6f, 4, 4)
{
...
sealed class WindUnbound(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.WindUnbound);
sealed class CrystallineCrush(ModuleBase module) : Components.CastTowers(module, (uint)AID.CrystallineCrush, 6f, 4, 4);
sealed class EarthenShot(ModuleBase module) : Components.SpreadFromCastTargets(module, (uint)AID.EarthenShot, 6f);
sealed class StalagmiteCircle(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.StalagmiteCircle, 15f);
sealed class CrystallineStorm(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.CrystallineStorm, new AOEShapeRect(50f, 1f));
sealed class CyclonicRing(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.CyclonicRing, new AOEShapeDonut(8f, 40f));
sealed class EyeOfTheFierce(ModuleBase module) : Components.CastGaze(module, (uint)AID.EyeOfTheFierce);
sealed class SeedCrystals(ModuleBase module) : Components.SpreadFromCastTargets(module, (uint)AID.SeedCrystals, 6f);

sealed class D022KahderyorStates : StateMachineBuilder
{
    public D022KahderyorStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 824u, CFCID = 824u, NameID = 12703u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus, LTS) (ported from BMR)")]
public sealed class D022Kahderyor : ModuleBase
{
