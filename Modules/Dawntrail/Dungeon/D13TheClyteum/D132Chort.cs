...
namespace Minerva.Dawntrail.Dungeon.D13TheClyteum.D132Chort;
...
sealed class MortifyingFlesh(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.MortifyingFlesh, new AOEShapeRect(40f, 4f));
sealed class MortifyingFleshAOEs(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.MortifyingFlesh1, (uint)AID.MortifyingFlesh2], new AOEShapeRect(40f, 8f));

sealed class BodyWeightExorcism1(ModuleBase module) : Components.SimpleKnockbacks(module, (uint)AID.BodyweightExorcism1, 8)
{
...
sealed class BasicVomit(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.BasicVomit, new AOEShapeCone(50f, 60f.Degrees()));

sealed class BodyweightTower(ModuleBase module) : Components.CastTowers(module, (uint)AID.BodyweightExorcismTower, 4f, 4, 4)
{
...
sealed class EvilEmission(ModuleBase module) : Components.SpreadFromIcon(module, (uint)IconID.EvilEmissionSpread, (uint)AID.EvilEmission1, 4, 5);
