...
namespace Minerva.Dawntrail.Dungeon.D04Vanguard.D040VanguardLeptocyon;
...
{
    public D040VanguardLeptocyonStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
public sealed class D040VanguardLeptocyon(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
