...
namespace Minerva.Dawntrail.Dungeon.D04Vanguard.D040VanguardSentryR7;
...
sealed class Swoop(ModuleBase module) : Components.ChargeAOEs(module, (uint)AID.Swoop, 2.5f);
sealed class FloaterTurn(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.FloaterTurn, new AOEShapeDonut(4f, 10f));
sealed class SpinningAxle(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.SpinningAxle, 6f);

sealed class D040VanguardSentryR7States : StateMachineBuilder
{
    public D040VanguardSentryR7States(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 831u, NameID = 12778u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class D040VanguardSentryR7(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
