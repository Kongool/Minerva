...
namespace Minerva.Dawntrail.Dungeon.D04Vanguard.D040VanguardAerostat2;
...
sealed class IncendiaryRing(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.IncendiaryRing, new AOEShapeDonut(3f, 12f));
sealed class Electrobeam(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Electrobeam, new AOEShapeRect(50f, 2f));
sealed class SpreadShot(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.SpreadShot, new AOEShapeCone(12f, 45f.Degrees()));

sealed class D040VanguardAerostat2States : StateMachineBuilder
{
    public D040VanguardAerostat2States(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
public sealed class D040VanguardAerostat2(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
