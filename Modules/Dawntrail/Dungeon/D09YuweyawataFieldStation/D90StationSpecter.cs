...
namespace Minerva.Dawntrail.Dungeon.D09YuweyawataFieldStation.D90StationSpecter;
...
sealed class GlassPunch(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.GlassPunch, new AOEShapeCone(7f, 60f.Degrees()));
sealed class Catapult(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Catapult, 6f);

sealed class D90StationSpecterStates : StateMachineBuilder
{
    public D90StationSpecterStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 1008u, CFCID = 1008u, NameID = 13577u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class D90StationSpecter : ModuleBase
{
