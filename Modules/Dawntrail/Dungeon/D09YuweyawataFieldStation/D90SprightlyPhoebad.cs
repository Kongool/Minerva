...
namespace Minerva.Dawntrail.Dungeon.D09YuweyawataFieldStation.D90SprightlyPhoebad;
...
sealed class Landslip(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Landslip, new AOEShapeCone(12, 60.Degrees()));
sealed class Plummet(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Plummet, 10);

sealed class D90SprightlyPhoebadStates : StateMachineBuilder
{
    public D90SprightlyPhoebadStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 1008u, CFCID = 1008u, NameID = 13580u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class D90SprightlyPhoebad : ModuleBase
{
