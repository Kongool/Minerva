...
namespace Minerva.Dawntrail.Dungeon.D09YuweyawataFieldStation.D90RottenResearcher;
...
{
    public D90RottenResearcherStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 1008u, CFCID = 1008u, NameID = 13575u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class D90RottenResearcher : ModuleBase
{
