...
namespace Minerva.Dawntrail.Dungeon.D09YuweyawataFieldStation.D90ForestBat;
...
sealed class FlashFlood(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.SweepingGouge, new AOEShapeCone(9f, 45f.Degrees()));
sealed class LineVoltage(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.LineVoltage, new AOEShapeRect(14f, 2f));

sealed class D90ForestBatStates : StateMachineBuilder
{
    public D90ForestBatStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 1008u, CFCID = 1008u, NameID = 13572u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class D90ForestBat : ModuleBase
{
