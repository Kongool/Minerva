...
namespace Minerva.Dawntrail.Dungeon.D09YuweyawataFieldStation.D90SprightlyClayGolem;
...
sealed class WildHorn(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.WildHorn, new AOEShapeCone(15f, 60f.Degrees()));
sealed class Plummet(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Plummet, 10f);

sealed class D90SprightlyClayGolemStates : StateMachineBuilder
{
    public D90SprightlyClayGolemStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 1008u, CFCID = 1008u, NameID = 13582u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class D90SprightlyClayGolem : ModuleBase
{
