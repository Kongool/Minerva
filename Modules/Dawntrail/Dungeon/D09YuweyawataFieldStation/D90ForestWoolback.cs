...
namespace Minerva.Dawntrail.Dungeon.D09YuweyawataFieldStation.D90ForestWoolback;
...
sealed class SweepingGouge(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.SweepingGouge, new AOEShapeCone(9f, 45f.Degrees()));
sealed class Thunderball(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Thunderball, 8f);

sealed class D90ForestWoolbackStates : StateMachineBuilder
{
    public D90ForestWoolbackStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 1008u, CFCID = 1008u, NameID = 13573u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class D90ForestWoolback : ModuleBase
{
