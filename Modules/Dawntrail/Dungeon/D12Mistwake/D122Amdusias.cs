...
namespace Minerva.Dawntrail.Dungeon.D12Mistwake.D122Amdusias;
...
[SkipLocalsInit]
sealed class ThunderIII(ModuleBase module) : Components.UniformStackSpread(module, 6f, default, 4, 4)
{
    private int numCasts;

    public override void OnCastStarted(Actor caster, ActorCastInfo spell)
    {
        if (spell.Action.ID == (uint)AID.ThunderIIIFirst && World.Actors.Find(spell.TargetID) is Actor t)
        {
...
[SkipLocalsInit]
sealed class GallopingThunder(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class Burst(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnStatusGain(Actor actor, ref ActorStatus status)
    {
        if (status.ID == (uint)SID.Burst)
        {
            ...
            _aoes.Add(new(circle, origin, default, World.FutureTime(4.5d), shapeDistance: circle.Distance(origin, default)));
        }
    }
...
[SkipLocalsInit]
sealed class Thunder(ModuleBase module) : Components.SpreadFromCastTargets(module, (uint)AID.Thunder, 5f);

[SkipLocalsInit]
sealed class D122AmdusiasStates : StateMachineBuilder
{
    public D122AmdusiasStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
