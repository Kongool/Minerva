...
namespace Minerva.Dawntrail.Hunt.RankA.TheRaintriller;
...
sealed class DoReMisery(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class DropOfVenom(ModuleBase module) : Components.StackWithCastTargets(module, (uint)AID.DropOfVenom, 6f);

sealed class TheRaintrillerStates : StateMachineBuilder
{
    public TheRaintrillerStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.Hunt, CFCID = 0u, NameID = 13442u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Shinryin, Malediktus (ported from BMR)")]
