...
namespace Minerva.Dawntrail.Hunt.RankA.QueenHawk;
...
sealed class ResonantBuzz(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.ResonantBuzz, "Apply forced march!");
sealed class ResonantBuzzMarch(ModuleBase module) : Components.StatusDrivenForcedMarch(module, 3f, (uint)SID.ForwardMarch, (uint)SID.AboutFace, (uint)SID.LeftFace, (uint)SID.RightFace)
{
...
sealed class StraightSpindle(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.StraightSpindle, new AOEShapeRect(50f, 2.5f));
sealed class FrenziedSting(ModuleBase module) : Components.SingleTargetCast(module, (uint)AID.FrenziedSting);

sealed class BeeBeAOE(ModuleBase module) : Components.GenericAOEs(module)
{
...
{
    public QueenHawkStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.Hunt, CFCID = 0u, NameID = 13361u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Shinryin, Malediktus (ported from BMR)")]
