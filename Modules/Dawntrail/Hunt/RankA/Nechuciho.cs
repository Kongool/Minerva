...
namespace Minerva.Dawntrail.Hunt.RankA.Nechuciho;
...
sealed class Level5DeathSentence(ModuleBase module) : Components.CastInterruptHint(module, (uint)AID.Level5DeathSentence, true, false, "Applies Doom!");
sealed class SentinelRoar(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.SentinelRoar);
sealed class WordOfTheWood(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.CastWordOfTheWood, new AOEShapeCone(30f, 90f.Degrees()));

sealed class WhispersOfTheWood(ModuleBase module) : Components.GenericAOEs(module)
{
...
{
    public NechucihoStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.Hunt, CFCID = 0u, NameID = 13362u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Shinryin, Malediktus (ported from BMR)")]
