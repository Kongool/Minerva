...
namespace Minerva.Dawntrail.Hunt.RankS.Sansheya;
...
sealed class Boiling(ModuleBase module) : Components.StayMove(module)
{
...
sealed class TwinscorchedHaloVeil(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class HaloOfHeat1(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.HaloOfHeat1, new AOEShapeDonut(10f, 40f));
sealed class VeilOfHeat1(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.VeilOfHeat1, 15f);
sealed class FiresDomain(ModuleBase module) : Components.BaitAwayChargeCast(module, (uint)AID.FiresDomain, 3f);
sealed class CaptiveBolt(ModuleBase module) : Components.StackWithCastTargets(module, (uint)AID.CaptiveBolt, 6f, 8);
sealed class PyreOfRebirthCullingBlade(ModuleBase module) : Components.RaidwideCasts(module, [(uint)AID.PyreOfRebirth, (uint)AID.CullingBlade]);

sealed class SansheyaStates : StateMachineBuilder
{
    public SansheyaStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.Hunt, CFCID = 0u, NameID = 13399u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
