...
namespace Minerva.Dawntrail.Hunt.RankS.TheForecaster;
...
sealed class FloodConditions(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.FloodConditions, 6f);
sealed class GaleForceWinds(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.GaleForceWinds, new AOEShapeRect(40f, 20f));
sealed class Hyperelectricity(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Hyperelectricity, 10f);
sealed class WildfireConditions(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.WildfireConditions, new AOEShapeDonut(5f, 40f));
sealed class BlizzardConditions(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.BlizzardConditions, new AOEShapeCross(40f, 2.5f));

sealed class ForecastClimateChange(ModuleBase module) : Components.GenericAOEs(module)
{
...
{
    public TheForecasterStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.Hunt, CFCID = 0u, NameID = 13437u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
