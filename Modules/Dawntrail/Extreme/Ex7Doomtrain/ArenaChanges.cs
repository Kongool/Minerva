...
sealed class ArenaChanges(ModuleBase module) : ModuleComponent(module)
{
    ...
    public override void OnMapEffect(byte index, uint state)
    {
        switch (index)
        {
            case 0x04 when state == 0x00020001u:
                ...
                Center = centerCar2;
                Bounds = new ArenaBoundsCustom([new Rectangle(centerCar2, 10.5f, 15f)],
            ...
            case 0x05 when state == 0x00020001u:
                ++Car; // Car 3
                Center = new(100f, 200f);
                Bounds = new ArenaBoundsRect(10f, 14.5f);
                break;
        }
    }
    ...
    public override void OnActorTargetable(Actor actor)
    {
        if (actor.OID == (uint)OID.Aether)
        {
            ...
            Center = center;
            Bounds = new ArenaBoundsCustom([new Polygon(center, 14.495f, 64)]);
        }
