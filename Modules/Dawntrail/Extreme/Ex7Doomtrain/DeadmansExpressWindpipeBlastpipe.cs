...
[SkipLocalsInit]
sealed class DeadMansExpress(ModuleBase module) : Components.GenericKnockback(module, (uint)AID.DeadMansExpress)
{
...
[SkipLocalsInit]
sealed class DeadMansBlastpipe(ModuleBase module) : Components.GenericAOEs(module)
{
...
[SkipLocalsInit]
sealed class DeadMansWindpipe(ModuleBase module) : Components.GenericKnockback(module, (uint)AID.DeadMansWindpipe)
{
    private Knockback[] _kb = [];
