...
sealed class ChasmOfVollokFangSmall(ModuleBase module) : Components.GenericAOEs(module, (uint)AID.ChasmOfVollokFangSmallAOE)
{
...
sealed class ChasmOfVollokFangLarge(ModuleBase module) : Components.GenericAOEs(module, (uint)AID.ChasmOfVollokFangLargeAOE)
{
    public readonly List<AOEInstance> AOEs = [];
...
sealed class ChasmOfVollokPlayer(ModuleBase module) : Components.GenericAOEs(module, (uint)AID.ChasmOfVollokPlayer, "GTFO from occupied cell!")
{
    public bool Active;
    ...
    public override ReadOnlySpan<AOEInstance> ActiveAOEs(int slot, Actor actor)
    {
        ...
        var platformOffset = 2f * (Center - mid);
        var a45 = 45f.Degrees();
