...
sealed class RosebloodDrop(ModuleBase module) : Components.Adds(module, (uint)OID.RosebloodDrop2);

sealed class Towers2(ModuleBase module) : Components.GenericTowers(module)
{
...
sealed class SpearpointPushAOE(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class SpearpointPushBait(ModuleBase module) : Components.GenericBaitAway(module, onlyShowOutlines: true)
{
    ...
    public override void OnTethered(Actor source, in ActorTetherInfo tether)
    {
        if (tether.ID == (uint)TetherID.SpearpointPush)
        {
            ...
            {
                CurrentBaits.Add(new(source, t, rect, World.FutureTime(6.7d)));
            }
        }
    }
