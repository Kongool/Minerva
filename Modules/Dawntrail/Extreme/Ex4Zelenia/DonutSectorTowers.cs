...
sealed class DonutSectorTowers(ModuleBase module) : Components.GenericTowers(module, (uint)AID.ExplosionDonutSectorTower)
{
    ...
    public override void OnMapEffect(byte index, uint state)
    {
        ...
        if (state == 0x00020001u)
        {
            ...
            {
                var pos = Center;
                Towers.Add(new(pos, shape, activation: World.FutureTime(13d), rotation: FloorTiles.TileAngles[index - idx], shapeDistance: shape.Distance(pos, default),
