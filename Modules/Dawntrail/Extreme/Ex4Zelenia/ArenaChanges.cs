...
sealed class ArenaChanges(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnMapEffect(byte index, uint state)
    {
        ...
        switch (state)
        {
            case 0x00020001u:
                _aoe = [];
                Bounds = Ex4Zelenia.DonutArena;
                break;
            case 0x00080004u:
                Bounds = Ex4Zelenia.DefaultArena;
                break;
        }
    }
}

class FloorTiles(ModuleBase module) : ModuleComponent(module)
{
...
class ActiveTiles(ModuleBase module) : Components.GenericAOEs(module)
{
