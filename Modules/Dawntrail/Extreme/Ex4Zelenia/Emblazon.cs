...
sealed class Emblazon(ModuleBase module) : Components.GenericTowers(module, (uint)AID.Emblazon)
{
    ...
    public override void OnCastStarted(Actor caster, ActorCastInfo spell)
    {
        ...
        void AddTower(AOEShapeDonutSector shape, Angle rot) => Towers.Add(new(Center, shape, forbiddenSoakers: ~Allowed, activation: Module.CastFinishAt(spell, 4.5d), rotation: rot));
    }
