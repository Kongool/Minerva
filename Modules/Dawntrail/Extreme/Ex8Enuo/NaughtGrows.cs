...
sealed class NaughtGrowsWildCharge(ModuleBase module) : Components.InverseWildCharge(module, 3f, 6f)
{
...
sealed class NaughtGrowsDonut(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.NaughtGrowsDonut, new AOEShapeDonut(40f, 60f));

sealed class NaughtGrowsCircle(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.NaughtGrowsCircle, new AOEShapeCircle(40f));

sealed class NaughtGrowsBossDonut(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.NaughtGrowsBossDonut, new AOEShapeDonut(6f, 20f));

sealed class NaughtGrowsBossCircle(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.NaughtGrowsBossCircle, new AOEShapeCircle(12f));
