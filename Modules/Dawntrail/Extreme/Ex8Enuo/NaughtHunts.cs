...
sealed class NaughtHunts(ModuleBase module) : Components.StandardChasingAOEs(module, new AOEShapeCircle(6f), (uint)AID.EndlessChaseCast, (uint)AID.EndlessChaseInstant, 2.9f, 0.7d, 13, icon: (uint)IconID.NaughtHuntTarget, activationDelay: 6d)
{
...
sealed class NaughtHuntsJumps(ModuleBase module) : ModuleComponent(module)
{
