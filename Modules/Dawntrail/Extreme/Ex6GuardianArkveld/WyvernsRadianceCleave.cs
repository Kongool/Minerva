...
sealed class WyvernsRadianceCleave(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class ChainbladeBlow(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.ChainbladeBlowFirst1, (uint)AID.ChainbladeBlowFirst2,
