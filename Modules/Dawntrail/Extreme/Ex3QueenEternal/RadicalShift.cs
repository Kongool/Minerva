...
sealed class RadicalShift(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    private void UpdateAOE(Platform platform)
    {
        ...
        if (aoe != null)
        {
            _aoe = [new(aoe, center, default, World.FutureTime(6d), shapeDistance: aoe.Distance(center, default))];
        }
    }
}

sealed class RadicalShiftAOE(ModuleBase module) : Components.SpreadFromCastTargets(module, (uint)AID.RadicalShiftAOE, 5f);
