...
sealed class MountainFire(ModuleBase module) : Components.GenericTowers(module, (uint)AID.MountainFireTower)
{
    private BitMask _nonTanks = GetNonTanks(module);
    private BitMask _lastSoakers;

    private static BitMask GetNonTanks(ModuleBase module)
    {
...
sealed class MountainFireCone(ModuleBase module) : Components.GenericAOEs(module)
{
