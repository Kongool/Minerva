...
sealed class ParticleConcentration(ModuleBase module) : Components.GenericTowers(module)
{
    ...
    public override void OnMapEffect(byte index, uint state)
    {
        ...
        if (count == 3)
        {
            _outerTowers.Add(Center + offset);
        }
        else if (count > 0)
        {
            Towers.Add(new(Center + offset, 3f, count, count, _outerPlayers, World.FutureTime(10.1d)));
        }
    }
