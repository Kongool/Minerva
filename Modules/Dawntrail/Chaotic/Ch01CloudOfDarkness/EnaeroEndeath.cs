...
sealed class EnaeroEndeath(ModuleBase module) : Components.GenericKnockback(module, stopAfterWall: true)
{
    ...
    public override bool DestinationUnsafe(int slot, Actor actor, WPos pos)
    {
        ...
        return s.Kind == Kind.TowardsOrigin ? (pos - s.Origin).LengthSq() <= 36f : !InBounds(pos);
    }
...
sealed class EnaeroAOE(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class EndeathAOE(ModuleBase module) : Components.GenericAOEs(module)
{
