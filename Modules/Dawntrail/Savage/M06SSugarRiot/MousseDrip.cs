...
sealed class MousseDripStack(ModuleBase module) : Components.UniformStackSpread(module, 5f, default, 4, 4)
{
    public int NumCasts;
...
sealed class MousseDripVoidzone(ModuleBase module) : Components.VoidzoneAtCastTarget(module, 5f, (uint)AID.MousseDrip, GetVoidzones, 1.4f)
{
...
sealed class MousseDripTowers(ModuleBase module) : Components.GenericTowers(module)
{
    public override void OnMapEffect(byte index, uint state)
    {
        ...
        if (pos is WPos origin)
            Towers.Add(new(origin.Quantized(), 3f, activation: World.FutureTime(19.1d)));
    }
