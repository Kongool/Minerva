...
abstract class LariatOut(ModuleBase module, uint aid) : Components.SimpleAOEs(module, aid, 10f);
sealed class OctupleLariatOut(ModuleBase module) : LariatOut(module, (uint)AID.OctupleLariatOutAOE);
sealed class QuadrupleLariatOut(ModuleBase module) : LariatOut(module, (uint)AID.QuadrupleLariatOutAOE);

abstract class LariatIn(ModuleBase module, uint aid) : Components.SimpleAOEs(module, aid, new AOEShapeDonut(10f, 60f));
sealed class OctupleLariatIn(ModuleBase module) : LariatIn(module, (uint)AID.OctupleLariatInAOE);
sealed class QuadrupleLariatIn(ModuleBase module) : LariatIn(module, (uint)AID.QuadrupleLariatInAOE);

// TODO: generalize to a conal stack/spread with role-based targets
sealed class BlazingLariat(ModuleBase module) : Components.CastCounter(module, default)
{
