...
sealed class OneTwoPawBoss(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class OneTwoPawShade(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnTethered(Actor source, in ActorTetherInfo tether)
    {
        if (_aoes.Count < 4 && tether.ID == (uint)TetherID.Soulshade)
        {
            ...
            _aoes.Add(new(_shape, pos, source.Rotation + _firstDirection, World.FutureTime(20.3d)));
            _aoes.Add(new(_shape, pos, source.Rotation - _firstDirection, World.FutureTime(23.3d)));
...
sealed class LeapingOneTwoPaw(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnTethered(Actor source, in ActorTetherInfo tether)
    {
        if (tether.ID == (uint)TetherID.Soulshade)
        {
            ...
            else if (_clone == source)
            {
                ...
                StartMechanic(source.Position, source.Rotation, World.FutureTime(16));
            }
