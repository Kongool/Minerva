...
sealed class RottenHeart(ModuleBase module) : Components.CastCounter(module, (uint)AID.RottenHeartAOE);

sealed class RottenHeartBigBurst(ModuleBase module) : Components.CastCounter(module, (uint)AID.RottenHeartBigBurst)
{
    ...
    public override void OnStatusGain(Actor actor, ref ActorStatus status)
    {
        ...
        {
            _order[slot] = (status.ExpireAt - World.CurrentTime).TotalSeconds switch
            {
                < 15 => 1,
                < 30 => 2,
                < 45 => 3,
