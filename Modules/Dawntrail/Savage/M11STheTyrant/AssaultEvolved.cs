...
abstract class SequencedPreviewAOEs<TEntry>(ModuleBase module)
    : GenericAOEs(module)
    where TEntry : struct
{
...
sealed class AssaultWeaponTimeline(ModuleBase module) : ModuleComponent(module)
{
...
sealed class AssaultFloorPredictor(ModuleBase module) : GenericAOEs(module)
{
...
sealed class AssaultEvolvedSword(ModuleBase module) : GenericAOEs(module)
{
    private bool _active;
...
sealed class AssaultEvolvedAxeStack(ModuleBase module) : ModuleComponent(module)
{
...
sealed class AssaultEvolvedScythe(ModuleBase module) : GenericAOEs(module)
{
    private bool _active;
    internal bool Active => _active;
    private WPos _origin;
...
sealed class AssaultWeaponSafeSpots(ModuleBase module) : ModuleComponent(module)
{
