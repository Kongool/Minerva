...
{
    public Cometite(ModuleBase module) : base(module, (uint)AID.Cometite, 6f, 24)
    {
        MaxDangerColor = 8;
    }
}
...
{
    public MajesticMeteorStorm(ModuleBase module) : base(module, (uint)AID.MajesticMeteorStorm, 6f, 36)
    {
        MaxDangerColor = 6;
    }
}
sealed class MammothMeteor(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.MammothMeteor, 18f);
sealed class AtomicImpact(ModuleBase module) : Components.SpreadFromIcon(module, (uint)IconID.AtomicImpactIcon, (uint)AID.AtomicImpact, 5f, 6);
sealed class Comet(ModuleBase module) : Components.SpreadFromIcon(module, (uint)IconID.CometIcon, (uint)AID.Comet, 6f, 5d);
sealed class CrushingComet(ModuleBase module) : Components.StackWithCastTargets(module, (uint)AID.CrushingComet, 6f);
sealed class EyeOfTheHurricane(ModuleBase module) : Components.StackWithCastTargets(module, (uint)AID.EyeOfTheHurricane, 6f, 2, 2);
sealed class Explosion(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.Explosion1, (uint)AID.Explosion2], new AOEShapeRect(60f, 5f));
sealed class FireAndFury(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.FireAndFuryFront, (uint)AID.FireAndFuryBack], new AOEShapeCone(60f, 45.Degrees()));
sealed class GreatWallOfFire(ModuleBase module) : Components.BaitAwayCast(module, (uint)AID.GreatWallOfFire, new AOEShapeRect(60f, 3f), false, true, true);
sealed class GreatWallOfFireExplosion(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.GreatWallOfFire1, (uint)AID.GreatWallOfFire2, (uint)AID.GreatWallOfFireExplosion], new AOEShapeRect(60f, 3f));
sealed class FearsomeFireball(ModuleBase module) : Components.LineStack(module, (uint)IconID.FearsomeFireballIcon, (uint)AID.FearsomeFireball1, 5d, 60f, 4f, 4, 6, 1, true);
sealed class OneAndOnly(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.OneAndOnly, "Raidwide");
sealed class Shockwave(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Shockwave, new AOEShapeCircle(1f)); //Just want to track casts; we actually use this AID in TripleTyrannhilation
sealed class Flatliner(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Flatliner, new AOEShapeRect(30f, 5f, 30f));
sealed class FlatlinerKB(ModuleBase module) : Components.SimpleKnockbacks(module, (uint)AID.Flatliner1, 15f, true, 1, new AOEShapeCircle(60f));
sealed class ArcadionAvalanche(ModuleBase module) :
...
sealed class ArcadionAvalancheSmash(ModuleBase module) :
...
{
    public OrbitalOmen(ModuleBase module) : base(module, (uint)AID.OrbitalOmen_Lines, new AOEShapeRect(60f, 5f), 4)
    {
        MaxDangerColor = 2;
    }
}
sealed class AtomicImpactVoidZones(ModuleBase module) :
    Components.Voidzone(module, 5f, module => module.Enemies((uint)OID.AtomicImpactVoidZones).Where(z => z.EventState != 7));
sealed class DanceOfDomination(ModuleBase module) : Components.RaidwideCastsDelay(module, [(uint)AID.DanceOfDominationTrophy], [(uint)AID.DanceOfDomination, (uint)AID.DanceOfDomination1, (uint)AID.DanceOfDomination2, (uint)AID.DanceOfDomination3], 6f, "Multi-hit Raidwide");
sealed class Charybdistopia(ModuleBase module) : Components.CastHint(module, (uint)AID.Charybdistopia, "Set hp to 1");
sealed class MassiveMeteor(ModuleBase module) : Components.StackWithIcon(module, (uint)IconID.MassiveMeteorIcon, (uint)AID.MassiveMeteorHit, 6f, 5, 4, 4, 5);
sealed class MaelstromVoidZones(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    {
        var maelstroms = World.Actors.Where(a => (OID)a.OID == OID.Maelstrom);
        if (!maelstroms.Any())
            return default;
...
sealed class MaelstromGustCones(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class MaelstromBaitSafeSpots(ModuleBase module) : ModuleComponent(module)
{
    ...
    public override void DrawArenaForeground(int slot, Actor pc)
    {
        ...
        var assignments = _roles.AssignmentsPerSlot(World.Party);
...
sealed class AtomicImpactBaitPath(ModuleBase module) : ModuleComponent(module)
{
