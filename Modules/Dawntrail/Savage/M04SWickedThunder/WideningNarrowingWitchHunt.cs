...
sealed class WideningNarrowingWitchHunt(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class WideningNarrowingWitchHuntBait(ModuleBase module) : Components.GenericBaitAway(module, (uint)AID.WitchHuntAOE, centerAtTarget: true)
{
    ...
    public override void OnEventCast(Actor caster, ActorCastEvent spell)
    {
        if (spell.Action.ID == WatchedAction)
        {
            ...
            _activation = World.FutureTime(3.5d);
            if ((NumCasts & 1) == 0)
