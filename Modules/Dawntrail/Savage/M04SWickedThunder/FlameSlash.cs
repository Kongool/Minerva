...
sealed class FlameSlash(ModuleBase module) : Components.GenericAOEs(module, (uint)AID.FlameSlashAOE)
{
...
sealed class RainingSwords(ModuleBase module) : Components.CastTowers(module, (uint)AID.RainingSwordsAOE, 3f);

sealed class ChainLightning(ModuleBase module) : Components.GenericAOEs(module)
{
