...
sealed class ManaSphere(ModuleBase module) : ModuleComponent(module)
{
    public enum Shape
    {
        BlueSphere,
...
sealed class BloodWakeningReplay(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class Netherworld(ModuleBase module) : Components.UniformStackSpread(module, 6, 0, maxStackSize: 4)
{
