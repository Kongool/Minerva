...
class Replication2Staging(ModuleBase module)
...
class Replication2ScaldingWaves : Components.GenericBaitProximity
{
    ...
    public Replication2ScaldingWaves(ModuleBase module)
        : base(module)
    {
        _staging = module.FindComponent<Replication2Staging>()!;
        _activation = World.FutureTime(6.2f);
...
class Replication2ManaBurst : Components.UniformStackSpread
{
    ...
    public Replication2ManaBurst(ModuleBase module)
        : base(module, 0, 20, includeDeadTargets: true)
    {
        ...
        for (var i = 0; i < len; ++i)
        {
            ...
            if (clone == null || clone.AssignedRole.IsDefam)
                AddSpread(player, World.FutureTime(8));
        }
    }
...
class Replication2HeavySlam : Components.UniformStackSpread
{
    ...
    public Replication2HeavySlam(ModuleBase module)
        : base(module, 5, 0, minStackSize: 3, includeDeadTargets: true)
    {
        ...
        for (var i = 0; i < len; ++i)
        {
            ...
            if (clone != null && clone.AssignedRole.IsStack)
                AddStack(player, World.FutureTime(7));
        }
    }
...
sealed class Replication2HemorrhagicProjection : Components.GenericBaitAway
{
    ...
    public Replication2HemorrhagicProjection(ModuleBase module)
        : base(module, centerAtTarget: true)
    {
        var staging = module.FindComponent<Replication2Staging>()!;
        _activation = World.FutureTime(8.8d);
...
sealed class Replication2ReenactmentOrder(ModuleBase module) : ModuleComponent(module)
{
...
sealed class Replication2ReenactmentAOEs(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class Replication2ReenactmentTowers(ModuleBase module) : Components.GenericTowers(module, (uint)AID.HeavySlamReplay)
{
...
sealed class Replication2ReenactmentScaldingWaves(ModuleBase module) : Components.GenericBaitAway(module)
{
...
sealed class Replication2TimelessSpite(ModuleBase module) : Components.UniformStackSpread(module, 6f, 0f, maxStackSize: 2)
{
