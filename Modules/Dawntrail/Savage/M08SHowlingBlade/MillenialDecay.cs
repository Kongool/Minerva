...
{
    public BreathOfDecay(ModuleBase module) : base(module, (uint)AID.BreathOfDecay, new AOEShapeRect(40f, 4f), 2)
    {
        MaxDangerColor = 1;
    }
}

sealed class AeroIII(ModuleBase module) : Components.SimpleKnockbacks(module, (uint)AID.AeroIII, 8f)
{
...
sealed class ProwlingGale(ModuleBase module) : Components.CastTowers(module, (uint)AID.ProwlingGale, 2f)
{
...
sealed class Gust(ModuleBase module) : Components.SpreadFromIcon(module, (uint)IconID.Gust, (uint)AID.Gust, 5f, 5.1f);
sealed class WindsOfDecayTether(ModuleBase module) : Components.StretchTetherDuo(module, 16f, 5.7f)
{
...
sealed class WindsOfDecayBait(ModuleBase module) : Components.GenericBaitAway(module)
{
    ...
    public override void OnTethered(Actor source, in ActorTetherInfo tether)
    {
        ...
        {
            if (World.Actors.Find(tether.Target) is Actor t)
            {
                CurrentBaits.Add(new(source, t, cone, World.FutureTime(7.1d)));
            }
        }
    }
...
sealed class TrackingTremors(ModuleBase module) : Components.StackWithIcon(module, (uint)IconID.TrackingTremors, (uint)AID.TrackingTremors, 6f, 6f, 8, 8, 8);
