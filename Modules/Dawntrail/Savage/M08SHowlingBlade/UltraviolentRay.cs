...
sealed class UltraviolentRay(ModuleBase module) : Components.GenericBaitAway(module, (uint)AID.UltraviolentRay, onlyShowOutlines: true)
{
    ...
    public override void OnEventIcon(Actor actor, uint iconID, ulong targetID)
    {
        ...
        {
            CurrentBaits.Add(new(bossmod.BossP2()!, actor, rect, World.FutureTime(6.1d)));
        }
    }
...
sealed class GleamingBeam(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnActorPlayActionTimelineEvent(Actor actor, ushort id)
    {
        ...
        {
            _aoes.Add(new(Rect, actor.Position.Quantized(), actor.Rotation, World.FutureTime(6.1d)));
        }
    }
