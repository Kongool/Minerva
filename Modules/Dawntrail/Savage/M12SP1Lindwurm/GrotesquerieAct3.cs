...
sealed class GrotesquerieAct3(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    private void QueueDestructionAOEs()
    {
        ...
        _aoes.Clear();
        var activation = World.FutureTime(10f);
    ...
    private float StatusDuration(DateTime expireAt) => Math.Max(0, (float)(expireAt - World.CurrentTime).TotalSeconds);
