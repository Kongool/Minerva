...
public class VoidzoneShape(ModuleBase module, uint OID, AOEShape shape) : Components.GenericAOEs(module, default, "GTFO from voidzone!")
{
    public VoidzoneShape(ModuleBase module, uint OID, float radius) : this(module, OID, new AOEShapeCircle(radius)) { }
...
sealed class FlameFloaterPuddle(ModuleBase module) : VoidzoneShape(module, (uint)OID.PuddleFlameFloater, new AOEShapeRect(60f, 4f));
sealed class AlleyOopInfernoPuddle(ModuleBase module) : VoidzoneShape(module, (uint)OID.PuddleAlleyOopInferno, 5f);
sealed class CutbackBlazePuddle(ModuleBase module) : VoidzoneShape(module, (uint)OID.PuddleCutbackBlaze, new AOEShapeCone(60f, 165f.Degrees()));
sealed class Pyrorotation(ModuleBase module) : Components.StackWithIcon(module, (uint)IconID.PyrorotationStack, (uint)AID.Pyrotation, 6f, 5d, 6, 8, 3);
sealed class PyrorotationPuddle(ModuleBase module) : VoidzoneShape(module, (uint)OID.PuddlePyrorotation, 6f);
sealed class BlastingSnapPuddle(ModuleBase module) : VoidzoneShape(module, (uint)OID.PuddleInsaneAirCone, new AOEShapeCone(60f, 22.5f.Degrees()));
sealed class HotImpact(ModuleBase module) : Components.CastSharedTankbuster(module, (uint)AID.HotImpact, 6f);
sealed class CutbackBlaze(ModuleBase module) : Components.CastCounter(module, (uint)AID.CutbackBlaze)
{
...
sealed class DiversDareRed(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.DiversDareRed);
sealed class AlleyOopInferno(ModuleBase module) : Components.SpreadFromCastTargets(module, (uint)AID.AlleyOopInferno, 5f)
{
    private readonly DebuffTracker _debuff = module.FindComponent<DebuffTracker>()!;
...
sealed class HotImpact2(ModuleBase module) : Components.CastSharedTankbuster(module, (uint)AID.HotImpact2, 6f);
sealed class HotAerial(ModuleBase module) : Components.GenericStackSpread(module)
{
...
sealed class FreakyPyrotation(ModuleBase module) : Components.StackWithIcon(module, (uint)IconID.FreakyPyrotation, (uint)AID.FreakyPyrotation, 6f, 5f, 2, 2);
sealed class FlameFloaterSplit(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.FlameFloaterSplit, new AOEShapeRect(60f, 4f))
{
    public override void OnCastStarted(Actor caster, ActorCastInfo spell)
    {
