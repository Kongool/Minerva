...
sealed class FlameFloater(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    private WPos GetBaitPosition(int order)
    {
        ...
        var dirFromCenter = (Center - _bossStartPos).Normalized();
