...
namespace Minerva.Dawntrail.Foray.ForkedTowerBlood.FTB0SanguineRecluse;
...
sealed class TartareanFlame(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.TartareanFlame, new AOEShapeDonut(8f, 40f));
sealed class TartareanThunder(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.TartareanThunder, 20f);
sealed class Doom(ModuleBase module) : Components.CleansableDebuff(module, (uint)SID.Doom);

sealed class Cryptcall(ModuleBase module) : Components.GenericAOEs(module)
{
...
{
    public FTB0SanguineRecluseStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.TheForkedTowerBlood, GroupID = 1018u, CFCID = 1018u, NameID = 13868u, PrimaryActorOID = (uint)OID.SanguineRecluse, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
