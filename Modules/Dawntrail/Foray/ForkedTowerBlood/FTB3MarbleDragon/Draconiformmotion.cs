...
sealed class DraconiformMotion(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.DraconiformMotion1, (uint)AID.DraconiformMotion2], new AOEShapeCone(60f, 45f.Degrees()));

sealed class DraconiformMotionBait(ModuleBase module) : Components.GenericAOEs(module)
{
