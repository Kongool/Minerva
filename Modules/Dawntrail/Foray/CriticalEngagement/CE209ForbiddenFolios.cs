...
namespace Minerva.Dawntrail.Foray.CriticalEngagement.CE209ForbiddenFolios;
...
[SkipLocalsInit]
sealed class KnowledgeLevelCorrection(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.KnowledgeLevelCorrectionCast);
[SkipLocalsInit]
sealed class Summon(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Summon, 4f);
[SkipLocalsInit]
...
[SkipLocalsInit]
sealed class FireII(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.FireII, new AOEShapeCone(60f, 22.5f.Degrees()));
[SkipLocalsInit]
sealed class QuadRule(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.QuadRule, new AOEShapeCross(25f, 5f));
[SkipLocalsInit]
...
{
    public Blot(ModuleBase module) : base(module, (uint)AID.Blot, 15f, 6)
    {
        MaxDangerColor = 3;
    }
}
[SkipLocalsInit]
sealed class Invincibility(ModuleBase module) : Components.InvincibleStatus(module, (uint)SID.Invincibility);

[SkipLocalsInit]
sealed class CoverToCover(ModuleBase module) : Components.GenericAOEs(module)
{
...
[SkipLocalsInit]
sealed class KnowledgeLevel(ModuleBase module) : Components.GenericAOEs(module)
{
    private readonly List<AOEInstance> _aoes = [];
...
{
    public CE209ForbiddenFoliosStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CriticalEngagement, CFCID = 1093u, NameID = 52u, PrimaryActorOID = (uint)OID.Arbatel, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Equilius (ported from BMR)")]
[SkipLocalsInit]
public sealed class CE209ForbiddenFolios : ModuleBase
{
