...
namespace Minerva.Dawntrail.Foray.FATE.FatalAllure;
...
class DarkMistVoidFireIII(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class ArmOfPurgatory(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.ArmOfPurgatory, 20f);
sealed class Mini(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Mini, new AOEShapeCone(30f, 60f.Degrees()));
sealed class VoidFireIII(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.VoidFireIII, 10f);

sealed class FatalAllureStates : StateMachineBuilder
{
    public FatalAllureStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.ForayFATE, GroupID = 1018u, CFCID = 1018u, NameID = 1971u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
