...
namespace Minerva.Dawntrail.Foray.FATE.GoldenGuardian;
...
{
    public FlamingEpigraph(ModuleBase module) : base(module, (uint)AID.FlamingEpigraph, new AOEShapeCone(60f, 30f.Degrees()), 4)
    {
        MaxDangerColor = 2;
    }
}
sealed class FlaringEpigraph(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.FlaringEpigraph);
sealed class EpigraphicFireII(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.EpigraphicFireII, 5f);
sealed class Epigraph(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Epigraph, new AOEShapeRect(45f, 2.5f));

sealed class ErosiveEye(ModuleBase module) : Components.GenericGaze(module)
{
...
sealed class TongueLickOfFlameOutIn(ModuleBase module) : Components.ConcentricAOEs(module, _shapes)
{
...
sealed class TongueLickOfFlameInOut(ModuleBase module) : Components.ConcentricAOEs(module, _shapes)
{
...
{
    public GoldenGuardianStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.ForayFATE, CFCID = 1018u, NameID = 1963u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
