...
sealed class P5PolarizingStrikes(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnEventCast(Actor caster, ActorCastEvent spell)
    {
        switch (spell.Action.ID)
        {
            ...
            case (uint)AID.CruelPathOfDarknessBait:
                ++NumCasts;
                _aoes.Add(new(_shape, caster.Position, caster.Rotation, World.FutureTime(2d)));
                break;
