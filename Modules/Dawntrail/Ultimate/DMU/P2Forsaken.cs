...
sealed class AllThingsEndingCasts(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.AllThingsEnding, (uint)AID.AllThingsEnding1], new AOEShapeCone(100f, 90f.Degrees()));
...
sealed class AllThingsEnding(ModuleBase module) : Components.GenericBaitAway(module, onlyShowOutlines: true)
{
    ...
    private readonly List<Actor> baiters = []; // players currently baiting
    ...
    public override void DrawArenaForeground(int pcSlot, Actor pc)
    {
        ...
        if (shapes.currentTowerSet == 9)
        {
            ...
            {
                var waymark = World.Waymarks.GetFieldMark((int)Waymark.A);
                if (waymark == null)
                {
                    return;
                }
