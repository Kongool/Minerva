...
sealed class ConcertedDissolution(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.ConcertedDissolution, new AOEShapeCone(40f, 20f.Degrees()))
{
...
sealed class LightsChain(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.LightsChain, new AOEShapeDonut(4f, 40f))
{
...
sealed class CrossReaver(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.CrossReaverAOE, new AOEShapeCross(50f, 6f))
{
    private LightsChain? _aoe;
