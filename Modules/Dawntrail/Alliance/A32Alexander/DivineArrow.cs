...
sealed class DivineArrowCone(ModuleBase module) : Components.GenericRotatingAOE(module)
{
    ...
    public override void OnEventIcon(Actor actor, uint iconID, ulong targetID)
    {
        ...
        if (iconID is (uint)IconID.DivineArrowN or ((uint)IconID.DivineArrowNR))
        {
            ...
            Sequences.Add(new(cone, actor.Position, startrot, inc, World.FutureTime(13.3f), 0.67f, 18, maxShownAOEs: 8));
        }
...
sealed class DivineArrowCircles(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.DivineArrowClose, (uint)AID.DivineArrowClose2], new AOEShapeCircle(10f), 1)
{
