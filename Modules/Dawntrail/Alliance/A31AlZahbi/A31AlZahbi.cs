...
namespace Minerva.Dawntrail.Alliance.A31AlZahbi;
...
sealed class Earthshatter(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Earthshatter, 8);
sealed class TranscendentShot(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.TranscendentShot, new AOEShapeRect(60f, 2.5f), maxCasts: 4);
sealed class LeapingCleave(ModuleBase module) : Components.SimpleKnockbacks(module, (uint)AID.LeapingCleave, 22f);
sealed class FeralLunge(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.FeralLunge, 10f);
sealed class WhirlingSlash(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.WhirlingSlash, 6f);
sealed class Perdition(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Perdition, 9f);
sealed class Tourbillion(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Tourbillion, new AOEShapeRect(40f, 25f));
sealed class PinningShot(ModuleBase module) : Components.BaitAwayCast(module, (uint)AID.PinningShot, 13f, tankbuster: true);
sealed class FulminationKhalkeos(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.FulminationKhalkeos);
sealed class DanceToDust(ModuleBase module) : Components.Exaflare(module, 7f)
{
...
sealed class ShadowSlash(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.RightShadowSlash, (uint)AID.LeftShadowSlash], new AOEShapeCone(60f, 90f.Degrees()));
sealed class BellowingGrunt(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.BellowingGrunt);
sealed class Disregard(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.DisregardRaidwide);
sealed class DisregardRect(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.DisregardRect, new AOEShapeRect(55f, 5f));
sealed class Petrifaction(ModuleBase module) : Components.CastGaze(module, (uint)AID.Petrifaction);
...
[ModuleInfo(CFCID = 1117u, NameID = 14834u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Xan, ported by wen (ported from BMR)")]
 ...
 */
public class A31AlZahbi(WorldState ws, Actor primary) : ModuleBase(ws, primary, new(721f, 720f), new ArenaBoundsRect(25f, 20f))
{
