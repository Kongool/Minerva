...
namespace Minerva.Dawntrail.Alliance.A20JaggedyEaredJack;
...
sealed class DustCloud(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.DustCloud, new AOEShapeCone(10f, 60f.Degrees()));

sealed class A20JaggedyEaredJackStates : StateMachineBuilder
{
    public A20JaggedyEaredJackStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 1058u, CFCID = 1058u, NameID = 14080u, PrimaryActorOID = (uint)OID.JaggedyEaredJack, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class A20JaggedyEaredJack(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
