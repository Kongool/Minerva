...
namespace Minerva.Dawntrail.Alliance.A10Trash.VanguardPathfinder;
...
sealed class BombToss(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.BombToss, 3f);
sealed class Seismostomp(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Seismostomp, 5f);

public sealed class A10VanguardPathfinderStates : StateMachineBuilder
{
    public A10VanguardPathfinderStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 1015u, CFCID = 1015u, NameID = 13599u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class A10VanguardPathfinder(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
