...
namespace Minerva.Dawntrail.Alliance.A10Groundskeeper;
...
sealed class MysteriousLight(ModuleBase module) : Components.CastGaze(module, (uint)AID.MysteriousLight);

public sealed class A10GroundskeeperStates : StateMachineBuilder
{
    public A10GroundskeeperStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 1015u, CFCID = 1015u, NameID = 13607u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class A10Groundskeeper(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
