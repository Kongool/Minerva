...
sealed class CthonicFury(ModuleBase module) : Components.GenericAOEs(module)
{
    private AOEInstance[] _aoe = [];
    public bool Active => _aoe.Length != 0 || Bounds is not ArenaBoundsCircle;
    public readonly AOEShapeCustom AOEBurningBattlements = new(module.Center, GetDefaultSquare(), [new Square(new(150f, 800f), 11.5f, 45f.Degrees())]);
    private readonly AOEShapeCustom aoeCthonicFury = new(module.Center, GetDefaultSquare(), GetCustomShape());
...
sealed class BurningCourtMoatKeepBattlements(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class EchoesOfAgony(ModuleBase module) : Components.StackWithIcon(module, (uint)IconID.EchoesOfAgony, (uint)AID.EchoesOfAgonyAOE, 5f, 9.2d, PartyState.MaxAllianceSize, PartyState.MaxAllianceSize)
{
    public override void OnCastStarted(Actor caster, ActorCastInfo spell)
    {
