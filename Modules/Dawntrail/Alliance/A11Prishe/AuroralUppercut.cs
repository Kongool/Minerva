...
sealed class AuroralUppercut(ModuleBase module) : Components.GenericKnockback(module)
{
    ...
    public override void OnCastStarted(Actor caster, ActorCastInfo spell)
    {
        ...
        if (distance != default)
        {
            _kb = [new(Center, distance, Module.CastFinishAt(spell, 1.6d), ignoreImmunes: true)];
...
sealed class AuroralUppercutHint(ModuleBase module) : Components.GenericAOEs(module)
{
