...
namespace Minerva.Endwalker.DeepDungeon.PilgrimsTraverse.DD60AncestralMaliktender;
...
{
    public SeveralThousandNeedles(ModuleBase module) : base(module, (uint)AID.SeveralThousandNeedles1, new AOEShapeRect(10f, 5f), 6)
    {
        MaxDangerColor = 3;
    }
}
...
{
    public LongRangeNeedles(ModuleBase module) : base(module, (uint)AID.LongRangeNeedles1, new AOEShapeRect(30f, 15f), 2)
    {
        MaxDangerColor = 1;
    }
}
...
[SkipLocalsInit]
sealed class Spineshot(ModuleBase module) : Components.GenericAOEs(module)
{
...
[SkipLocalsInit]
sealed class OneTwoStoneMarch(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnMapEffect(byte index, uint state)
    {
        if (index == 0x00)
        {
            ...
            activation = World.FutureTime(16.2d);
            InitIfReady();
        }
    }
...
[SkipLocalsInit]
sealed class SpinningNeedles(ModuleBase module) : Components.GenericRotatingAOE(module)
{
    private readonly AOEShapeCone cone = new(60f, 30f.Degrees());
    ...
    public override void AddAIHints(int slot, Actor actor, PartyRolesConfig.Assignment assignment, AIHints hints)
    {
        ...
        if (Sequences.Count != 0 && _aoe.AOEs.Count == 0)
        {
            ...
            hints.AddForbiddenZone(new SDInvertedCircle(Center, 4f), Sequences.Ref(0).NextActivation);
        }
    }
}

[SkipLocalsInit]
sealed class AncestralMaliktenderStates : StateMachineBuilder
{
    public AncestralMaliktenderStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 1037u, CFCID = 1037u, NameID = 14097u, PrimaryActorOID = (uint)OID.AncestralMaliktender, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
[SkipLocalsInit]
public sealed class AncestralMaliktender(WorldState ws, Actor primary) : ModuleBase(ws, primary, new(-600f, -300f), new ArenaBoundsSquare(19.5f));
