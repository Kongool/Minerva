...
sealed class WaltzOfTheRegaliaBait(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnActorPlayActionTimelineEvent(Actor actor, ushort id)
    {
        ...
        {
            _targets.Add((actor, World.FutureTime(7d)));
        }
    }
...
sealed class WaltzOfTheRegalia(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.WaltzOfTheRegalia, new AOEShapeRect(14f, 2f));
