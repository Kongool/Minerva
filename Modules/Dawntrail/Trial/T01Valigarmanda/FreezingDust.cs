...
sealed class FreezingDust(ModuleBase module) : Components.StayMove(module, 3d)
{
    ...
    public override void AddAIHints(int slot, Actor actor, PartyRolesConfig.Assignment assignment, AIHints hints)
    {
        ...
        hints.AddForbiddenZone(new SDInvertedRect(Center, new WDir(default, 1f), 10f, 10, 10f), ps.Activation);
    }
}
