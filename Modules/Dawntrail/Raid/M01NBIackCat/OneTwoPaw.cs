...
sealed class OneTwoPaw(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    private void InitIfReady()
    {
        if (helper != null && _currentPattern != Pattern.None)
        {
            ...
            _aoes.Add(new(cone, helper.Position, angle[0], World.FutureTime(8.7d)));
            _aoes.Add(new(cone, helper.Position, angle[1], World.FutureTime(10.7d)));
            _currentPattern = Pattern.None;
            helper = null;
        }
    }
