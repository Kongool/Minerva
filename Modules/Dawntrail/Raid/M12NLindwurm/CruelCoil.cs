...
[SkipLocalsInit]
sealed class CruelCoil(ModuleBase module) : Components.GenericAOEs(module, warningText: "Run out of snek!")
{
    ...
    public override void OnCastStarted(Actor caster, ActorCastInfo spell)
    {
        ...
        {
            _aoe = [new(circle, Center.Quantized(), activation: Module.CastFinishAt(spell), risky: false)];
        }
    }
    ...
    private void UpdateArena(int state = 0)
    {
        ...
        Bounds = new ArenaBoundsCustom([new Rectangle(Center, 20f, 15f)], [new DonutSegmentV(Center, 9.5f, 13.5f, centerDir, (state == 0 ? 180f : 160f).Degrees(), 128)]);
    }
}
