...
sealed class SidewiseSpark(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnActorPlayActionTimelineEvent(Actor actor, ushort id)
    {
        if (actor.OID == (uint)OID.WickedReplica)
        {
            ...
            void AddAOE(Angle offset) => _aoes.Add(new(cone, actor.Position, actor.Rotation + offset, World.FutureTime(8d)));
        }
    }
