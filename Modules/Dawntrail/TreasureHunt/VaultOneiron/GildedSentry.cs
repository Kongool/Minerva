...
namespace Minerva.Dawntrail.TreasureHunt.VaultOneiron.GildedSentry;
...
sealed class AlexandrianThunder(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.AlexandrianThunder, 6f);
sealed class CrossLightning(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.CrossLightning, new AOEShapeCross(50f, 5f));
sealed class Electray(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Electray, new AOEShapeRect(75f, 2f));
sealed class SkeweringLance(ModuleBase module) : Components.SingleTargetCast(module, (uint)AID.SkeweringLance);
sealed class AlexandrianThunderIII(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.AlexandrianThunderIII);
...
{
    public GildedSentryStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 1060u, CFCID = 1060u, NameID = 14007u, PrimaryActorOID = (uint)OID.GildedSentry, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
