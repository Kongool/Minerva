...
namespace Minerva.Dawntrail.TreasureHunt.VaultOneiron.Fastitocalon;
...
{
    public UpliftSequence(ModuleBase module) : base(module, [(uint)AID.UpliftSequence1, (uint)AID.UpliftSequence2,
...
sealed class Uplift(ModuleBase module) : Components.BaitAwayCast(module, (uint)AID.Uplift, 5f, tankbuster: true);
sealed class Earthshake(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Earthshake, 6f);
sealed class Canyon(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.Canyon);

sealed class Tremblor(ModuleBase module) : Components.ConcentricAOEs(module, _shapes)
{
...
{
    public FastitocalonStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 1060u, CFCID = 1060u, NameID = 13999u, PrimaryActorOID = (uint)OID.Fastitocalon, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
