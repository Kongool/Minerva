...
namespace Minerva.Dawntrail.TreasureHunt.CenoteJaJaGural.BullApollyon;
...
sealed class Pyreburst(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.Pyreburst);

sealed class FlameBlade1and2(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.FlameBlade1, (uint)AID.FlameBlade2], new AOEShapeRect(40f, 5f));
sealed class CrossfireBlade3FlameBlade3(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.CrossfireBlade3, (uint)AID.FlameBlade3], new AOEShapeRect(40f, 2.5f));
sealed class CrossfireBlade1and2(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.CrossfireBlade1, (uint)AID.CrossfireBlade2], new AOEShapeCross(20f, 5f));

sealed class BlazingBreath(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.BlazingBreath, new AOEShapeRect(44f, 5f));
sealed class BlazingBlast(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.BlazingBlast, 6f);
...
{
    public BullApollyonStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 993u, CFCID = 993u, NameID = 13247u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Kismet, Malediktus (ported from BMR)")]
