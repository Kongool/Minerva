...
namespace Minerva.Dawntrail.TreasureHunt.CenoteJaJaGural.Room1;
...
sealed class NepenthicPlunge(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.NepenthicPlunge, new AOEShapeCone(10f, 45f.Degrees()));
sealed class CreepingHush(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.CreepingHush, new AOEShapeCone(12f, 60f.Degrees()));
sealed class Ovation(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Ovation, new AOEShapeRect(14f, 2f));
sealed class BestialFire(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.BestialFire, 5f);
sealed class HeadButt(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.HeadButt, new AOEShapeCone(6f, 60f.Degrees()));
sealed class AetherialBlast(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.AetherialBlast, new AOEShapeRect(20f, 2f));
sealed class Envenomate(ModuleBase module) : Components.BaitAwayChargeCast(module, (uint)AID.Envenomate, 1.5f);
sealed class SyrupSpout(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.SyrupSpout, new AOEShapeCone(10f, 60f.Degrees()));
sealed class SpinningAttack(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.SpinningAttack, new AOEShapeRect(10f, 2f));
sealed class IsleDropRottenSpores(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.IsleDrop, (uint)AID.RottenSpores], 6f);
...
{
    public Room1States(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 993u, CFCID = 993u, NameID = 5057u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class Room1(WorldState ws, Actor primary) : ModuleBase(ws, primary, ArenaBounds.Center, ArenaBounds)
{
