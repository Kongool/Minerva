...
namespace Minerva.Dawntrail.TreasureHunt.CenoteJaJaGural.Room4;
...
sealed class LumisphereTornadoRootsOfAtopyRottenSpores(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.Lumisphere, (uint)AID.Tornado, (uint)AID.RootsOfAtopy, (uint)AID.RottenSpores], 6f);
...
sealed class SerratedSpin(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.SerratedSpin, 8f);
...
sealed class OdiousAir(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.OdiousAir, new AOEShapeCone(12f, 60f.Degrees()));
sealed class Wingblade(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.LeftWingblade, (uint)AID.RightWingblade], new AOEShapeCone(8f, 90f.Degrees()));
...
{
    public Room4States(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
public sealed class Room4(WorldState ws, Actor primary) : ModuleBase(ws, primary, ArenaBounds.Center, ArenaBounds)
{
