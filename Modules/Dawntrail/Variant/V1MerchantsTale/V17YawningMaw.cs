...
namespace Minerva.Dawntrail.Variant.V01NMerchantsTale.V08NYawningMaw;
...
[SkipLocalsInit]
sealed class ForbiddenGoobue(ModuleBase module) : Components.GenericInvincible(module)
{
...
[SkipLocalsInit]
sealed class Inhale(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Inhale, new AOEShapeCone(23f, 60f.Degrees()));

[SkipLocalsInit]
sealed class GemHints(ModuleBase module) : ModuleComponent(module)
{
...
{
    public V08YawningMawStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 1066u, CFCID = 1066u, NameID = 14402u, PrimaryActorOID = (uint)OID.YawningMaw, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "VeraNala (ported from BMR)")]
[SkipLocalsInit]
public sealed class V08YawningMaw(WorldState ws, Actor primary) : ModuleBase(ws, primary, new(299.77f, 681.98f), new ArenaBoundsCircle(15f));
