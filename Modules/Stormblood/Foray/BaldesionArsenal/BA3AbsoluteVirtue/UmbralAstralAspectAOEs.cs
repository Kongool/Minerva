...
sealed class BrightDarkAurora(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class BrightDarkAuroraCounter(ModuleBase module) : Components.CastCounterMulti(module, [(uint)AID.DarkAurora1, (uint)AID.BrightAurora1,
(uint)AID.DarkAurora2, (uint)AID.BrightAurora2]);

sealed class AstralUmbralRays(ModuleBase module) : Components.GenericAOEs(module)
{
