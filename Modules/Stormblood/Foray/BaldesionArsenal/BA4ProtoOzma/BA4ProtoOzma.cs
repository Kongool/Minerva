...
sealed class Tornado(ModuleBase module) : Components.BaitAwayCast(module, (uint)AID.Tornado, 6f);
sealed class MeteorStack(ModuleBase module) : Components.StackWithIcon(module, (uint)IconID.MeteorStack, (uint)AID.Meteor, 10f, 5.1f, 4, 24)
{
...
sealed class MeteorBait(ModuleBase module) : Components.SpreadFromIcon(module, (uint)IconID.MeteorBaitaway, (uint)AID.MeteorImpact, 18f, 8.9f)
{
...
sealed class MeteorImpact(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.MeteorImpact, 18f);
...
[ModuleInfo(Group = ModuleGroup.BaldesionArsenal, GroupID = 639u, CFCID = 639u, NameID = 7981u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class BA4ProtoOzma(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
