...
class Gekko2(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override ReadOnlySpan<AOEInstance> ActiveAOEs(int slot, Actor actor)
    {
        ...
        {
            if (!t.IsDestroyed)
                _aoes.Add(new(_circle, t.Position, default, World.FutureTime(_gekko2Delay)));
        }
    ...
    public override void Update()
    {
        ...
        if (_yukikazeActive && World.CurrentTime >= _yukikazeExpiry)
