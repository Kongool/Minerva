...
namespace Minerva.Stormblood.Trial.T01Susano;
...
sealed class RasenKaikyo(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.RasenKaikyo, 6f);

sealed class YataNoKagami(ModuleBase module) : Components.SimpleKnockbacks(module, (uint)AID.YataNoKagami, 20f, kind: Kind.AwayFromOrigin);

sealed class Ukehi(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.Ukehi);

sealed class Brightstorm(ModuleBase module) : Components.StackWithIcon(module, (uint)IconID._Gen_Icon_com_share0c, (uint)AID.Brightstorm, 6f, 8);

sealed class ThePartingClouds(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.ThePartingClouds, new AOEShapeRect(65f, 5f));

sealed class AmeNoMurakumoRaidwide(ModuleBase module) : Components.RaidwideInstant(module, (uint)AID.AmeNoMurakumoRaidwide);

sealed class AmeNoMurakumoRectAOE(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.AmeNoMurakumoRectAOE, new AOEShapeRect(65f, 3f));

sealed class Shock(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Shock, 6f);

sealed class AmeNoMurakumoOrbs(ModuleBase module) : ModuleComponent(module)
{
    public static List<Actor> GetOrbs(ModuleBase module)
    {
...
sealed class SeaSplitterCast(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Seasplitter, new AOEShapeRect(41f, 20f));

sealed class SeaSplitter1(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Seasplitter1, new AOEShapeRect(27f, 20f));
sealed class SeaSplitter2(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Seasplitter2, new AOEShapeRect(27f, 20f));
sealed class SeaSplitter3(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Seasplitter3, new AOEShapeRect(27f, 20f));

sealed class StormSplitter(ModuleBase module) : Components.IconSharedTankbuster(module, (uint)IconID.StormsplitterIcon, (uint)AID.Stormsplitter, new AOEShapeRect(40f, 2f));

sealed class SheerForce(ModuleBase module) : Components.RaidwideInstant(module, (uint)AID.SheerForce);

[SkipLocalsInit]
sealed class SusanoStates : StateMachineBuilder
{
    public SusanoStates(ModuleBase module) : base(module)
    {
...
[ModuleInfo(CFCID = 243u, NameID = 6221u, PrimaryActorOID = (uint)OID.Susano, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "wen (ported from BMR)")]
[SkipLocalsInit]
public class Susano(WorldState ws, Actor primary)
    : ModuleBase(ws, primary, new(0, 0), new ArenaBoundsCircle(20f))
{
    protected override void DrawEnemies(int pcSlot, Actor pc)
    {
        if (PrimaryActor.IsTargetable)
        {
            if (PrimaryActor.Position.InCircle(Center, 20f))
                Arena.ActorInsideBounds(Center - new WDir(0, 20), PrimaryActor.Rotation, Colors.Enemy);
            else
                Arena.ActorOutsideBounds(Center - new WDir(0, 20f), PrimaryActor.Rotation, Colors.Enemy);
        }
