...
class VoiceOfThunder(ModuleBase module) : ModuleComponent(module)
{
...
class Intermission(ModuleBase module) : ModuleComponent(module)
{
    public bool Active;
...
class IntermissionOrbAratama(ModuleBase module) : Components.GenericAOEs(module, (uint)AID.IntermissionOrbAratama)
{
    ...
    public override void OnEventCast(Actor caster, ActorCastEvent spell)
    {
        switch (spell.Action.ID)
        {
            case (uint)AID.IntermissionOrbSpawn:
                AOEs.Add(new(_shape, spell.TargetXZ, default, World.FutureTime(5.1d)));
                break;
...
class IntermissionSweepTheLeg(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.IntermissionSweepTheLeg, new AOEShapeDonut(5f, 25f));
class ImperialGuard(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.ImperialGuard, new AOEShapeRect(44.75f, 2.5f));
class FellSwoop(ModuleBase module) : Components.CastCounter(module, (uint)AID.FellSwoop);
