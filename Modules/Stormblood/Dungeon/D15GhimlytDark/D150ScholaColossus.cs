...
namespace Minerva.Stormblood.Dungeon.D15TheGhimlytDark.D150ScholaColossus;
...
class HomingLaser(ModuleBase module) : Components.SpreadFromCastTargets(module, (uint)AID.HomingLaser, 6);
class GrandStrike(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.GrandStrike, new AOEShapeRect(48.2f, 2));

class D0150ScholaColossusStates : StateMachineBuilder
{
    public D0150ScholaColossusStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 611u, NameID = 7886u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public class D0150ScholaColossus(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
