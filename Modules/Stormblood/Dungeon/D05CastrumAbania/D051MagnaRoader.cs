...
namespace Minerva.Stormblood.Dungeon.D05CastrumAbania.D051MagnaRoader;
...
class MagitekPulsePlayer(ModuleBase module) : ModuleComponent(module)
{
...
class WildSpeedHaywire(ModuleBase module) : Components.GenericAOEs(module)
{
...
class MagitekPulse(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.MagitekPulse, 6f);
class MagitekFireII(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.MagitekFireII, 5f);
class MagitekFireIII(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.MagitekFireIII);

class D051MagnaRoaderStates : StateMachineBuilder
{
    public D051MagnaRoaderStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 242u, NameID = 6263u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public class D051MagnaRoader(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
