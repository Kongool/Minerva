...
namespace Minerva.Stormblood.Dungeon.D06AlaMhigo.D061MagitekScorpion;
...
sealed class TailLaser(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class TargetSearch(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class LockOn(ModuleBase module) : Components.VoidzoneAtCastTarget(module, 5f, (uint)AID.LockOn, GetVoidzones, 0.7f)
{
...
sealed class ElectromagneticField(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.ElectromagneticField);

sealed class D061MagitekScorpionStates : StateMachineBuilder
{
    public D061MagitekScorpionStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 247u, CFCID = 247u, NameID = 6037u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class D061MagitekScorpion(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
