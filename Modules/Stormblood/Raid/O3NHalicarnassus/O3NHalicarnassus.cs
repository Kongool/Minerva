...
namespace Minerva.Stormblood.Raid.O3NHalicarnassus;
...
class Ribbit(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Ribbit, new AOEShapeCone(19.5f, 75f.Degrees()));
class SpellbladeThunderIII(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.SpellbladeThunderIII, new AOEShapeRect(60f, 3f));
class SpellbladeBlizzardIII(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.SpellbladeBlizzardIII, 9f);
class SpellbladeFireIII(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.SpellbladeFireIII, new AOEShapeDonut(4f, 15f));
class CrossReaper(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.CrossReaper, 10f);
class TheQueensWaltz1(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.TheQueensWaltz1, new AOEShapeCone(34f, 10f.Degrees()));
class TheQueensWaltz2(ModuleBase module) : Components.GenericAOEs(module)
{
...
class TheGame(ModuleBase module) : Components.GenericAOEs(module)
{
    private readonly List<AOEInstance> _aoes = [];
    private static readonly AOEShapeRect rect = new(5f, 5f, 5f);
...
{
    public O3NHalicarnassusStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 254u, NameID = 5633u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "VeraNala (ported from BMR)")]
public class O3NHalicarnassus(WorldState ws, Actor primary) : ModuleBase(ws, primary, default, new ArenaBoundsSquare(20));
