...
sealed class FireOrbsTimedFollowAOE(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnCastStarted(Actor caster, ActorCastInfo spell)
    {
        ...
        {
            info.ActualExplode = World.FutureTime(spell.NPCRemainingTime);
