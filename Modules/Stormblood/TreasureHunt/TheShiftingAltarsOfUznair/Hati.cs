...
namespace Minerva.Stormblood.TreasureHunt.ShiftingAltarsOfUznair.Hati;
...
class PolarRoar(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.PolarRoar, new AOEShapeDonut(9f, 40f));
class Hellstorm(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Hellstorm2, 10f);
class Netherwind(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Netherwind, new AOEShapeRect(18f, 2f));
class GlassyNova(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.GlassyNova, new AOEShapeRect(45.4f, 4f));
class BrainFreeze(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.BrainFreeze, 15.4f);
...
{
    public HatiStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 586u, NameID = 7590u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Malediktus (ported from BMR)")]
