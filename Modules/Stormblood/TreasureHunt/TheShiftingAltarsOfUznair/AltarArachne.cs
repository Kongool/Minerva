...
namespace Minerva.Stormblood.TreasureHunt.ShiftingAltarsOfUznair.AltarArachne;
...
class DarkSpike(ModuleBase module) : Components.SingleTargetDelayableCast(module, (uint)AID.DarkSpike);
class FrondAffeared(ModuleBase module) : Components.CastGaze(module, (uint)AID.FrondAffeared);
class SilkenSpray(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.SilkenSpray, new AOEShapeCone(24f, 30f.Degrees()));
class Implosion(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.Implosion);
class Earthquake1(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Earthquake1, 10.5f);
class Earthquake2(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Earthquake2, new AOEShapeDonut(10f, 20f));
class Earthquake3(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Earthquake3, new AOEShapeDonut(20f, 30f));
...
{
    public AltarArachneStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 586u, NameID = 7623u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Malediktus (ported from BMR)")]
