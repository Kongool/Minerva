...
class P2Cauterize(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnActorCreated(Actor actor)
    {
        ...
        {
            var dir = 180f.Degrees() - Angle.FromDirection(actor.Position - Center);
...
class P2Hypernova(ModuleBase module) : Components.VoidzoneAtCastTarget(module, 5f, (uint)AID.Hypernova, GetVoidzones, 1.4f)
{
