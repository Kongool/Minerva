...
// TODO: verify width
class P1MistralSongBoss(ModuleBase module) : Components.GenericWildCharge(module, 5, (uint)AID.MistralSongBoss, 40)
{
    public override void OnEventIcon(Actor actor, uint iconID, ulong targetID)
    {
        if (iconID == (uint)IconID.MistralSong)
        {
            ...
            Activation = World.FutureTime(5.2f);
...
// TODO: verify width
class P1MistralSongAdds(ModuleBase module) : Components.CastCounter(module, (uint)AID.MistralSongAdds)
{
...
class P1GreatWhirlwind(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.GreatWhirlwind, 8f);
