...
sealed class P3Geocrush1(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Geocrush1, 18f);

// TODO: add prediction after PATE xxx - need non-interpolated actor rotation for that...
sealed class P3Geocrush2(ModuleBase module) : Components.GenericAOEs(module, (uint)AID.Geocrush2)
{
    ...
    public override void OnCastStarted(Actor caster, ActorCastInfo spell)
    {
        ...
        {
            _caster = caster;
            Bounds = new ArenaBoundsCircle(NumCasts == 0 ? 16f : 12f);
        }
    }
    ...
    //        _predictedPos = Center + _possibleOffsets.MinBy(o =>
    //        {
    //            var off = Center + o - _caster.Position;
