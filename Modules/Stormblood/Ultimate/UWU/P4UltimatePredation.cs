...
class P4UltimatePredation(ModuleBase module) : ModuleComponent(module)
{
    ...
    {
        _first.Center = _second.Center = Center;
        ...
        _second.ForbidInfiniteRect(Center - new WDir(Bounds.Radius, default), 90f.Degrees(), 5f);
        _second.ForbidInfiniteRect(Center - new WDir(default, Bounds.Radius), default, 5f);
    ...
    private WPos GetSafePositionAtAngle(Angle angle) => Center + _dodgeRadius * angle.ToDirection();
