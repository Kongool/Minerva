...
namespace Minerva.Endwalker.Dungeon.D10FellCourtOfTroia.D100TroianBishop;
...
sealed class JestersReap(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.JestersReap, new AOEShapeCone(12f, 60f.Degrees()));
sealed class HallOfSorrow(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.HallOfSorrow, 8f);

sealed class D100TroianBishopStates : StateMachineBuilder
{
    public D100TroianBishopStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 869u, NameID = 11364u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class D100TroianBishop(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
