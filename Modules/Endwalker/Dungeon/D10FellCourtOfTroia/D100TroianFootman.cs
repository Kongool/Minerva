...
namespace Minerva.Endwalker.Dungeon.D10FellCourtOfTroia.D100TroianFootman;
...
sealed class Geirrothr(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Geirrothr, new AOEShapeCone(6f, 60f.Degrees()));
sealed class GrimFate(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.GrimFate, new AOEShapeCone(12f, 60f.Degrees()));
sealed class GrimHalo(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.GrimHalo, 12f);
sealed class VoidTrap(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.VoidTrap, 6f);

sealed class D100TroianFootmanStates : StateMachineBuilder
{
    public D100TroianFootmanStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 869u, NameID = 11447u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class D100TroianFootman(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
