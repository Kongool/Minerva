...
namespace Minerva.Endwalker.Dungeon.D04KtisisHyperboreia.D041Lyssa;
...
sealed class PillarPierceAOE(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.PillarPierceAOE, new AOEShapeRect(40f, 2f))
{
...
sealed class PunishingSlice(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnMapEffect(byte index, uint state)
    {
        ...
        if (pair != default)
        {
            var activation = NumCasts == 0 ? World.FutureTime(13d) : World.FutureTime(16d);
...
sealed class IcePillar(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.IcePillar, 4f);
sealed class HeavySmash(ModuleBase module) : Components.StackWithCastTargets(module, (uint)AID.HeavySmash, 6f, 4, 4)
{
...
sealed class SkullDasher(ModuleBase module) : Components.SingleTargetCast(module, (uint)AID.SkullDasher);
sealed class FrigidStomp(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.FrigidStomp);

sealed class D041LyssaStates : StateMachineBuilder
{
    public D041LyssaStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 787u, CFCID = 787u, NameID = 10396u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus, LTS) (ported from BMR)")]
public sealed class D041Lyssa(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
