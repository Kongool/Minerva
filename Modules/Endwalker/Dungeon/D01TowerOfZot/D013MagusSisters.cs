...
namespace Minerva.Endwalker.Dungeon.D01TheTowerOfZot.D013MagusSisters;
...
sealed class Dhrupad(ModuleBase module) : ModuleComponent(module)
{
    private bool active;
...
sealed class ManusyaBio(ModuleBase module) : Components.SingleTargetCast(module, (uint)AID.ManusyaBio, "Tankbuster + cleansable poison");

sealed class Poison(ModuleBase module) : Components.CleansableDebuff(module, (uint)SID.Poison, "Poison", "poisoned");

sealed class IsitvaSiddhi(ModuleBase module) : Components.SingleTargetCast(module, (uint)AID.IsitvaSiddhi);
sealed class Samsara(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.Samsara);
sealed class DeltaThunderIII1(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.DeltaThunderIII1, 3f);
sealed class DeltaThunderIII2(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.DeltaThunderIII2, 5f);
sealed class DeltaThunderIII3(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.DeltaThunderIII3, new AOEShapeRect(40f, 5f));
sealed class DeltaThunderIII4(ModuleBase module) : Components.StackWithCastTargets(module, (uint)AID.DeltaThunderIII4, 5f, 4, 4);
sealed class DeltaBlizzardIII1(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.DeltaBlizzardIII1, new AOEShapeCone(40.5f, 10f.Degrees()));
sealed class DeltaBlizzardIII2(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.DeltaBlizzardIII2, new AOEShapeRect(44f, 2f));
sealed class DeltaBlizzardIII3(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.DeltaBlizzardIII3, 15f);
sealed class DeltaFireIII1(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.DeltaFireIII1, new AOEShapeDonut(5f, 40f));
sealed class DeltaFireIII2(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.DeltaFireIII2, new AOEShapeRect(44f, 5f));
sealed class DeltaFireIII3(ModuleBase module) : Components.SpreadFromCastTargets(module, (uint)AID.DeltaFireIII3, 6f);
...
sealed class SphereShatter(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnActorCreated(Actor actor)
    {
        if (actor.OID == (uint)OID.BerserkerSphere)
            _aoes.Add(new(circle, actor.Position.Quantized(), default, World.FutureTime(7.3d)));
    }
...
sealed class ManusyaBlizzardIII(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.ManusyaBlizzardIII2, new AOEShapeCone(40.5f, 10.Degrees()));

sealed class D013MagusSistersStates : StateMachineBuilder
{
    public D013MagusSistersStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 783u, NameID = 10265u, PrimaryActorOID = (uint)OID.Cinduruva, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "dhoggpt, Malediktus (ported from BMR)")]
sealed class D013MagusSisters(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
