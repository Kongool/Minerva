...
namespace Minerva.Endwalker.Dungeon.D01TowerOfZot.D011Minduruva;
...
sealed class ManusyaThunderIII(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.ManusyaThunderIII2, 3f);
sealed class ManusyaBioIII(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.ManusyaBioIII2, new AOEShapeCone(40.5f, 90f.Degrees()));
sealed class ManusyaBlizzardIII(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.ManusyaBlizzardIII2, new AOEShapeCone(40.5f, 10f.Degrees()));
sealed class ManusyaFireIII(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.ManusyaFireIII2, new AOEShapeDonut(5f, 60f));

sealed class D011MinduruvaStates : StateMachineBuilder
{
    public D011MinduruvaStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 783u, CFCID = 783u, NameID = 10256u, PrimaryActorOID = (uint)OID.Minduruva, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "dhoggpt, Malediktus (ported from BMR)")]
public sealed class D011Minduruva(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
