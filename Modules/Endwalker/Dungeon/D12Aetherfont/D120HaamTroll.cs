...
namespace Minerva.Endwalker.Dungeon.D12Aetherfont.D120HaamTroll;
...
class Uppercut(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Uppercut, new AOEShapeCone(11, 60.Degrees()));

class D120HaamTrollStates : StateMachineBuilder
{
    public D120HaamTrollStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 822u, NameID = 12343u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public class D120HaamTroll(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
