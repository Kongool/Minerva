...
namespace Minerva.Endwalker.Dungeon.D12Aetherfont.D120HaamForlorn;
...
{
    public D120HaamForlornStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 822u, NameID = 12349u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public class D120HaamForlorn(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
