...
namespace Minerva.Endwalker.Dungeon.D12Aetherfont.D120HaamOtodus;
...
class AquaticLance(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.AquaticLance, 8);
class Icestorm(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Icestorm, new AOEShapeCone(16, 45.Degrees()));

class D120HaamOtodusStates : StateMachineBuilder
{
    public D120HaamOtodusStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 822u, NameID = 12339u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public class D120HaamOtodus(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
