...
namespace Minerva.Endwalker.Dungeon.D12Aetherfont.D120HaamHalonid;
...
{
    public D120HaamHalonidStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 822u, NameID = 12341u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public class D120HaamHalonid(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
