...
namespace Minerva.Endwalker.Dungeon.D12Aetherfont.D120HaamCrystal;
...
class HardHead(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.HardHead, new AOEShapeCone(12f, 60f.Degrees()));
class EarthenHeart(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.EarthenHeart, 6f);

class D120HaamCrystalStates : StateMachineBuilder
{
    public D120HaamCrystalStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 822u, NameID = 12345u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public class D120HaamCrystal(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
