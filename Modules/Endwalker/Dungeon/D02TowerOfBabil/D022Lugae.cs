...
namespace Minerva.Endwalker.Dungeon.D02TowerOfBabil.D022Lugae;
...
sealed class DownpourMagitekChakram(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class ThermalSuppression(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.ThermalSuppression);
sealed class MightyRay(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.MagitekRay, new AOEShapeRect(50f, 3f));
sealed class Explosion(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Explosion, new AOEShapeCross(40f, 4f));
...
{
    public D022LugaeStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 785u, CFCID = 785u, NameID = 10281u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus, LTS) (ported from BMR)")]
public sealed class D022Lugae(WorldState ws, Actor primary) : ModuleBase(ws, primary, new(221f, 306f), new ArenaBoundsSquare(19.5f));
