...
{
    public OnceTwiceThriceRokujo(ModuleBase module) : base(module, [(uint)AID.OnceOnRokujo, (uint)AID.TwiceOnRokujo, (uint)AID.ThriceOnRokujo], new AOEShapeRect(60f, 7f))
    {
        MaxDangerColor = 1;
    }
}

sealed class Rokujo(ModuleBase module) : Components.GenericAOEs(module)
{
