...
namespace Minerva.Endwalker.VariantCriterion.V2MountRokkon.V20ShishuChochin;
...
sealed class Lanterns(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    private readonly List<Circle> lanterns = [];
    ...
    private void InitAOE()
    {
        ...
        _aoe = [new(shape, center, default, World.FutureTime(99d), Colors.SafeFromAOE, shapeDistance: shape.InvertedDistance(center, default))];
        aoeInit = true;
    }
...
sealed class Illume(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Illume, new AOEShapeCone(6f, 45f.Degrees()));

sealed class V20ShishuChochinStates : StateMachineBuilder
{
    public V20ShishuChochinStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 945u, CFCID = 945u, NameID = 12396u, PrimaryActorOID = (uint)OID.ShishuChochin, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class V20ShishuChochin : ModuleBase
{
