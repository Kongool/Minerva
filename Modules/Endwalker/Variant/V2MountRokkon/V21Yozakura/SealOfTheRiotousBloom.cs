...
sealed class SealOfRiotousBloom(ModuleBase module) : Components.GenericAOEs(module)
{
            ...
            switch (state)
            {
                ...
                case 0x00400080u: // seal activates
                    ...
                    for (var i = 0; i < count; ++i)
                    {
                        if (elements[i] == e)
                        {
                            ActivateAOE(e, World.FutureTime(8.1d));
                            break;
                        }
                    }
                    break;
    ...
    private void ActivateAOE(Element element, DateTime activation)
    {
        ...
        {
            var act = World.FutureTime(16.3d);
        ...
        void AddAOE(AOEShape shape, DateTime activation, Angle rotation = default) => _aoes.Add(new(shape, Center.Quantized(), rotation, activation));
