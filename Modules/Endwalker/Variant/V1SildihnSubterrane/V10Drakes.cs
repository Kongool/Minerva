...
namespace Minerva.Endwalker.VariantCriterion.V1SildihnSubterrane.V10Drakes;
...
sealed class BurningCyclone(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.BurningCyclone, new AOEShapeCone(8f, 60f.Degrees()))
{
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 868u, CFCID = 868u, NameID = 11463u, PrimaryActorOID = (uint)OID.ForgottenDrakefather, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class V10Drakes(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
