...
sealed class BallOfFire(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnActorCreated(Actor actor)
    {
        switch (actor.OID)
        {
            case (uint)OID.BallOfFire:
                ...
                _aoes.Add(new(circle, position.Quantized(), default, World.FutureTime(countP == 0 ? 10.2d : 15.8f)));
                break;
