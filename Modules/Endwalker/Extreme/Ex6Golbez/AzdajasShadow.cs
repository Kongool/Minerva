...
class AzdajasShadow(ModuleBase module) : ModuleComponent(module)
{
...
class FlamesOfEventide(ModuleBase module) : Components.GenericBaitAway(module, (uint)AID.FlamesOfEventide)
{
