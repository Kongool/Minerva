...
class VisceralWhirl(ModuleBase module) : Components.GenericAOEs(module)
{
...
class MiasmicBlast(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.MiasmicBlast, new AOEShapeCross(60f, 5f));

class VoidBio(ModuleBase module) : Components.GenericAOEs(module)
{
...
class BondsOfDarkness(ModuleBase module) : ModuleComponent(module)
{
...
class DarkDivides(ModuleBase module) : Components.UniformStackSpread(module, default, 5f)
{
