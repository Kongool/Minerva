...
class FlowOfTheAbyssDimensionalSurge(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.FlowOfTheAbyssDimensionalSurge, new AOEShapeRect(60f, 7f));

class FlowOfTheAbyssSpreadStack(ModuleBase module) : Components.GenericStackSpread(module)
{
    public override void OnEventIcon(Actor actor, uint iconID, ulong targetID)
    {
        var act = World.FutureTime(5d);
        switch (iconID)
        {
...
class FlowOfTheAbyssAkhRhai(ModuleBase module) : Components.GenericAOEs(module)
{
...
class ChasmicNails(ModuleBase module) : Components.GenericAOEs(module)
{
    private readonly List<AOEInstance> _aoes = [];
