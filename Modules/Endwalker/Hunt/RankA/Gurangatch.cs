...
namespace Minerva.Endwalker.Hunt.RankA.Gurangatch;
...
class Slammer(ModuleBase module) : Components.GenericRotatingAOE(module)
{
...
class BoneShaker(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.BoneShaker);

class GurangatchStates : StateMachineBuilder
{
    public GurangatchStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.Hunt, CFCID = 0u, NameID = 10631u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "ported from BossmodReborn")]
