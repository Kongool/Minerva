...
namespace Minerva.Endwalker.Hunt.RankA.MoussePrincess;
...
class PrincessThrenody(ModuleBase module) : Components.GenericAOEs(module)
{
...
class WhimsyAlaMode(ModuleBase module) : Components.CastHint(module, (uint)AID.WhimsyAlaMode, "Select direction");
class AmorphicFlail(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.AmorphicFlail, 9f);
class PrincessCacophony(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.PrincessCacophony, 12f);
class Banish(ModuleBase module) : Components.SingleTargetCast(module, (uint)AID.Banish);

class MoussePrincessStates : StateMachineBuilder
{
    public MoussePrincessStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.Hunt, CFCID = 0u, NameID = 10630u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "ported from BossmodReborn")]
