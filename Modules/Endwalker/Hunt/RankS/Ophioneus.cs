...
namespace Minerva.Endwalker.Hunt.RankS.Ophioneus;
...
sealed class Maw(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.RightMaw, (uint)AID.LeftMaw], new AOEShapeCone(30f, 90f.Degrees()));

sealed class PyricCircleBurst(ModuleBase module) : Components.GenericAOEs(module)
{
...
{
    public OphioneusStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
            .ActivateOnEnter<Maw>()
...
[ModuleInfo(Group = ModuleGroup.Hunt, CFCID = 0u, NameID = 10621u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "ported from BossmodReborn")]
