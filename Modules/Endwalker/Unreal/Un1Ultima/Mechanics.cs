...
class Mechanics(ModuleBase module) : ModuleComponent(module)
{
    ...
    {
        var mtSlot = World.Party.FindSlot(Module.PrimaryActor.TargetID);
    ...
    {
        var mt = World.Actors.Find(Module.PrimaryActor.TargetID);
