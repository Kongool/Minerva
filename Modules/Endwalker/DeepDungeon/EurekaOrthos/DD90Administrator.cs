...
namespace Minerva.Endwalker.DeepDungeon.EurekaOrthos.DD90Administrator;
...
class AetheroChemicalLaserCombo(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnEventIcon(Actor actor, uint iconID, ulong targetID)
    {
        ...
        AOEs.Add(new(_shapes[shapeIndex], actor.Position.Quantized(), actor.OID == (uint)OID.OrbInterceptor ? default : actor.Rotation, World.FutureTime(delay)));
        if (AOEs.Count == 6)
...
class AetherLaserLine : Components.SimpleAOEs
{
    ...
    public AetherLaserLine(ModuleBase module) : base(module, (uint)AID.AetherochemicalLaserLine, new AOEShapeRect(40f, 2.5f), 4)
    {
        MaxDangerColor = 2;
        MaxRisky = 2;
...
class AetherLaserLine2(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.AetherochemicalLaserLine2, new AOEShapeRect(40f, 2.5f));
class AetherLaserCone(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.AetherochemicalLaserCone2, new AOEShapeCone(50f, 60f.Degrees()));
class HomingLasers(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.HomingLaser, 6f);
class Laserstream(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.Laserstream);

class DD90AdministratorStates : StateMachineBuilder
{
    public DD90AdministratorStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 905u, NameID = 12102u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "legendoficeman, Malediktus (ported from BMR)")]
public class DD90Administrator(WorldState ws, Actor primary) : ModuleBase(ws, primary, new(-300f, -300f), new ArenaBoundsSquare(20f));
