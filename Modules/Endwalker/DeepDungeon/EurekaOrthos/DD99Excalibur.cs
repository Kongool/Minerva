...
namespace Minerva.Endwalker.DeepDungeon.EurekaOrthos.DD99Excalibur;
...
sealed class Steelstrike(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class ThermalDivideSides(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class IceBloomCross(ModuleBase module) : Components.GenericAOEs(module)
{
    private readonly List<AOEInstance> _aoes = [];
...
sealed class AbyssalSlash1(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.AbyssalSlash1, new AOEShapeDonutSector(2f, 7f, 90f.Degrees()));
sealed class AbyssalSlash2(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.AbyssalSlash2, new AOEShapeDonutSector(7f, 12f, 90f.Degrees()));
sealed class AbyssalSlash3(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.AbyssalSlash3, new AOEShapeDonutSector(17f, 22f, 90f.Degrees()));
sealed class VacuumSlash(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.VacuumSlash, new AOEShapeCone(80f, 22.5f.Degrees()));
sealed class ThermalDivide(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.ThermalDivide1, new AOEShapeRect(40f, 4f));
sealed class Exflammeus(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Exflammeus, 8f);
sealed class IceShootIceBloomCircle(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.IceShoot, (uint)AID.IceBloomCircle], 6f);
sealed class EmptySoulsCaliber(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.EmptySoulsCaliber, new AOEShapeDonut(5f, 40f));
sealed class SolidSoulsCaliber(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.SolidSoulsCaliber, 10f);

sealed class DD99ExcaliburStates : StateMachineBuilder
{
    public DD99ExcaliburStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 906u, CFCID = 906u, NameID = 12100u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class DD99Excalibur(WorldState ws, Actor primary) : ModuleBase(ws, primary, new(-600f, -300f), new ArenaBoundsCircle(19.5f));
