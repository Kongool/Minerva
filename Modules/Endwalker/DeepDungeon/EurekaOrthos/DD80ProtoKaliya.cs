...
namespace Minerva.Endwalker.DeepDungeon.EurekaOrthos.DD80ProtoKaliya;
...
sealed class Magnetism(ModuleBase module) : Components.GenericKnockback(module, stopAfterWall: true)
{
    ...
    public override void OnTethered(Actor source, in ActorTetherInfo tether)
    {
        ...
        if (tether.ID == (uint)TetherID.Magnetism)
        {
            ...
            void AddSource(bool isKnockback) => _kbs[Raid.FindSlot(target.InstanceID)] = [new(source.Position, 10f, World.FutureTime(10d), kind: isKnockback ? Kind.AwayFromOrigin : Kind.TowardsOrigin, ignoreImmunes: true)];
        }
    }
...
sealed class Barofield(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnStatusGain(Actor actor, ref ActorStatus status)
    {
        ...
        {
            _aoe = [];
            Bounds = DD80ProtoKaliya.DonutArena;
        }
    }
...
sealed class NerveGasRingAndAutoCannons(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class NerveGas(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.LeftwardNerveGas, (uint)AID.RightwardNerveGas], new AOEShapeCone(25.5f, 90f.Degrees()));

sealed class CentralizedNerveGas(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.CentralizedNerveGas, new AOEShapeCone(25.5f, 60f.Degrees()));

sealed class AutoAttack(ModuleBase module) : Components.Cleave(module, (uint)AID.AutoAttack, new AOEShapeCone(11f, 45f.Degrees()))
{
...
sealed class Resonance(ModuleBase module) : Components.BaitAwayCast(module, (uint)AID.Resonance, new AOEShapeCone(12f, 45f.Degrees()), endsOnCastEvent: true, tankbuster: true);

sealed class DD80ProtoKaliyaStates : StateMachineBuilder
{
    public DD80ProtoKaliyaStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 904u, CFCID = 904u, NameID = 12247u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Malediktus, legendoficeman (ported from BMR)")]
public sealed class DD80ProtoKaliya(WorldState ws, Actor primary) : ModuleBase(ws, primary, arenaCenter, new ArenaBoundsCircle(20f))
{
