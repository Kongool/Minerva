...
namespace Minerva.Endwalker.DeepDungeon.EurekaOrthos.DD60ServomechanicalMinotaur16;
...
sealed class BullishSwing(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.BullishSwing, 13f);
sealed class BullishSwipe(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.BullishSwipe, new AOEShapeCone(40f, 45f.Degrees()));

sealed class DisorientingGroan(ModuleBase module) : Components.SimpleKnockbacks(module, (uint)AID.DisorientingGroan, 15f)
{
...
sealed class Shock(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnActorCreated(Actor actor)
    {
        ...
        {
            _aoes.Add(new(circle, actor.Position.Quantized(), default, World.FutureTime(13d)));
        }
    }
...
{
    public DD60ServomechanicalMinotaur16States(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 902u, CFCID = 902u, NameID = 12267u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class DD60ServomechanicalMinotaur16(WorldState ws, Actor primary) : ModuleBase(ws, primary, new(-600f, -300f), new ArenaBoundsCircle(20f));
