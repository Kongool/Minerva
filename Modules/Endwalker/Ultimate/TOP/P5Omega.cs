...
sealed class P5OmegaDoubleAOEs(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnActorPlayActionTimelineEvent(Actor actor, ushort id)
    {
        if (id != 0x1E43)
            return;
        void AddAOE(AOEShape shape, Angle offset = default) => AOEs.Add(new(shape, actor.Position.Quantized(), actor.Rotation + offset, World.FutureTime(13.2d)));
        switch (actor.OID)
        {
...
sealed class P5OmegaDiffuseWaveCannon(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class P5OmegaNearDistantWorld(ModuleBase module) : P5NearDistantWorld(module)
{
...
// TODO: assign soakers
sealed class P5OmegaOversampledWaveCannon(ModuleBase module) : Components.UniformStackSpread(module, default, 7f)
{
...
sealed class P5OmegaBlaster : Components.BaitAwayTethers
{
    ...
    public P5OmegaBlaster(ModuleBase module) : base(module, 15f, (uint)TetherID.Blaster, (uint)AID.OmegaBlasterAOE)
    {
