...
sealed class P1BallisticImpact(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.BallisticImpact, 5);

sealed class P1FlameThrower(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void DrawArenaForeground(int pcSlot, Actor pc)
    {
        ...
        if (group > 0)
        {
            ...
            var pos = group == 1 ? Center + offset : Center - offset;
...
sealed class P1Pantokrator(ModuleBase module) : P1CommonAssignments(module)
{
...
class P1DiffuseWaveCannonKyrios : Components.GenericBaitAway
{
    ...
    public P1DiffuseWaveCannonKyrios(ModuleBase module) : base(module, (uint)AID.DiffuseWaveCannonKyrios)
    {
...
class P1WaveCannonKyrios(ModuleBase module) : Components.GenericBaitAway(module)
{
