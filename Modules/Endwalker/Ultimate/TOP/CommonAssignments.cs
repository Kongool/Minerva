...
abstract class CommonAssignments(ModuleBase module) : ModuleComponent(module)
{
...
abstract class P1CommonAssignments(ModuleBase module) : CommonAssignments(module)
{
