...
sealed class P2PartySynergy(ModuleBase module) : CommonAssignments(module)
{
...
sealed class P2PartySynergyDoubleAOEs(ModuleBase module) : Components.GenericAOEs(module)
{
...
{
    public P2PartySynergyOptimizedFire(ModuleBase module) : base(module, default, 7f)
    {
...
sealed class P2PartySynergyOpticalLaser(ModuleBase module) : Components.GenericAOEs(module, (uint)AID.OpticalLaser)
{
    ...
    public void Show()
    {
        _activation = World.FutureTime(6.8d);
    }
    ...
    public override void DrawArenaForeground(int pcSlot, Actor pc)
    {
        ...
        if (pos != default)
            Arena.ZoneCircleOutline(Center + pos, 1f, Colors.Safe);
    }
    ...
    private WDir AssignedPosition(int slot)
    {
        ...
        var eyeOffset = _source.Position - Center;
...
sealed class P2PartySynergyDischarger(ModuleBase module) : Components.GenericKnockback(module, (uint)AID.Discharger)
{
    public override ReadOnlySpan<Knockback> ActiveKnockbacks(int slot, Actor actor)
    {
        return new Knockback[1] { new(Center, 13f) }; // TODO: activation
    }
}
...
class P2PartySynergyEfficientBladework : Components.GenericAOEs
{
    ...
    public P2PartySynergyEfficientBladework(ModuleBase module) : base(module)
    {
    ...
    public override void OnEventCast(Actor caster, ActorCastEvent spell)
    {
        switch (spell.Action.ID)
        {
            ...
            case (uint)AID.OpticalLaser:
                _activation = World.FutureTime(9.8d);
                break;
        }
    }
    ...
    private WDir AssignedPosition(int slot)
    {
        ...
        var relNorth = 1.4f * (_sources[0].Position - Center);
        return _firstGroup[slot] ? relNorth.OrthoL() : _synergy.ActiveGlitch == P2PartySynergy.Glitch.Mid ? -relNorth : relNorth.OrthoR();
    }
}

sealed class P2PartySynergySpotlight(ModuleBase module) : Components.UniformStackSpread(module, 6f, default, 4, 4)
{
