...
sealed class P6WaveCannonPuddle(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.P6WaveCannonPuddle, 6f);

sealed class P6WaveCannonExaflare(ModuleBase module) : Components.Exaflare(module, 8f)
{
...
sealed class P6WaveCannonProteans(ModuleBase module) : Components.GenericBaitAway(module)
{
...
sealed class P6WaveCannonWildCharge(ModuleBase module) : Components.GenericWildCharge(module, 4f, (uint)AID.P6WaveCannonWildCharge, 100)
{
    public override void OnCastStarted(Actor caster, ActorCastInfo spell)
    {
        if (spell.Action.ID == (uint)AID.P6WaveCannonProtean)
