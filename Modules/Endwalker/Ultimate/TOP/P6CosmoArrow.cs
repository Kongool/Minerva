...
sealed class P6CosmoArrow(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnCastStarted(Actor caster, ActorCastInfo spell)
    {
        ...
        {
            var offset = caster.Position - Center;
    ...
    public override void OnEventCast(Actor caster, ActorCastEvent spell)
    {
        ...
        {
            if (!l.Next.AlmostEqual(caster.Position, 1) || !l.Direction.AlmostEqual(caster.Rotation, 0.1f) || (l.NextExplosion - World.CurrentTime).TotalSeconds > 1)
                continue;
            ...
            l.NextExplosion = World.FutureTime(2);
            --l.ExplosionsLeft;
            ++numLines;
        }
        if (numLines == 0)
