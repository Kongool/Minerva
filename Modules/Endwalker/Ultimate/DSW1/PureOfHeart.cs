...
sealed class PureOfHeartBrightwing(ModuleBase module) : Components.GenericBaitAway(module)
{
...
sealed class PureOfHeartSkyblindBait(ModuleBase module) : ModuleComponent(module)
{
...
sealed class PureOfHeartSkyblind(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Skyblind, 3f);
