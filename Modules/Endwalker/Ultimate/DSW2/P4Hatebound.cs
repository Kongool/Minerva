...
// TODO: hints?..
sealed class P4Hatebound(ModuleBase module) : ModuleComponent(module)
{
...
sealed class P4MirageDive(ModuleBase module) : Components.CastCounter(module, (uint)AID.MirageDiveAOE)
{
