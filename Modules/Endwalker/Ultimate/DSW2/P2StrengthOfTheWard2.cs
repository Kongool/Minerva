...
sealed class P2StrengthOfTheWard2SpreadStack : Components.UniformStackSpread
{
    ...
    public P2StrengthOfTheWard2SpreadStack(ModuleBase module) : base(module, 8, 24, 5)
    {
        ...
        var offset1 = c1.Position - Center;
        var offset2 = c2.Position - Center;
    ...
    private WPos SafeSpotAt(Angle dir) => Center + 20f * dir.ToDirection();
}

// growing voidzones
sealed class P2StrengthOfTheWard2Voidzones(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.DimensionalCollapseAOE, 9f);

// charges on tethered targets
sealed class P2StrengthOfTheWard2Charges(ModuleBase module) : Components.CastCounter(module, (uint)AID.HolyShieldBash)
{
...
sealed class P2StrengthOfTheWard2Towers(ModuleBase module) : Components.CastTowers(module, (uint)AID.Conviction1AOE, 3f)
{
