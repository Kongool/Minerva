...
sealed class P3Geirskogul(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Geirskogul, new AOEShapeRect(62f, 4f))
{
...
sealed class P3GnashAndLash(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnCastStarted(Actor caster, ActorCastInfo spell)
    {
        ...
        if (first != null && second != null)
        {
            ...
            _aoes.Add(new(first, spell.LocXZ, default, World.FutureTime(3.7d), risky: false));
            _aoes.Add(new(second, spell.LocXZ, default, World.FutureTime(6.8d), risky: false));
        }
    }
...
sealed class P3DiveFromGrace(ModuleBase module) : Components.CastTowers(module, (uint)AID.DarkdragonDive, 5f)
{
    ...
    private List<WPos> SafeSpots(int slot)
    {
        ...
        {
            safespots.Add(Center + DirectionForStack());
        }
        return safespots;
    }
}
