...
sealed class P6HallowedWings(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class P6CauterizeN : Components.GenericAOEs
{
    ...
    public P6CauterizeN(ModuleBase module) : base(module, (uint)AID.CauterizeN)
    {
        var caster = module.Enemies((uint)OID.NidhoggP6).FirstOrDefault();
        if (caster != null)
        {
            AOE = [new(_shape, caster.Position.Quantized(), caster.Rotation, World.FutureTime(8.6d))];
        }
    }
...
abstract class P6HallowedPlume(ModuleBase module) : Components.GenericBaitAway(module, (uint)AID.HallowedPlume, centerAtTarget: true)
{
...
sealed class P6HallowedPlume1(ModuleBase module) : P6HallowedPlume(module)
{
...
sealed class P6HallowedPlume2(ModuleBase module) : P6HallowedPlume(module)
{
