...
sealed class P4IntermissionBrightwing(ModuleBase module) : Components.GenericBaitAway(module)
{
...
sealed class P4IntermissionSkyblindBait(ModuleBase module) : ModuleComponent(module)
{
...
sealed class P4IntermissionSkyblind(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Skyblind, 3f);

sealed class P4Haurchefant(ModuleBase module) : ModuleComponent(module)
{
    public bool Appear;
