...
sealed class P6Touchdown(ModuleBase module) : Components.GenericAOEs(module, (uint)AID.TouchdownAOE)
{
...
class P6TouchdownCauterize(ModuleBase module) : ModuleComponent(module)
{
...
sealed class P6TouchdownPyretic(ModuleBase module) : Components.StayMove(module)
{
    public override void OnStatusGain(Actor actor, ref ActorStatus status)
    {
...
sealed class P7PhaseChange(ModuleBase module) : ModuleComponent(module)
{
...
sealed class P6Enrage(ModuleBase module) : ModuleComponent(module)
{
    public bool Enrage;
