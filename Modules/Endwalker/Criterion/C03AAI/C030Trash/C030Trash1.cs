...
class Twister(ModuleBase module) : Components.Adds(module, (uint)OID.Twister)
{
...
public abstract class C030Trash1(WorldState ws, Actor primary) : ModuleBase(ws, primary, new(default, 100f), new ArenaBoundsRect(20f, 30f));
