...
class PlanarTactics(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void DrawArenaForeground(int pcSlot, Actor pc)
    {
        ...
        if (p.StartingOffsets != null)
        {
            ...
            for (var i = 0; i < len; ++i)
                Arena.ZoneCircleOutline(Center + p.StartingOffsets[i], 1f, Colors.Safe);
        }
    }
    ...
    private void InitSafespots()
    {
        ...
        for (var i = 0; i < count; ++i)
            safeCornerOffset -= Mines[i].Origin + new WDir(0, 4) - Center;
...
class PlanarTacticsForcedMarch : Components.GenericForcedMarch
{
    ...
    public PlanarTacticsForcedMarch(ModuleBase module) : base(module)
    {
        MovementSpeed = 4;
    }
