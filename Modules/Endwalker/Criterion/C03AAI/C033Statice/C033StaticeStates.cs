...
class C033StaticeStates : StateMachineBuilder
{
    ...
    public C033StaticeStates(ModuleBase module, bool savage) : base(module)
    {
        _savage = savage;
...
class C033NStaticeStates(ModuleBase module) : C033StaticeStates(module, false);
class C033SStaticeStates(ModuleBase module) : C033StaticeStates(module, true);
