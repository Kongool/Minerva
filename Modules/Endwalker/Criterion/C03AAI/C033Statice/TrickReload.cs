...
class TrickReload(ModuleBase module) : ModuleComponent(module)
{
...
class Trapshooting(ModuleBase module) : Components.UniformStackSpread(module, 6f, 6, 4)
{
...
abstract class TriggerHappy(ModuleBase module, uint aid) : Components.SimpleAOEs(module, aid, new AOEShapeCone(40f, 30f.Degrees()));
class NTriggerHappy(ModuleBase module) : TriggerHappy(module, (uint)AID.NTriggerHappyAOE);
class STriggerHappy(ModuleBase module) : TriggerHappy(module, (uint)AID.STriggerHappyAOE);
