...
class C031KetudukeStates : StateMachineBuilder
{
    ...
    public C031KetudukeStates(ModuleBase module, bool savage) : base(module)
    {
        _savage = savage;
...
class C031NKetudukeStates(ModuleBase module) : C031KetudukeStates(module, false);
class C031SKetudukeStates(ModuleBase module) : C031KetudukeStates(module, true);
