...
namespace Minerva.Endwalker.VariantCriterion.C01ASS.C010Trash2;
...
abstract class DominionSlash(ModuleBase module, uint aid) : Components.SimpleAOEs(module, aid, new AOEShapeCone(12f, 45f.Degrees()));
sealed class NDominionSlash(ModuleBase module) : DominionSlash(module, (uint)AID.NDominionSlash);
sealed class SDominionSlash(ModuleBase module) : DominionSlash(module, (uint)AID.SDominionSlash);

abstract class InfernalWeight(ModuleBase module, uint aid) : Components.RaidwideCast(module, aid, "Raidwide with slow");
sealed class NInfernalWeight(ModuleBase module) : InfernalWeight(module, (uint)AID.NInfernalWeight);
sealed class SInfernalWeight(ModuleBase module) : InfernalWeight(module, (uint)AID.SInfernalWeight);

abstract class HellsNebula(ModuleBase module, uint aid) : Components.CastHint(module, aid, "Reduce hp to 1");
sealed class NHellsNebula(ModuleBase module) : HellsNebula(module, (uint)AID.NHellsNebula);
sealed class SHellsNebula(ModuleBase module) : HellsNebula(module, (uint)AID.SHellsNebula);

abstract class BlightedGloom(ModuleBase module, uint aid) : Components.SimpleAOEs(module, aid, 10f);
sealed class NBlightedGloom(ModuleBase module) : BlightedGloom(module, (uint)AID.NBlightedGloom);
sealed class SBlightedGloom(ModuleBase module) : BlightedGloom(module, (uint)AID.SBlightedGloom);

abstract class KingsWill(ModuleBase module, uint aid) : Components.CastHint(module, aid, "Damage increase buff");
sealed class NKingsWill(ModuleBase module) : KingsWill(module, (uint)AID.NKingsWill);
sealed class SKingsWill(ModuleBase module) : KingsWill(module, (uint)AID.SKingsWill);

abstract class InfernalPain(ModuleBase module, uint aid) : Components.RaidwideCast(module, aid);
sealed class NInfernalPain(ModuleBase module) : InfernalPain(module, (uint)AID.NInfernalPain);
sealed class SInfernalPain(ModuleBase module) : InfernalPain(module, (uint)AID.SInfernalPain);

abstract class C010DullahanStates : StateMachineBuilder
{
    public C010DullahanStates(ModuleBase module, bool savage) : base(module)
    {
        TrivialPhase()
...
sealed class C010NTrash2States(ModuleBase module) : C010DullahanStates(module, false);
sealed class C010STrash2States(ModuleBase module) : C010DullahanStates(module, true);

[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 878u, CFCID = 878u, NameID = 11506u, PrimaryActorOID = (uint)OID.NDullahan, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Malediktus (ported from BMR)")]
public sealed class C010NTrash2(WorldState ws, Actor primary) : Trash2Arena(ws, primary, false);

[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 879u, CFCID = 879u, NameID = 11506u, PrimaryActorOID = (uint)OID.SDullahan, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Malediktus (ported from BMR)")]
public sealed class C010STrash2(WorldState ws, Actor primary) : Trash2Arena(ws, primary, true);

public abstract class Trash2Arena(WorldState ws, Actor primary, bool savage) : ModuleBase(ws, primary, arena.Center, arena)
{
