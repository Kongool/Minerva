...
namespace Minerva.Endwalker.VariantCriterion.C01ASS.C010Trash1;
...
abstract class AtropineSpore(ModuleBase module, uint aid) : Components.SimpleAOEs(module, aid, new AOEShapeDonut(10f, 40f));
sealed class NAtropineSpore(ModuleBase module) : AtropineSpore(module, (uint)AID.NAtropineSpore);
sealed class SAtropineSpore(ModuleBase module) : AtropineSpore(module, (uint)AID.SAtropineSpore);

abstract class FrondAffront(ModuleBase module, uint aid) : Components.CastGaze(module, aid);
sealed class NFrondAffront(ModuleBase module) : FrondAffront(module, (uint)AID.NFrondAffront);
sealed class SFrondAffront(ModuleBase module) : FrondAffront(module, (uint)AID.SFrondAffront);

abstract class Deracinator(ModuleBase module, uint aid) : Components.SingleTargetCast(module, aid);
sealed class NDeracinator(ModuleBase module) : Deracinator(module, (uint)AID.NDeracinator);
sealed class SDeracinator(ModuleBase module) : Deracinator(module, (uint)AID.SDeracinator);

abstract class ArborealStorm(ModuleBase module, uint aid) : Components.SimpleAOEs(module, aid, 12f);
sealed class NArborealStorm(ModuleBase module) : ArborealStorm(module, (uint)AID.NArborealStorm);
sealed class SArborealStorm(ModuleBase module) : ArborealStorm(module, (uint)AID.SArborealStorm);

abstract class AcornBomb(ModuleBase module, uint aid) : Components.SimpleAOEs(module, aid, 6f);
sealed class NAcornBomb(ModuleBase module) : AcornBomb(module, (uint)AID.NAcornBomb);
sealed class SAcornBomb(ModuleBase module) : AcornBomb(module, (uint)AID.SAcornBomb);

abstract class GelidGale(ModuleBase module, uint aid) : Components.SimpleAOEs(module, aid, 6f);
sealed class NGelidGale(ModuleBase module) : GelidGale(module, (uint)AID.NGelidGale);
sealed class SGelidGale(ModuleBase module) : GelidGale(module, (uint)AID.SGelidGale);

abstract class Uproot(ModuleBase module, uint aid) : Components.SimpleAOEs(module, aid, 6f);
sealed class NUproot(ModuleBase module) : Uproot(module, (uint)AID.NUproot);
sealed class SUproot(ModuleBase module) : Uproot(module, (uint)AID.SUproot);

abstract class Sweep(ModuleBase module, uint aid) : Components.SimpleAOEs(module, aid, new AOEShapeCone(30f, 105f.Degrees()));
sealed class NRightSweep(ModuleBase module) : Sweep(module, (uint)AID.NRightSweep);
sealed class SRightSweep(ModuleBase module) : Sweep(module, (uint)AID.SRightSweep);
sealed class NLeftSweep(ModuleBase module) : Sweep(module, (uint)AID.NLeftSweep);
sealed class SLeftSweep(ModuleBase module) : Sweep(module, (uint)AID.SLeftSweep);

abstract class CreepingIvy(ModuleBase module, uint aid) : Components.SimpleAOEs(module, aid, new AOEShapeCone(10f, 45f.Degrees()));
sealed class NCreepingIvy(ModuleBase module) : CreepingIvy(module, (uint)AID.NCreepingIvy);
sealed class SCreepingIvy(ModuleBase module) : CreepingIvy(module, (uint)AID.SCreepingIvy);

abstract class Honeyed(ModuleBase module, uint aid) : Components.SimpleAOEs(module, aid, new AOEShapeCone(30f, 90f.Degrees()));
sealed class NHoneyedLeft(ModuleBase module) : Honeyed(module, (uint)AID.NHoneyedLeft);
sealed class SHoneyedLeft(ModuleBase module) : Honeyed(module, (uint)AID.SHoneyedLeft);
sealed class NHoneyedRight(ModuleBase module) : Honeyed(module, (uint)AID.NHoneyedRight);
sealed class SHoneyedRight(ModuleBase module) : Honeyed(module, (uint)AID.SHoneyedRight);

abstract class HoneyedFront(ModuleBase module, uint aid) : Components.SimpleAOEs(module, aid, new AOEShapeCone(30f, 60f.Degrees()));
sealed class NHoneyedFront(ModuleBase module) : HoneyedFront(module, (uint)AID.NHoneyedFront);
sealed class SHoneyedFront(ModuleBase module) : HoneyedFront(module, (uint)AID.SHoneyedFront);

abstract class BloodyCaress(ModuleBase module, uint aid) : Components.SimpleAOEs(module, aid, new AOEShapeCone(12f, 60f.Degrees()));
sealed class NBloodyCaress(ModuleBase module) : BloodyCaress(module, (uint)AID.NBloodyCaress);
sealed class SBloodyCaress(ModuleBase module) : BloodyCaress(module, (uint)AID.SBloodyCaress);

abstract class C010Trash1States : StateMachineBuilder
{
    public C010Trash1States(ModuleBase module, bool savage) : base(module)
    {
        TrivialPhase()
...
sealed class C010NTrash1States(ModuleBase module) : C010Trash1States(module, false);
sealed class C010STrash1States(ModuleBase module) : C010Trash1States(module, true);

[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 878u, CFCID = 878u, NameID = 11511u, PrimaryActorOID = (uint)OID.NUdumbara, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Malediktus (ported from BMR)")]
public sealed class C010NTrash1(WorldState ws, Actor primary) : Trash1Arena(ws, primary, false);

[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 879u, CFCID = 879u, NameID = 11511u, PrimaryActorOID = (uint)OID.SUdumbara, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Malediktus (ported from BMR)")]
public sealed class C010STrash1(WorldState ws, Actor primary) : Trash1Arena(ws, primary, true);

public abstract class Trash1Arena(WorldState ws, Actor primary, bool savage) : ModuleBase(ws, primary, arena.Center, arena)
{
