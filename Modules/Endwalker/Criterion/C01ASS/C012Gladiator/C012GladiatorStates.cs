...
abstract class C012GladiatorStates : StateMachineBuilder
{
    ...
    public C012GladiatorStates(ModuleBase module, bool savage) : base(module)
    {
        _savage = savage;
...
sealed class C012NGladiatorStates(ModuleBase module) : C012GladiatorStates(module, false);
sealed class C012SGladiatorStates(ModuleBase module) : C012GladiatorStates(module, true);
