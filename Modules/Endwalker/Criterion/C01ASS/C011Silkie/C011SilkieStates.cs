...
abstract class C011SilkieStates : StateMachineBuilder
{
    ...
    public C011SilkieStates(ModuleBase module, bool savage) : base(module)
    {
        _savage = savage;
...
sealed class C011NSilkieStates(ModuleBase module) : C011SilkieStates(module, false);
sealed class C011SSilkieStates(ModuleBase module) : C011SilkieStates(module, true);
