...
namespace Minerva.Endwalker.VariantCriterion.C02AMR.C020Trash1;
...
abstract class DisciplesOfLevin(ModuleBase module, uint aid) : Components.SimpleAOEs(module, aid, 10f)
{
    public override bool KeepOnPhaseChange => true;
}
sealed class NDisciplesOfLevin(ModuleBase module) : DisciplesOfLevin(module, (uint)AID.NDisciplesOfLevin);
sealed class SDisciplesOfLevin(ModuleBase module) : DisciplesOfLevin(module, (uint)AID.SDisciplesOfLevin);

abstract class BarrelingSmash(ModuleBase module, uint aid) : Components.BaitAwayChargeCast(module, aid, 3.5f)
{
    public override bool KeepOnPhaseChange => true;
}
sealed class NBarrelingSmash(ModuleBase module) : BarrelingSmash(module, (uint)AID.NBarrelingSmash);
sealed class SBarrelingSmash(ModuleBase module) : BarrelingSmash(module, (uint)AID.SBarrelingSmash);

abstract class Howl(ModuleBase module, uint aid) : Components.RaidwideCast(module, aid)
{
    public override bool KeepOnPhaseChange => true;
}
sealed class NHowl(ModuleBase module) : Howl(module, (uint)AID.NHowl);
sealed class SHowl(ModuleBase module) : Howl(module, (uint)AID.SHowl);

abstract class MasterOfLevin(ModuleBase module, uint aid) : Components.SimpleAOEs(module, aid, new AOEShapeDonut(5f, 30f))
{
    public override bool KeepOnPhaseChange => true;
}
sealed class NMasterOfLevin(ModuleBase module) : MasterOfLevin(module, (uint)AID.NMasterOfLevin);
sealed class SMasterOfLevin(ModuleBase module) : MasterOfLevin(module, (uint)AID.SMasterOfLevin);

abstract class Swipe(ModuleBase module, uint aid) : Components.SimpleAOEs(module, aid, new AOEShapeCone(60f, 90f.Degrees()))
{
    public override bool KeepOnPhaseChange => true;
}
sealed class NRightSwipe(ModuleBase module) : Swipe(module, (uint)AID.NRightSwipe);
sealed class SRightSwipe(ModuleBase module) : Swipe(module, (uint)AID.SRightSwipe);
sealed class NLeftSwipe(ModuleBase module) : Swipe(module, (uint)AID.NLeftSwipe);
sealed class SLeftSwipe(ModuleBase module) : Swipe(module, (uint)AID.SLeftSwipe);

abstract class Tornado(ModuleBase module, uint aid) : Components.SimpleAOEs(module, aid, 6f)
{
    public override bool KeepOnPhaseChange => true;
}
sealed class NTornado(ModuleBase module) : Tornado(module, (uint)AID.NTornado);
sealed class STornado(ModuleBase module) : Tornado(module, (uint)AID.STornado);

abstract class ScytheTail(ModuleBase module, uint aid) : Components.SimpleAOEs(module, aid, 10f)
{
    public override bool KeepOnPhaseChange => true;
}
sealed class NScytheTail(ModuleBase module) : ScytheTail(module, (uint)AID.NScytheTail);
sealed class SScytheTail(ModuleBase module) : ScytheTail(module, (uint)AID.SScytheTail);

abstract class Twister(ModuleBase module, uint aid) : Components.StackWithCastTargets(module, aid, 8f, 4, 4)
{
    public override bool KeepOnPhaseChange => true;
}
sealed class NTwister(ModuleBase module) : Twister(module, (uint)AID.NTwister);
sealed class STwister(ModuleBase module) : Twister(module, (uint)AID.STwister);

abstract class Crosswind(ModuleBase module, uint aid) : Components.SimpleKnockbacks(module, aid, 25f)
{
    public override bool KeepOnPhaseChange => true;
}
sealed class NCrosswind(ModuleBase module) : Crosswind(module, (uint)AID.NCrosswind);
sealed class SCrosswind(ModuleBase module) : Crosswind(module, (uint)AID.SCrosswind);
...
[ModuleInfo(CFCID = 946u, NameID = 12425u, PrimaryActorOID = (uint)OID.NYuki, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Malediktus (ported from BMR)")]
public sealed class C020NTrash1(WorldState ws, Actor primary) : Trash1Arena(ws, primary, false);

[ModuleInfo(CFCID = 947u, NameID = 12425u, PrimaryActorOID = (uint)OID.SYuki, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Malediktus (ported from BMR)")]
