...
// TODO: cast start/end?
sealed class Clearout(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnActorPlayActionTimelineEvent(Actor actor, ushort id)
    {
        ...
        {
            AOEs.Add(new(_shape, actor.Position, actor.Rotation, World.FutureTime(8.3d)));
        }
    }
}
...
sealed class AccursedEdge : Components.GenericBaitAway
{
    ...
    public AccursedEdge(ModuleBase module) : base(module, centerAtTarget: true)
    {
    ...
    public override void DrawArenaForeground(int pcSlot, Actor pc)
    {
        ...
        if (_curMechanic != Mechanic.None && _clearout != null)
        {
            ...
            for (var i = 0; i < 4; ++i)
            {
                ...
                var potentialSafespot = Center + baitDistance * dir;
