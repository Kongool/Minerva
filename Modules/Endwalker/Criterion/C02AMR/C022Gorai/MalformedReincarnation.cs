...
abstract class MalformedReincarnation(ModuleBase module, uint aid) : Components.CastCounter(module, aid);
sealed class NMalformedReincarnation(ModuleBase module) : MalformedReincarnation(module, (uint)AID.NMalformedReincarnationAOE);
sealed class SMalformedReincarnation(ModuleBase module) : MalformedReincarnation(module, (uint)AID.SMalformedReincarnationAOE);

// TODO: initial hints (depending on strat?) + specific towers
sealed class MalformedPrayer2(ModuleBase module) : Components.GenericTowers(module)
{
...
abstract class FlickeringFlame(ModuleBase module, uint aid) : Components.SimpleAOEs(module, aid, new AOEShapeRect(46f, 2.5f), 8);
sealed class NFlickeringFlame(ModuleBase module) : FlickeringFlame(module, (uint)AID.NFireSpreadCross);
sealed class SFlickeringFlame(ModuleBase module) : FlickeringFlame(module, (uint)AID.SFireSpreadCross);
