...
class C022GoraiStates : StateMachineBuilder
{
    ...
    public C022GoraiStates(ModuleBase module, bool savage) : base(module)
    {
        _savage = savage;
...
sealed class C022NGoraiStates(ModuleBase module) : C022GoraiStates(module, false);
sealed class C022SGoraiStates(ModuleBase module) : C022GoraiStates(module, true);
