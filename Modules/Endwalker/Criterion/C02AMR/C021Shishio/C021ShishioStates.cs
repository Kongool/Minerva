...
abstract class C021ShishioStates : StateMachineBuilder
{
    ...
    public C021ShishioStates(ModuleBase module, bool savage) : base(module)
    {
        _savage = savage;
...
sealed class C021NShishioStates(ModuleBase module) : C021ShishioStates(module, false);
sealed class C021SShishioStates(ModuleBase module) : C021ShishioStates(module, true);
