...
class FarFlungFire(ModuleBase module) : Components.GenericWildCharge(module, 3f, fixedLength: 40f)
{
    private bool _real;
...
class DeepestPit(ModuleBase module) : Components.GenericAOEs(module)
{
    private bool _real;
