...
sealed class RadiantRhythm(ModuleBase module) : Components.GenericAOEs(module, (uint)AID.RadiantFlight)
{
...
sealed class RadiantFlourish(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnCastFinished(Actor caster, ActorCastInfo spell)
    {
        ...
        {
            _aoes.Add(new(circle, spell.LocXZ, default, World.FutureTime(16.6d)));
        }
