...
{
    public A32LlymlaenStates(ModuleBase module) : base(module)
    {
    ...
    private void SurgingWaveSeaFoam(uint id, float delay)
    {
        Cast(id, (uint)AID.SurgingWave, delay, 9)
            ...
            .ExecOnEnter<SurgingWaveCorridor>(comp => Module.Center = comp.CorridorDir.X > 0f ? A32Llymlaen.EastCorridorBounds.Center : A32Llymlaen.WestCorridorBounds.Center)
            .ExecOnEnter<SurgingWaveCorridor>(comp => Module.Bounds = comp.CorridorDir.X > 0f ? A32Llymlaen.EastCorridorBounds : A32Llymlaen.WestCorridorBounds);
        ...
        ComponentCondition<SurgingWaveCorridor>(id + 0x50, 0.5f, comp => comp.CorridorDir == default)
            ...
            .OnExit(() => (Module.Center, Module.Bounds) = (A32Llymlaen.DefaultCenter, A32Llymlaen.DefaultBounds));
