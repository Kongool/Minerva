...
class Octagons(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnMapEffect(byte index, uint state)
    {
        ...
        switch (state)
        {
            case 0x00100008u when index == 0x07:
                ...
                _aoe = [new(shape, center, default, World.FutureTime(9d), shapeDistance: shape.Distance(center, default))];
                break;
        ...
        if (update)
        {
            Bounds = new ArenaBoundsCustom([new Circle(new(-700f, 600f), 29.5f)], [.. octagonsOuter], [.. octagonsInner]);
        }
    }
