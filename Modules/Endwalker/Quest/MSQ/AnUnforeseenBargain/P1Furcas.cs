...
class Explosion(ModuleBase module) : Components.CastTowers(module, (uint)AID.Explosion, 5f);
class VoidSlash(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.VoidSlash, new AOEShapeCone(9.7f, 45f.Degrees()));
class JongleursX(ModuleBase module) : Components.SingleTargetCast(module, (uint)AID.JongleursX);
class StraightSpindle(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.StraightSpindle, new AOEShapeRect(51.08f, 2.5f));
class VoidTorch(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.VoidTorch, 6f);
class HellishScythe(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.HellishScythe, 10f);
class FlameBlast(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.FlameBlast, new AOEShapeRect(80.6f, 2f));
class JestersReward(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.JestersReward, new AOEShapeCone(28f, 90f.Degrees()));

class Blackout1(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.Blackout1);
class Blackout2(ModuleBase module) : Components.CastHint(module, (uint)AID.Blackout2, "Kill the Voidskipper!", true)
{
...
[ModuleInfo(Group = ModuleGroup.Quest, CFCID = 70209u, NameID = 12066u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "ported from BossmodReborn")]
public class Furcas(WorldState ws, Actor primary) : ModuleBase(ws, primary, ArenaBounds.Center, ArenaBounds)
{
