...
namespace Minerva.Endwalker.Quest.Job.Sage.SagesFocus;
...
class DosisIII(ModuleBase module) : Components.SingleTargetCast(module, (uint)AID.DosisIII);
class DemifireSpread(ModuleBase module) : Components.SpreadFromCastTargets(module, (uint)AID.DemifireIISpread, 5);
class DemifireIIAOE(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.DemifireIIAOE, 14);
class DemifireIII(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.DemifireIII1);
class Noubelea(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Noubelea1, new AOEShapeRect(50, 2));
class Demigravity1(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Demigravity1, 6);
class Demigravity2(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Demigravity2, 6);
class Demiblizzard(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.DemiblizzardIII1, new AOEShapeDonut(10, 40));
class TripleThreat(ModuleBase module) : Components.SingleTargetCast(module, (uint)AID.TripleThreat);
class Explosion(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Explosion, 6);
class ArmOfTheScholar(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.ArmOfTheScholar, 5);

class AncelRockfistStates : StateMachineBuilder
{
    public AncelRockfistStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.Quest, CFCID = 69604u, NameID = 10732u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "ported from BossmodReborn")]
public class AncelRockfist(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
