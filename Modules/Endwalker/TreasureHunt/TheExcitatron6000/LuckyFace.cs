...
namespace Minerva.Endwalker.TreasureHunt.Excitatron6000.LuckyFace;
...
abstract class InTheDark(ModuleBase module, uint aid) : Components.SimpleAOEs(module, aid, new AOEShapeCone(20f, 90f.Degrees()));
class LeftInTheDark1(ModuleBase module) : InTheDark(module, (uint)AID.LeftInTheDark1);
class LeftInTheDark2(ModuleBase module) : InTheDark(module, (uint)AID.LeftInTheDark2);
class RightInTheDark1(ModuleBase module) : InTheDark(module, (uint)AID.RightInTheDark1);
class RightInTheDark2(ModuleBase module) : InTheDark(module, (uint)AID.RightInTheDark2);

abstract class QuakeCircle(ModuleBase module, uint aid) : Components.SimpleAOEs(module, aid, 10f);
class QuakeMeAwayCircle(ModuleBase module) : QuakeCircle(module, (uint)AID.QuakeMeAwayCircle);
class QuakeInYourBootsCircle(ModuleBase module) : QuakeCircle(module, (uint)AID.QuakeInYourBootsCircle);

abstract class QuakeDonut(ModuleBase module, uint aid) : Components.SimpleAOEs(module, aid, new AOEShapeDonut(10f, 20f));
class QuakeInYourBootsDonut(ModuleBase module) : QuakeDonut(module, (uint)AID.QuakeInYourBootsDonut);
class QuakeMeAwayDonut(ModuleBase module) : QuakeDonut(module, (uint)AID.QuakeMeAwayDonut);

class HeartOnFireII(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.HeartOnFireII, 6f);
class HeartOnFireIV(ModuleBase module) : Components.SingleTargetCast(module, (uint)AID.HeartOnFireIV);
class HeartOnFireIII(ModuleBase module) : Components.SpreadFromCastTargets(module, (uint)AID.HeartOnFireIII, 6f);
class TempersFlare(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.TempersFlare);
...
{
    public LuckyFaceStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 819u, NameID = 10831u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Malediktus (ported from BMR)")]
public class LuckyFace(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
