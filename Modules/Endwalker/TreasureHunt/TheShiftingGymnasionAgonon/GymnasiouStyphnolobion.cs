...
namespace Minerva.Endwalker.TreasureHunt.ShiftingGymnasionAgonon.GymnasiouStyphnolobion;
...
class Rake(ModuleBase module) : Components.SingleTargetCast(module, (uint)AID.Rake);
class Tiiimbeeer(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.Tiiimbeeer);
class StoneIII(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.StoneIII2, 6f);
class EarthShaker(ModuleBase module) : Components.BaitAwayCast(module, (uint)AID.EarthShaker, new AOEShapeCone(60f, 15f.Degrees()), endsOnCastEvent: true);

class EarthQuaker(ModuleBase module) : Components.ConcentricAOEs(module, _shapes)
{
...
{
    public GymnasiouStyphnolobionStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 909u, NameID = 12012u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Malediktus (ported from BMR)")]
