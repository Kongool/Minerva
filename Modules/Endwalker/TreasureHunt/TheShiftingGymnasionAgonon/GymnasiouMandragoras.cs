...
namespace Minerva.Endwalker.TreasureHunt.ShiftingGymnasionAgonon.GymnasiouMandragoras;
...
class Ram(ModuleBase module) : Components.SingleTargetCast(module, (uint)AID.Ram);
...
{
    public GymnasiouMandragorasStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
            .ActivateOnEnter<Ram>()
...
[ModuleInfo(CFCID = 909u, NameID = 12022u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Malediktus (ported from BMR)")]
