...
namespace Minerva.Endwalker.TreasureHunt.ShiftingGymnasionAgonon.GymnasiouSphinx;
...
class Scratch(ModuleBase module) : Components.SingleTargetCast(module, (uint)AID.Scratch);
class Explosion(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Explosion, new AOEShapeDonut(3f, 12f));
class FrigidPulse(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.FrigidPulse, new AOEShapeDonut(12f, 60f));
class FervidPulse(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.FervidPulse, new AOEShapeCross(50f, 7f));
class MoltingPlumage(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.MoltingPlumage);
class AlpineDraft(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.AlpineDraft, new AOEShapeRect(45f, 2.5f));
class FeatherRain(ModuleBase module) : Components.SpreadFromCastTargets(module, (uint)AID.FeatherRain, 6f);
class AeroII(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.AeroII, 4f);
...
{
    public GymnasiouSphinxStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 909u, NameID = 12016u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Malediktus (ported from BMR)")]
