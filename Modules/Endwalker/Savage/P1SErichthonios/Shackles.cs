...
class Shackles(ModuleBase module) : ModuleComponent(module)
{
    ...
    {
        var way1 = World.Waymarks.GetFieldMark((int)Waymark.A + order);
        var way2 = World.Waymarks.GetFieldMark((int)Waymark.N1 + order);
        if (way1 == null || way2 == null)
            return;

        var w1 = new WPos(way1.Value.XZ());
        var w2 = new WPos(way2.Value.XZ());
        var d1 = (w1 - Center).LengthSq();
        var d2 = (w2 - Center).LengthSq();
