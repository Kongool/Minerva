...
class LimitlessDesolation : Components.UniformStackSpread
{
    ...
    public LimitlessDesolation(ModuleBase module) : base(module, default, 6f, raidwideOnResolve: false)
    {
    ...
    public override void AddHints(int slot, Actor actor, TextHints hints)
    {
        ...
        if (towerIndex >= 0 && !actor.Position.InCircle(Center + _towerOffsets[towerIndex], _towerRadius))
    ...
    public override void DrawArenaForeground(int pcSlot, Actor pc)
    {
        ...
        if (towerIndex >= 0)
            Arena.ZoneCircleOutline(Center + _towerOffsets[towerIndex], _towerRadius, Colors.Safe, 2f);
    }
...
class LimitlessDesolationTyrantsFlare(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.TyrantsFlareLimitless, 8f);
