...
class ForbiddenFruitCommon(ModuleBase module, uint watchedAction) : Components.GenericAOEs(module, watchedAction)
{
    ...
    public override void DrawArenaForeground(int pcSlot, Actor pc)
    {
        ...
        foreach (var platform in SafePlatforms[pcSlot].SetBits())
            Arena.ZoneCircleOutline(Center + PlatformDirection(platform).ToDirection() * 16.5f, 10f, Colors.Safe);
    }
