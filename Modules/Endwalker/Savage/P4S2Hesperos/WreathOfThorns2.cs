...
class WreathOfThorns2(ModuleBase module) : ModuleComponent(module)
{
    ...
    public override void DrawArenaForeground(int pcSlot, Actor pc)
    {
        ...
        var pcPartner = pc.Tether.Target != 0
            ? World.Actors.Find(pc.Tether.Target)
    ...
    private void PlayerTetherOrIconAssigned(int slot, Actor actor)
    {
        ...
        var tetherTarget = World.Actors.Find(actor.Tether.Target);
