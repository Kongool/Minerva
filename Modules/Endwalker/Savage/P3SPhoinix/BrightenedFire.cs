...
class BrightenedFire(ModuleBase module) : Components.CastCounter(module, (uint)AID.BrightenedFireAOE)
{
    ...
    private WPos PositionForOrder(int order)
    {
        ...
        var wm = World.Waymarks.GetFieldMark(markID);
        return wm != null ? new(wm.Value.XZ()) : Center;
    }
}
