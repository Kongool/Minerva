...
class PandaemoniacMeltdown(ModuleBase module) : Components.CastCounter(module, (uint)AID.PandaemoniacMeltdownStack)
{
    ...
    public override void OnEventCast(Actor caster, ActorCastEvent spell)
    {
        ...
        if (spell.Action.ID == (uint)AID.PandaemoniacMeltdownTargetSelect)
            _stackTarget = World.Actors.Find(spell.MainTargetID);
    }
