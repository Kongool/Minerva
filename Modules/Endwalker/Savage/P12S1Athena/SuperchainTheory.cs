...
abstract class SuperchainTheory(ModuleBase module) : ModuleComponent(module)
{
    ...
    public override void Update()
    {
        ...
        for (var i = count; i >= 0; --i)
        {
            ...
            else if (World.Actors.Find(source.Tether.Target) is var origin && origin != null)
            {
                Chains.Add(new(origin, source, shape, World.FutureTime(ActivationDelay((source.Position - origin.Position).Length()))));
...
sealed class SuperchainTheory1(ModuleBase module) : SuperchainTheory(module)
{
...
sealed class SuperchainTheory2A(ModuleBase module) : SuperchainTheory(module)
{
    public override float ActivationDelay(float distance)
    {
        return distance switch
...
sealed class SuperchainTheory2B(ModuleBase module) : SuperchainTheory(module)
{
    public override float ActivationDelay(float distance)
    {
        return distance switch
