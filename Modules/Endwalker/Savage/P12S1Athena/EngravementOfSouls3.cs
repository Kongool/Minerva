...
sealed class EngravementOfSouls3Shock(ModuleBase module) : Components.CastTowers(module, (uint)AID.Shock, 3f)
{
...
sealed class EngravementOfSouls3Spread(ModuleBase module) : Components.UniformStackSpread(module, default, 3f, raidwideOnResolve: false)
{
...
sealed class TheosCrossSaltire(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.TheosCross, (uint)AID.TheosSaltire], new AOEShapeCross(40f, 3f));

// TODO: this assumes standard strats, there could be variations i guess...
sealed class EngravementOfSouls3Hints(ModuleBase module) : ModuleComponent(module)
{
    ...
    public override void DrawArenaForeground(int pcSlot, Actor pc)
    {
        ...
        for (var i = 0; i < count; ++i)
        {
            ...
            if (chain.Count > 0)
            {
                Arena.ZoneCircleOutline(Center + chain[0], 1f, Colors.Safe);
            }
        }
    }
    ...
    public override void OnTethered(Actor source, in ActorTetherInfo tether)
    {
        switch (tether.ID)
        {
            ...
            case (uint)TetherID.UnnaturalEnchainment:
                ...
                {
                    _topLeftSafe = source.PosRot.X > Center.X;
    ...
    {
        var stayLeft = source.PosRot.X > Center.X;
        var stayTop = source.PosRot.Z > Center.Z;
