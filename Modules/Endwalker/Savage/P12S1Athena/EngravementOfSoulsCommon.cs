...
sealed class EngravementOfSoulsTethers(ModuleBase module) : Components.GenericBaitAway(module)
{
...
sealed class EngravementOfSoulsTowers(ModuleBase module) : Components.GenericTowers(module)
{
