...
sealed class EngravementOfSouls2Lines(ModuleBase module) : ModuleComponent(module)
{
...
sealed class EngrameventOfSouls2Spread(ModuleBase module) : Components.GenericStackSpread(module, true, false)
{
