...
class Shift(ModuleBase module) : ModuleComponent(module)
{
    ...
    public override void AddHints(int slot, Actor actor, TextHints hints)
    {
        ...
        else if (_cloakCaster != null && !InBounds(Components.GenericKnockback.AwayFromSource(actor.Position, _cloakCaster, _knockbackRange)))
        {
