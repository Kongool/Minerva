...
class ElementalBelone : ModuleComponent
{
    ...
    public override void DrawArenaBackground(int pcSlot, Actor pc)
    {
        if (Visible)
        {
            ...
            {
                var p = Center + 10 * assignments.Direction(safeCorner);
