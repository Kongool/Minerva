...
class Pinax(ModuleBase module) : ModuleComponent(module)
{
    ...
    public override void AddHints(int slot, Actor actor, TextHints hints)
    {
        ...
        if (_water != null)
        {
            ...
            if (!InBounds(Components.GenericKnockback.AwayFromSource(actor.Position, Center, _knockbackRadius)))
            {
        ...
        if (_lighting != null)
        {
            ...
            hints.Add("GTFO from center!", actor.Position.InRect(Center, new WDir(1, 0), _lightingSafeDistance, _lightingSafeDistance, _lightingSafeDistance));
        }
    }
    ...
    public override void DrawArenaBackground(int pcSlot, Actor pc)
    {
        ...
        if (_lighting != null)
        {
            ...
            Arena.ZoneRect(Center, new WDir(1, 0), _lightingSafeDistance, _lightingSafeDistance, _lightingSafeDistance, Colors.AOE);
        }
    }
    ...
    public override void DrawArenaForeground(int pcSlot, Actor pc)
    {
        ...
        if (_water != null)
        {
            var adjPos = Components.GenericKnockback.AwayFromSource(pc.Position, Center, _knockbackRadius);
