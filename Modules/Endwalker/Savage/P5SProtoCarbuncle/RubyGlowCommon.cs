...
abstract class RubyGlowCommon(ModuleBase module, uint watchedAction = default) : Components.GenericAOEs(module, watchedAction)
{
    ...
    public WPos QuadrantCenter(int q) => Center + Bounds.Radius * 0.5f * QuadrantDir(q);
...
abstract class RubyGlowRecolor(ModuleBase module, int expectedMagicStones) : RubyGlowCommon(module, (uint)AID.VenomPoolRecolorAOE)
{
