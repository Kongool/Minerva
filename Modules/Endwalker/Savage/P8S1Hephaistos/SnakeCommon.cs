...
class SnakingKick(ModuleBase module) : Components.GenericAOEs(module, (uint)AID.SnakingKick)
{
...
abstract class PetrifactionCommon(ModuleBase module) : Components.GenericGaze(module, (uint)AID.PetrifactionAOE)
{
    ...
    private static List<Actor> GetGorgons(ModuleBase module)
    {
    ...
    public override void OnCastStarted(Actor caster, ActorCastInfo spell)
    {
        ...
        {
            var dir = Angle.FromDirection(caster.Position - Center);
