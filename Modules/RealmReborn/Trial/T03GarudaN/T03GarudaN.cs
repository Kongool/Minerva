...
namespace Minerva.RealmReborn.Trial.T03GarudaN;
...
class Friction(ModuleBase module) : ModuleComponent(module)
{
...
class Downburst(ModuleBase module) : Components.Cleave(module, (uint)AID.Downburst, new AOEShapeCone(11.7f, 60f.Degrees()));
class Slipstream(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Slipstream, new AOEShapeCone(11.7f, 45f.Degrees()));

class MistralSongP1(ModuleBase module) : Components.CastLineOfSightAOE(module, (uint)AID.MistralSongP1, 31.7f, true)
{
...
class EyeOfTheStorm(ModuleBase module) : Components.GenericAOEs(module, (uint)AID.AerialBlast)
{
...
class MistralSongP2(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.MistralSongP2, new AOEShapeCone(31.7f, 60f.Degrees()));
class MistralShriek(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.MistralShriek, 24.7f);

class T03GarudaNStates : StateMachineBuilder
{
    public T03GarudaNStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 58u, NameID = 1644u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "ported from BossmodReborn")]
public class T03GarudaN(WorldState ws, Actor primary) : ModuleBase(ws, primary, default, new ArenaBoundsCircle(21f))
{
