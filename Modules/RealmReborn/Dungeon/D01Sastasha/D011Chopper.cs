...
namespace Minerva.RealmReborn.Dungeon.D01Sastasha.D011Chopper;
...
class ChargedWhisker(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.ChargedWhisker, new AOEShapeCircle(6.15f));

class D011ChopperStates : StateMachineBuilder
{
    public D011ChopperStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 4u, NameID = 1204u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Chuggalo (ported from BMR)")]
public class D011Chopper(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
