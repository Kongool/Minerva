...
namespace Minerva.RealmReborn.Dungeon.D12AurumVale.D123MisersMistress;
...
[SkipLocalsInit]
sealed class BurrBurrow(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.BurrBurrow);

[SkipLocalsInit]
sealed class VineProbe(ModuleBase module) : Components.SingleTargetDelayableCast(module, (uint)AID.VineProbe);

[SkipLocalsInit]
sealed class BadBreath(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.BadBreath, new AOEShapeCone(15.85f, 60f.Degrees()));

[SkipLocalsInit]
sealed class MorbolFruit(ModuleBase module) : ModuleComponent(module)
{
    private BitMask burrs;
    private List<Actor> _fruits = [];
...
{
    public D123MisersMistressStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 5u, CFCID = 5u, NameID = 1532u, PrimaryActorOID = (uint)OID.MisersMistress, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
[SkipLocalsInit]
public sealed class D123MisersMistress : ModuleBase
{
