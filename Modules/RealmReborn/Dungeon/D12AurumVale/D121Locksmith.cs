...
namespace Minerva.RealmReborn.Dungeon.D12AurumVale.D121Locksmith;
...
[SkipLocalsInit]
sealed class HundredLashings(ModuleBase module) : Components.SingleTargetDelayableCast(module, (uint)AID.HundredLashings);

[SkipLocalsInit]
sealed class GoldDust(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.GoldDust, 8f);

[SkipLocalsInit]
sealed class GoldRush(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.GoldDust);
...
{
    public D121LocksmithStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 5u, CFCID = 5u, NameID = 1534u, PrimaryActorOID = (uint)OID.Locksmith, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
[SkipLocalsInit]
public sealed class D121Locksmith : ModuleBase
{
