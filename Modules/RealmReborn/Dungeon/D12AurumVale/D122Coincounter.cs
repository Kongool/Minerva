...
namespace Minerva.RealmReborn.Dungeon.D12AurumVale.D122Coincounter;
...
[SkipLocalsInit]
sealed class TenHundredTonzeSwipe(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.HundredTonzeSwipe, (uint)AID.HundredTonzeSwipe], new AOEShapeCone(10f, 60f.Degrees()));

[SkipLocalsInit]
sealed class HundredTonzeSwing(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.HundredTonzeSwing, 12f);

[SkipLocalsInit]
sealed class Glower(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Glower, new AOEShapeRect(21f, 3.5f));

[SkipLocalsInit]
sealed class EyeOfTheBeholder(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.EyeOfTheBeholder, new AOEShapeDonutSector(8f, 19f, 135f.Degrees()));

[SkipLocalsInit]
sealed class Paralysis(ModuleBase module) : Components.CleansableDebuff(module, (uint)SID.Paralysis, "Paralysis", "paralyzed");

[SkipLocalsInit]
sealed class Electrocution(ModuleBase module) : Components.CleansableDebuff(module, (uint)SID.Electrocution, "Electrocution", "electrocuted");

[SkipLocalsInit]
sealed class D122CoincounterStates : StateMachineBuilder
{
    public D122CoincounterStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 5u, CFCID = 5u, NameID = 1533u, PrimaryActorOID = (uint)OID.Coincounter, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
[SkipLocalsInit]
public sealed class D122Coincounter : ModuleBase
{
