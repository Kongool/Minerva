...
namespace Minerva.RealmReborn.Dungeon.D11DzemaelDarkhold.D113Batraal;
...
[SkipLocalsInit]
sealed class Desolation(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Desolation, new AOEShapeRect(60f, 3f));

[SkipLocalsInit]
sealed class AetherialSurge(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.AetherialSurge, 6f);
...
{
    public D113BatraalStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 13u, CFCID = 13u, NameID = 1396u, PrimaryActorOID = (uint)OID.Batraal, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
[SkipLocalsInit]
public sealed class D113Batraal : ModuleBase
{
