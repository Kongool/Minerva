...
namespace Minerva.RealmReborn.Dungeon.D11DzemaelDarkhold.D111AllSeeingEye;
...
[SkipLocalsInit]
sealed class BlusteringBlink(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.BlusteringBlink, new AOEShapeRect(55f, 5f));

[SkipLocalsInit]
sealed class VoidMatter(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.VoidMatter, 10f, 6);
...
{
    public D111AllSeeingEyeStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 13u, CFCID = 13u, NameID = 1397u, PrimaryActorOID = (uint)OID.AllSeeingEye, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
[SkipLocalsInit]
public sealed class D111AllSeeingEye : ModuleBase
{
