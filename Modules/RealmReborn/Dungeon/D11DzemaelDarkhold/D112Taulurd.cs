...
namespace Minerva.RealmReborn.Dungeon.D11DzemaelDarkhold.D112Taulurd;
...
[SkipLocalsInit]
sealed class DoubleSmash(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.DoubleSmash, new AOEShapeCone(8f, 60f.Degrees()));

[SkipLocalsInit]
sealed class Firewater(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Firewater, 5f);

[SkipLocalsInit]
sealed class D112TaulurdStates : StateMachineBuilder
{
    public D112TaulurdStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 13u, CFCID = 13u, NameID = 1415u, PrimaryActorOID = (uint)OID.Taulurd, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
[SkipLocalsInit]
public sealed class D112Taulurd : ModuleBase
{
