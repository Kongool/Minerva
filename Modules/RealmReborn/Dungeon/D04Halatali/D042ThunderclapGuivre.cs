...
namespace Minerva.RealmReborn.Dungeon.D04Halatali.D042ThunderclapGuivre;
...
sealed class Levinfang(ModuleBase module) : Components.SingleTargetCast(module, (uint)AID.Levinfang);
sealed class Electrify(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Electrify, 6f);
sealed class HydroelectricShock(ModuleBase module) : Components.GenericAOEs(module)
{
...
{
    public D042ThunderclapGuivreStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 7u, CFCID = 7u, NameID = 1196u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class D042ThunderclapGuivre : ModuleBase
{
