...
namespace Minerva.RealmReborn.Dungeon.D04Halatali.D041Firemane;
...
class Fireflow(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.Fireflow1, (uint)AID.Fireflow2], new AOEShapeCone(60f, 22.5f.Degrees()), 4, 8);
class BurningBolt(ModuleBase module) : Components.SingleTargetCast(module, (uint)AID.BurningBolt);
...
{
    public D041FiremaneStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
public class D041Firemane(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
