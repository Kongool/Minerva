...
namespace Minerva.RealmReborn.Dungeon.D10StoneVigil.D103Isgebind;
...
class RimeWreath(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.RimeWreath);
class FrostBreath(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.FrostBreath, new AOEShapeCone(27f, 60f.Degrees()))
{
    public static readonly AOEShapeCone Cone = new(27f, 60f.Degrees());
}
class FrostBreathCleave(ModuleBase module) : Components.Cleave(module, (uint)AID.FrostBreath, FrostBreath.Cone, activeWhileCasting: false);
class SheetOfIce(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.SheetOfIce, 5f);
class SheetOfIce2(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.SheetOfIce2, 5f);
class Cauterize(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Cauterize, new AOEShapeRect(48f, 10f));

class Touchdown(ModuleBase module) : Components.GenericAOEs(module, (uint)AID.Touchdown)
{
    ...
    public override void OnActorPlayActionTimelineEvent(Actor actor, ushort id)
    {
        ...
        {
            _aoe = [new(_shape, D103Isgebind.ArenaCenter.Quantized(), default, World.FutureTime(7.8d))];
        }
    }
...
{
    public D103IsgebindStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 11u, NameID = 1680u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Malediktus, Chuggalo (ported from BMR)")]
public class D103Isgebind(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
