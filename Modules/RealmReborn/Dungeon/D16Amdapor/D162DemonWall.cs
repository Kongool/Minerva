...
namespace Minerva.RealmReborn.Dungeon.D16Amdapor.D162DemonWall;
...
class LiquefyCenter(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.LiquefyCenter, new AOEShapeRect(50f, 4f));
class LiquefySides(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.LiquefySides, new AOEShapeRect(50f, 3.5f));

class Repel(ModuleBase module) : Components.SimpleKnockbacks(module, (uint)AID.Repel, 20f, true)
{
...
class ForbiddenZones(ModuleBase module) : Components.GenericAOEs(module)
{
...
{
    public D162DemonWallStates(ModuleBase module) : base(module)
    {
...
[ModuleInfo(CFCID = 14u, NameID = 1694u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "ported from BossmodReborn")]
public class D162DemonWall(WorldState ws, Actor primary) : ModuleBase(ws, primary, new(200f, -131f), new ArenaBoundsRect(10f, 21f));
