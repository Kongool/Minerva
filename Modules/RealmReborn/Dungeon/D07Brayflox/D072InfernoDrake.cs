...
namespace Minerva.RealmReborn.Dungeon.D07Brayflox.D072InfernoDrake;
...
class BurningCyclone(ModuleBase module) : Components.Cleave(module, (uint)AID.BurningCyclone, new AOEShapeCone(8.6f, 60.Degrees()));

class D072InfernoDrakeStates : StateMachineBuilder
{
    public D072InfernoDrakeStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 8u, NameID = 1284u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Chuggalo (ported from BMR)")]
public class D072InfernoDrake(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
