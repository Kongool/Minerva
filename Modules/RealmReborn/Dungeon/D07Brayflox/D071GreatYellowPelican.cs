...
namespace Minerva.RealmReborn.Dungeon.D07Brayflox.D071GreatYellowPelican;
...
class NumbingBreath(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.NumbingBreath, new AOEShapeCone(9.2f, 60.Degrees()));

class D071GreatYellowPelicanStates : StateMachineBuilder
{
    public D071GreatYellowPelicanStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 8u, NameID = 1280u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Chuggalo (ported from BMR)")]
public class D071GreatYellowPelican(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
