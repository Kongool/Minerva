...
namespace Minerva.RealmReborn.Raid.T04Gauntlet;
...
class Rotoswipe(ModuleBase module) : Components.Cleave(module, (uint)AID.Rotoswipe, new AOEShapeCone(11, 60.Degrees()), [(uint)OID.ClockworkDreadnaught]); // TODO: verify angle

class GravityThrustPox(ModuleBase module) : Components.GenericAOEs(module, default, "Move behind rook!")
{
...
class EmergencyOverride(ModuleBase module) : Components.CastCounter(module, (uint)AID.EmergencyOverride);
...
[ModuleInfo(CFCID = 96u, NameID = 0u, PrimaryActorOID = (uint)OID.TerminalStart, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "ported from BossmodReborn")]
public class T04Gauntlet : ModuleBase
{
