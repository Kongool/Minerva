...
namespace Minerva.RealmReborn.Raid.T02MultiADS;
...
class CleaveCommon(ModuleBase module, uint aid, float hitboxRadius) : Components.Cleave(module, aid, new AOEShapeCone(6 + hitboxRadius, 60.Degrees()), activeWhileCasting: false);
class CleaveADS(ModuleBase module) : CleaveCommon(module, (uint)AID.CleaveADS, 2.3f);
class CleaveNode(ModuleBase module) : CleaveCommon(module, (uint)AID.CleaveNode, 1.15f);

class HighVoltage(ModuleBase module) : Components.CastInterruptHint(module, (uint)AID.HighVoltage);
class RepellingCannons(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.RepellingCannons, 8.3f);
class PiercingLaser(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.PiercingLaser, new AOEShapeRect(32.3f, 3));
// TODO: chain lightning?..
class Firestream(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.FirestreamAOE, new AOEShapeRect(35.5f, 3));
class Ballast1(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.BallastAOE1, new AOEShapeCone(5.5f, 135.Degrees()));
class Ballast2(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.BallastAOE2, new AOEShapeDonutSector(5.5f, 10.5f, 135.Degrees()));
class Ballast3(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.BallastAOE3, new AOEShapeDonutSector(10.5f, 15.5f, 135.Degrees()));
class GravityField(ModuleBase module) : Components.VoidzoneAtCastTarget(module, 6, (uint)AID.GravityField, m => m.Enemies((uint)OID.GravityField), 1);

class T02AI(ModuleBase module) : ModuleComponent(module)
{
    public override void AddAIHints(int slot, Actor actor, PartyRolesConfig.Assignment assignment, AIHints hints)
    {
        foreach (var e in hints.PotentialTargets)
        {
            ...
            {
                int targetVulnStacks = World.Actors.Find(e.Actor.TargetID)?.FindStatus(SID.VulnerabilityUp)?.Extra ?? 0;
...
{
    public T02ADSStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 94u, NameID = 1459u, PrimaryActorOID = (uint)OID.ADS, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "ported from BossmodReborn")]
public class T02ADS(WorldState ws, Actor primary) : ModuleBase(ws, primary, new(0, 77), new ArenaBoundsRect(18, 13));

class T02QuarantineNodeStates : StateMachineBuilder
{
    public T02QuarantineNodeStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 94u, NameID = 1468u, PrimaryActorOID = (uint)OID.QuarantineNode, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "ported from BossmodReborn")]
public class T02QuarantineNode(WorldState ws, Actor primary) : ModuleBase(ws, primary, new(0, 112), new ArenaBoundsRect(14, 13))
{
...
{
    public T02AttackNodeStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
            .ActivateOnEnter<CleaveNode>()
            .ActivateOnEnter<HighVoltage>()
...
[ModuleInfo(CFCID = 94u, NameID = 1469u, PrimaryActorOID = (uint)OID.AttackNode, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "ported from BossmodReborn")]
public class T02AttackNode(WorldState ws, Actor primary) : ModuleBase(ws, primary, new(-44, 94), new ArenaBoundsSquare(17))
{
    protected override bool CheckPull() => base.CheckPull() && !Enemies((uint)OID.ADS).Any(e => e.InCombat); // don't start modules for temporary node actors spawned during main boss fight
}
...
{
    public T02SanitaryNodeStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
            .ActivateOnEnter<CleaveNode>()
            .ActivateOnEnter<HighVoltage>()
...
[ModuleInfo(CFCID = 94u, NameID = 1470u, PrimaryActorOID = (uint)OID.SanitaryNode, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "ported from BossmodReborn")]
public class T02SanitaryNode(WorldState ws, Actor primary) : ModuleBase(ws, primary, new(-43, 52), new ArenaBoundsRect(18, 15))
{
    protected override bool CheckPull() => base.CheckPull() && !Enemies((uint)OID.ADS).Any(e => e.InCombat); // don't start modules for temporary node actors spawned during main boss fight
}
...
{
    public T02MonitoringNodeStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
            .ActivateOnEnter<CleaveNode>()
            .ActivateOnEnter<HighVoltage>()
...
[ModuleInfo(CFCID = 94u, NameID = 1471u, PrimaryActorOID = (uint)OID.MonitoringNode, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "ported from BossmodReborn")]
public class T02MonitoringNode(WorldState ws, Actor primary) : ModuleBase(ws, primary, new(0, 39), new ArenaBoundsRect(17, 15))
{
    protected override bool CheckPull() => base.CheckPull() && !Enemies((uint)OID.ADS).Any(e => e.InCombat); // don't start modules for temporary node actors spawned during main boss fight
}
...
{
    public T02DefenseNodeStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
            .ActivateOnEnter<CleaveNode>()
            .ActivateOnEnter<HighVoltage>()
...
[ModuleInfo(CFCID = 94u, NameID = 1472u, PrimaryActorOID = (uint)OID.DefenseNode, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "ported from BossmodReborn")]
public class T02DefenseNode(WorldState ws, Actor primary) : ModuleBase(ws, primary, new(46, 52), new ArenaBoundsRect(17, 14))
{
    protected override bool CheckPull() => base.CheckPull() && !Enemies((uint)OID.ADS).Any(e => e.InCombat); // don't start modules for temporary node actors spawned during main boss fight
}
...
{
    public T02DisposalNodeStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
            .ActivateOnEnter<CleaveNode>()
            .ActivateOnEnter<HighVoltage>()
...
[ModuleInfo(CFCID = 94u, NameID = 1473u, PrimaryActorOID = (uint)OID.DisposalNode, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "ported from BossmodReborn")]
public class T02DisposalNode(WorldState ws, Actor primary) : ModuleBase(ws, primary, new(41, 94), new ArenaBoundsRect(14, 20))
{
    protected override bool CheckPull() => base.CheckPull() && !Enemies((uint)OID.ADS).Any(e => e.InCombat); // don't start modules for temporary node actors spawned during main boss fight
}
