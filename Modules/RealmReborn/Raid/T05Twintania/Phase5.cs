...
class P5LiquidHell(ModuleBase module) : Components.VoidzoneAtCastTarget(module, 6, (uint)AID.LiquidHellBoss, m => m.Enemies((uint)OID.LiquidHell).Where(z => z.EventState != 7), 1.5f)
{
    public Actor? Target;
...
class P5Hatch(ModuleBase module) : ModuleComponent(module)
{
    public Actor? Target;
...
class P5AI(ModuleBase module) : ModuleComponent(module)
{
