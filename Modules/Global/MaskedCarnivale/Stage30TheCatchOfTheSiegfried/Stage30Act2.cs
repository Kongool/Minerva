...
namespace Minerva.Global.MaskedCarnivale.Stage30.Act2;
...
{
    public Stage30Act2States(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
public sealed class Stage30Act2(WorldState ws, Actor primary) : ModuleBase(ws, primary, Layouts.ArenaCenter, Layouts.CircleSmall);