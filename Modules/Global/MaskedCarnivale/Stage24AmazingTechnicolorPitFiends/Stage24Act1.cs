...
namespace Minerva.Global.MaskedCarnivale.Stage24.Act1;
...
sealed class LightningSpark(ModuleBase module) : Components.CastInterruptHint(module, (uint)AID.LightningSpark);
...
{
    public Stage24Act1States(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.MaskedCarnivale, GroupID = 634u, CFCID = 634u, NameID = 8127u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Malediktus (ported from BMR)")]
public sealed class Stage24Act1 : ModuleBase
{
