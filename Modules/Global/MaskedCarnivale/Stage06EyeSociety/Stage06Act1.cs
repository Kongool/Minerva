...
namespace Minerva.Global.MaskedCarnivale.Stage06.Act1;
...
{
    public Stage06Act1States(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.MaskedCarnivale, GroupID = 616u, CFCID = 616u, NameID = 8090u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Malediktus (ported from BMR)")]
public sealed class Stage06Act1 : ModuleBase
{
