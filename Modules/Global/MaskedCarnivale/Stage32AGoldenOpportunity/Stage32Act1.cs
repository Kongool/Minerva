...
namespace Minerva.Global.MaskedCarnivale.Stage32.Act1;
...
sealed class SlimySummon(ModuleBase module) : Components.CastHint(module, (uint)AID.SlimySummon, "Prepare to kill add ASAP");
sealed class GoldorFireIII(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.GoldorFireIII1, (uint)AID.GoldorFireIII2], 8f);
sealed class GoldorBlast(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.GoldorBlast, new AOEShapeRect(60f, 5f));
sealed class Rupture(ModuleBase module) : Components.CastHint(module, (uint)AID.Rupture, "Kill slime ASAP! (The Ram's Voice + Ultravibration)", true);
...
sealed class GoldorAeroIIIRaidwide(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.GoldorAeroIII);
sealed class Burn(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Burn, 10f);
sealed class GoldorGravity(ModuleBase module) : Components.RaidwideCastDelay(module, (uint)AID.GoldorGravity, (uint)AID.GoldorGravity2, 0.8f, "Dmg + Heavy debuff");
sealed class GoldorThunderIII(ModuleBase module) : Components.RaidwideCastDelay(module, (uint)AID.GoldorThunderIIIVisual, (uint)AID.GoldorThunderIII1, 0.8f, "Prepare to cleanse Electrocution");
...
{
    public Stage32Act1States(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
public sealed class Stage32Act1 : ModuleBase
{
