...
namespace Minerva.Global.MaskedCarnivale.Stage16.Act2;
...
sealed class OneOneOneOneTonzeSwing(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.OneOneOneOneTonzeSwing, "Use Diamondback!");
sealed class OneOneOneTonzeSwing(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.OneOneOneTonzeSwing, 12f);
sealed class CryOfRage(ModuleBase module) : Components.CastGaze(module, (uint)AID.CryOfRage);

sealed class TenTonzeSlashWaveCone(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.TenTonzeSlash, (uint)AID.TenTonzeWaveCone], new AOEShapeCone(44f, 30f.Degrees()));
sealed class TenTonzeWaveDonut(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.TenTonzeWaveDonut, new AOEShapeDonut(10f, 20f));
sealed class ZoomIn(ModuleBase module) : Components.BaitAwayChargeCast(module, (uint)AID.ZoomIn, 4f);

sealed class ZoomInKB(ModuleBase module) : Components.GenericKnockback(module)
{
...
{
    public Stage16Act2States(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.MaskedCarnivale, GroupID = 626u, CFCID = 626u, NameID = 8113u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Malediktus (ported from BMR)")]
public sealed class Stage16Act2 : ModuleBase
{
