...
namespace Minerva.Global.MaskedCarnivale.Stage15;
...
sealed class HighVoltage(ModuleBase module) : Components.CastInterruptHint(module, (uint)AID.HighVoltage);

sealed class Ballast(ModuleBase module) : Components.ConcentricAOEs(module, _shapes, true)
{
    ...
    public override void OnCastFinished(Actor caster, ActorCastInfo spell)
    {
        if (Sequences.Count != 0)
        {
            ...
            AdvanceSequence(order, spell.LocXZ, World.FutureTime(0.6d), spell.Rotation);
        }
    }
}

sealed class PiercingLaser(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.PiercingLaser, new AOEShapeRect(32.3f, 4f));
sealed class RepellingCannons(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.RepellingCannons, 12.3f);
sealed class Superstorm(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Superstorm2, new AOEShapeDonut(8f, 20f));
sealed class Spellsword(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Spellsword, new AOEShapeCone(7.1f, 60f.Degrees()));
sealed class Disseminate(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Disseminate, 7.2f);
...
{
    public Stage15States(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.MaskedCarnivale, GroupID = 625u, CFCID = 625u, NameID = 8109u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Malediktus (ported from BMR)")]
public sealed class Stage15 : ModuleBase
{
