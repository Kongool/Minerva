...
namespace Minerva.Global.MaskedCarnivale.Stage31.Act1;
...
sealed class Mimic(ModuleBase module) : Components.CastHint(module, (uint)AID.Mimic, "Stop attacking when cast ends");
sealed class MimickedSap(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.MimickedSap1, (uint)AID.MimickedSap2], 8f);
sealed class MimickedDoomImpending(ModuleBase module) : Components.CastHint(module, (uint)AID.MimickedDoomImpending, "Heal to full before cast ends!");
sealed class MimickedProteanWave(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.MimickedProteanWave2, new AOEShapeCone(50f, 15f.Degrees()));
sealed class MimickedFireBlast(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.MimickedFireBlast2, new AOEShapeRect(70.5f, 2f));
sealed class MimickedImpSong(ModuleBase module) : Components.CastInterruptHint(module, (uint)AID.MimickedImpSong);
sealed class MimickedRawInstinct(ModuleBase module) : Components.CastHint(module, (uint)AID.MimickedRawInstinct, "Applies buff, dispel it");

sealed class DiamondBackHint(ModuleBase module) : Components.CastHints(module, [(uint)AID.MimickedFlare, (uint)AID.MimickedHoly, (uint)AID.MimickedCriticalHit, (uint)AID.MimickedPowerfulHit], "Use Diamondback!");
...
{
    public Stage31Act1States(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
public sealed class Stage31Act1 : ModuleBase
{
