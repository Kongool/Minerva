...
namespace Minerva.Global.MaskedCarnivale.Stage20.Act1;
...
sealed class SnortKB(ModuleBase module) : Components.SimpleKnockbacks(module, (uint)AID.Snort, 30f, kind: Kind.AwayFromOrigin, stopAtWall: true);
...
{
    public Stage20Act1States(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
public sealed class Stage20Act1 : ModuleBase
{
