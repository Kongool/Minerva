...
namespace Minerva.Global.MaskedCarnivale.Stage19.Act2;
...
sealed class ExplosiveDehiscence(ModuleBase module) : Components.CastGaze(module, (uint)AID.ExplosiveDehiscence)
{
    public bool casting;
...
sealed class OffalBreathVoidzone(ModuleBase module) : Components.VoidzoneAtCastTarget(module, 6f, (uint)AID.OffalBreath, GetVoidzones, 1.6d)
{
...
{
    public Stage19Act2States(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
public sealed class Stage19Act2 : ModuleBase
{
