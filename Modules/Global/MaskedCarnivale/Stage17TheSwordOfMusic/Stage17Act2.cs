...
namespace Minerva.Global.MaskedCarnivale.Stage17.Act2;
...
sealed class MagitekRay(ModuleBase module) : Components.VoidzoneAtCastTarget(module, 6f, (uint)AID.MagitekRay, GetVoidzones, 1.1f)
{
...
{
    public Stage17Act2States(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.MaskedCarnivale, GroupID = 627u, CFCID = 627u, NameID = 8087u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Malediktus (ported from BMR)")]
public sealed class Stage17Act2 : ModuleBase
{
