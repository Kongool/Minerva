...
namespace Minerva.Global.MaskedCarnivale.Stage13.Act2;
...
sealed class VoidFireII(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.VoidFireII, 5f);
sealed class VoidFireIVDarkMist(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.VoidFireIV, (uint)AID.DarkMist], 10f);
sealed class VoidFireIV3(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.VoidFireIV3, 6f);
sealed class VoidAero(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.VoidAero, new AOEShapeRect(42f, 4f));
sealed class DarkSabbath(ModuleBase module) : Components.CastGaze(module, (uint)AID.DarkSabbath);
sealed class CircleOfBlood(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.CircleOfBlood2, new AOEShapeDonut(10f, 20f));
sealed class BeguilingMist(ModuleBase module) : Components.CastInterruptHint(module, (uint)AID.BeguilingMist);
sealed class BloodRain(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.BloodRain, "Harmless raidwide unless you failed to kill succubus in time");
...
{
    public Stage13Act2States(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.MaskedCarnivale, GroupID = 623u, CFCID = 623u, NameID = 8107u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Malediktus (ported from BMR)")]
public sealed class Stage13Act2 : ModuleBase
{
