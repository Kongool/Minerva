...
namespace Minerva.Global.MaskedCarnivale.Stage09;
...
sealed class DarkVoidzone(ModuleBase module) : Components.VoidzoneAtCastTarget(module, 4f, (uint)AID.Dark, GetVoidzones, 1d)
{
...
{
    public Stage09States(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.MaskedCarnivale, GroupID = 619u, CFCID = 619u, NameID = 8099u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Malediktus (ported from BMR)")]
public sealed class Stage09 : ModuleBase
{
