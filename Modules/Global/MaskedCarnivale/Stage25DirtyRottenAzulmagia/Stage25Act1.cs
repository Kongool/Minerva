...
namespace Minerva.Global.MaskedCarnivale.Stage25.Act1;
...
sealed class ApocalypticBolt(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.ApocalypticBolt, new AOEShapeRect(51.2f, 45f));
...
sealed class TremblingEarth1(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.TremblingEarth1, new AOEShapeDonut(10f, 20f));
...
{
    public Stage25Act1States(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
public sealed class Stage25Act1 : ModuleBase
{
