...
namespace Minerva.Global.MaskedCarnivale.Stage25.Act3;
...
sealed class Charybdis(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Charybdis2, 8f);

sealed class Web(ModuleBase module) : ModuleComponent(module)
{
...
sealed class Plaincracker(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Plaincracker, 7.2f);
sealed class TremblingEarth(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.TremblingEarth, new AOEShapeDonut(10f, 20f));
sealed class TremblingEarth2(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.TremblingEarth2, new AOEShapeDonut(20f, 30f));
sealed class ApocalypticBolt(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.ApocalypticBolt, new AOEShapeRect(51.2f, 4f));
sealed class ApocalypticRoar(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.ApocalypticRoar, new AOEShapeCone(36.2f, 60f.Degrees()));
sealed class TheRamsVoice(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.TheRamsVoice, 8f);
sealed class TheDragonsVoice(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.TheDragonsVoice, new AOEShapeDonut(6f, 30f));
...
sealed class Meteor(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Meteor, 15f);
sealed class MeteorVoidzone(ModuleBase module) : Components.VoidzoneAtCastTarget(module, 10f, (uint)AID.Meteor, GetVoidzones, 1.2d)
{
...
{
    public Stage25Act3States(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.MaskedCarnivale, GroupID = 635u, CFCID = 635u, NameID = 8129u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Malediktus (ported from BMR)")]
public sealed class Stage25Act3 : ModuleBase
{
