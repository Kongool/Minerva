...
namespace Minerva.Global.PVP.HiddenGorge.GoblinMercenary;
...
sealed class GobspinSwipe(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class Knockbacks(ModuleBase module) : Components.GenericKnockback(module)
{
...
sealed class GobfireShootypops(ModuleBase module) : Components.GenericRotatingAOE(module)
{
...
sealed class IronKiss(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.IronKiss, 7f);

sealed class GoblinMercenaryStates : StateMachineBuilder
{
    public GoblinMercenaryStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 599u, CFCID = 599u, NameID = 7906u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Malediktus (ported from BMR)")]
public sealed class GoblinMercenary(WorldState ws, Actor primary) : ModuleBase(ws, primary, new(default, primary.PosRot.Z < 0f ? -124.5f : 144.5f), primary.PosRot.Z < 0f ? new ArenaBoundsSquare(16f) : new ArenaBoundsCircle(30f));
