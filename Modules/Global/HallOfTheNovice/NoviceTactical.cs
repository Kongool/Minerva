...
namespace Minerva.Global.HallOfTheNovice.NoviceTactical;
...
class StartingPositions(ModuleBase module) : ModuleComponent(module)
{
    ...
    public override void OnMapEffect(byte index, uint state)
    {
        if (state == 0x00020001)
        {
            readyPos = Module.World.CurrentCFCID switch
            {
            ...
            if (Module.World.CurrentCFCID == 1013 && index == 0x18)
                radius = 4f;
        }
...
class Interact(ModuleBase module) : ModuleComponent(module)
{
    ...
    public override void AddAIHints(int slot, Actor actor, PartyRolesConfig.Assignment assignment, AIHints hints)
    {
        ...
        {
            hints.InteractWithOID = (uint)OID.MasterOfTrials; // We are missing the logic to complete the NPC interaction - We need to be able to crawl through dialogue, select "Commence the final challenge.", and then select "Yes" in the following YesNo Addon.
        }
    }
    public override void OnEventDirectorUpdate(uint updateID, uint param1, uint param2, uint param3, uint param4)
    {
        ...
        switch (Module.World.CurrentCFCID)
        {
...
class NA01Glaciate1(ModuleBase module)
...
class NA01SpectralBlaze2(ModuleBase module) : Components.StackWithIcon(module, (uint)IconID.NA01SpectralBlazeStack2, (uint)AID.NA01SpectralBlazeVisual2, 6f, 0, 2)
{
    public override void OnEventCast(Actor caster, ActorCastEvent spell)
    {
        if ((AID)spell.Action.ID is AID.NA01SpectralBlazeVisual1 or AID.NA01SpectralBlazeVisual2 or AID.NA01SpectralBlaze1 or AID.NA01SpectralBlaze2)
...
class NA01ScorchingStreak1(ModuleBase module) : Components.BaitAwayIcon(module, new AOEShapeRect(44, 5), (uint)IconID.NA01ScorchingStreakTankbuster, (uint)AID.NA01ScorchingStreakVisual1, centerAtTarget: false)
{
    public override void AddAIHints(int slot, Actor actor, PartyRolesConfig.Assignment assignment, AIHints hints)
    {
        base.AddAIHints(slot, actor, assignment, hints);
...
class NA01PiercingStone1(ModuleBase module) : Components.StandardChasingAOEs(module, new AOEShapeCircle(4f),
...
class NA01PiercingStone2(ModuleBase module) : Components.StandardChasingAOEs(module, new AOEShapeCircle(4f), (uint)AID.NA01PiercingStone4, (uint)AID.NA01PiercingStone5, 5f, 2.5d, 5, icon: (uint)IconID.NA01PiercingStoneChaser, activationDelay: 4.0d)
{
    public override void AddAIHints(int slot, Actor actor, PartyRolesConfig.Assignment assignment, AIHints hints)
    {
        base.AddAIHints(slot, actor, assignment, hints);
...
class NA01FrigidRing(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnCastStarted(Actor caster, ActorCastInfo spell)
    {
        ...
        {
            aoes.Add(new(donut, caster.CastInfo!.LocXZ, caster.CastInfo!.Rotation, World.FutureTime((AID)spell.Action.ID is AID.NA01FrigidRing ? 7d : 13.5d)));
        }
        if ((AID)spell.Action.ID is AID.NA01BitterChill or AID.NA03BitterChill1)
        {
            aoes.Add(new(circ, caster.CastInfo!.LocXZ, caster.CastInfo!.Rotation, World.FutureTime((AID)spell.Action.ID is AID.NA01BitterChill ? 11d : 10d)));
        }
...
class NA01Fireflood(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.NA01Fireflood, 15f);
class NA01BlazingRing(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.NA01BlazingRing, new AOEShapeDonut(8, 25));
#endregion NA01

#region NA02

class NA02RogueWave(ModuleBase module) : Components.SimpleKnockbacks(module, (uint)AID.NA02RogueWave1, 15f, shape: new AOEShapeCircle(25f))
{
    public override void AddAIHints(int slot, Actor actor, PartyRolesConfig.Assignment assignment, AIHints hints)
    {
        base.AddAIHints(slot, actor, assignment, hints);
...
class NA02RogueWave2(ModuleBase module) : Components.SimpleKnockbacks(module, (uint)AID.NA02RogueWave3, 15f, shape: new AOEShapeCircle(25f))
{
    public override void AddAIHints(int slot, Actor actor, PartyRolesConfig.Assignment assignment, AIHints hints)
    {
        base.AddAIHints(slot, actor, assignment, hints);
...
class NA02Border(ModuleBase module) : Components.SimpleAOEGroups(module,
    ...
    new AOEShapeDonut(18, 25))
{
    public override void OnCastStarted(Actor caster, ActorCastInfo spell)
    {
        ...
        {
            Casters.Add(new(Shape, Center, default, Module.CastFinishAt(spell)));
        }
    }
}

class NA02Windage(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.NA02Windage1, 5f);
class NA02WindageKnockback(ModuleBase module) : Components.SimpleKnockbacks(module, (uint)AID.NA02Windage2, 10f);
class NA02FuriousFlare(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.NA02FuriousFlare1, 18f);
class NA02FuriousFlare2(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.FuriousFlare3, 20f);
class NA02ThunderingPillar(ModuleBase module) : Components.CastTowers(module, (uint)AID.NA02ThunderingPillar1, 4f);
class NA02ThunderingPillar2(ModuleBase module) : Components.CastTowers(module, (uint)AID.NA02ThunderingPillar2, 4f);
class NA02WaterDrop(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.NA02WaterDrop, 10f);
class NA02Upwell(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.NA02Upwell2, 5f);

class NA02UpwellKnockback(ModuleBase module) : Components.SimpleKnockbacks(module, (uint)AID.NA02Upwell1, 20f)
{
    public override void AddAIHints(int slot, Actor actor, PartyRolesConfig.Assignment assignment, AIHints hints)
    {
        base.AddAIHints(slot, actor, assignment, hints);
...
class NA02BlazingSurge(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.NA02BlazingSurge1, (uint)AID.NA02BlazingSurge2], new AOEShapeCone(20f, 90.Degrees()), maxCasts: 1);
#endregion

#region NA03

class NA03Tether(ModuleBase module) : Components.BaitAwayTethers(module, new AOEShapeCircle(19f), (uint)TetherID.NA03Tether)
{
    public override void AddAIHints(int slot, Actor actor, PartyRolesConfig.Assignment assignment, AIHints hints)
    {
        base.AddAIHints(slot, actor, assignment, hints);
...
class NA03TetherIntercept(ModuleBase module) : ModuleComponent(module)
{
    ...
    public override void AddAIHints(int slot, Actor actor, PartyRolesConfig.Assignment assignment, AIHints hints)
    {
        ...
        if (Active)
        {
            ...
            hints.AddForbiddenZone(new SDInvertedRect(Center - distance.Scaled(0.5f), distance.ToAngle(), halfLength, halfLength, 1f));
        }
    }
    ...
    public override void DrawArenaForeground(int pcSlot, Actor pc)
    {
        ...
        var bomb = World.Actors.FirstOrDefault(a => a.OID == (uint)OID.NA03Bomb);
...
class NA03Glaciate(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.NA03Glaciate1, 6f);
class NA03FanOfFlames(ModuleBase module) : Components.SimpleAOEGroupsByTimewindow(module, [(uint)AID.NA03FanOfFlames1, (uint)AID.NA03FanOfFlames2], new AOEShapeCone(60f, 22.5f.Degrees()), expectedNumCasters: 4);
class NA03PetrifyingLight(ModuleBase module) : Components.CastGaze(module, (uint)AID.NA03PetrifyingLight2);
class NA03PetrifyingLight2(ModuleBase module) : Components.CastGaze(module, (uint)AID.NA03PetrifyingLight4);
class NA03Withdraw(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.NA03Withdraw);
class NA03Fireflood(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.NA03Fireflood, 15f);
#endregion NA03

class NoviceTacticalStates : StateMachineBuilder
{
    public NoviceTacticalStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 1012u, NameID = 13616u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "VeraNala, erdelf, wen (ported from BMR)")]
public class NoviceTactical(WorldState ws, Actor primary) : ModuleBase(ws, primary, new(0, 0), new ArenaBoundsCircle(20f))
{
