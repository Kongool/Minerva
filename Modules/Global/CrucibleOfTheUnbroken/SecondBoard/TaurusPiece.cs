...
namespace Minerva.Global.CrucibleOfTheUnbroken.SecondBoard.TaurusPiece;
...
sealed class Doom(ModuleBase module) : ModuleComponent(module)
{
...
sealed class MortalRay(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.MortalRay, "Raidwide + Doom");
sealed class RuinousRing(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.RuinousRing1, new AOEShapeDonut(8f, 40f));
sealed class RuinousLocus(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.RuinousLocus1, 8f);
sealed class RayOfIgnorance(ModuleBase module) : ModuleComponent(module)
{
...
sealed class MortalGaze(ModuleBase module) : Components.CastGaze(module, (uint)AID.MortalGaze, maxCasts: 2);
sealed class Adds(ModuleBase module) : Components.Adds(module, (uint)OID.AhrimanPiece, 1);
sealed class RuinousExpansion(ModuleBase module) : Components.GenericAOEs(module, (uint)AID.RuinousExpansion1)
{
...
sealed class RuinousContraction(ModuleBase module) : Components.GenericAOEs(module, (uint)AID.RuinousContraction1)
{
    private readonly List<AOEInstance> _aoes = [];
    private readonly AOEShapeCircle _circle = new(8f);
    private readonly AOEShapeDonut _donut = new(8f, 40f);
...
sealed class AethericCharge(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class Aetherwave(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Aetherwave, new AOEShapeRect(50f, 5f))
{
    public override ReadOnlySpan<AOEInstance> ActiveAOEs(int slot, Actor actor)
    {
...
{
    public TaurusPieceStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 1089u, NameID = 14546u, PrimaryActorOID = (uint)OID.TaurusPiece, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "gynorhino (ported from BMR)")]
public sealed class TaurusPiece(WorldState ws, Actor primary) : ModuleBase(ws, primary, new(520f, 0f), new ArenaBoundsRect(19.5f, 15f));
