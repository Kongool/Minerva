...
namespace Minerva.Global.CrucibleOfTheUnbroken.ThirdBoard.YmirPiece;
...
sealed class WaterII(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.WaterII, 6.0f);
sealed class BlanketThunder(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.BlanketThunder);
sealed class Dreadwash(ModuleBase module) : Components.CastInterruptHint(module, (uint)AID.Dreadwash);

sealed class ParalyzingSpikes(ModuleBase module) : Components.GenericInvincible(module, "Attacking boss with spikes debuff!")
{
...
sealed class VulnDown(ModuleBase module) : Components.GenericInvincible(module)
{
    private readonly List<Actor> avoidBosses = [];
...
sealed class Tsunami(ModuleBase module) : Components.SimpleKnockbacks(module, (uint)AID.Tsunami, 35.0f, kind: Kind.DirForward)
{
    public override void AddAIHints(int slot, Actor actor, PartyRolesConfig.Assignment assignment, AIHints hints)
    {
        ...
        {
            hints.AddForbiddenZone(new SDKnockbackInAABBRectFixedDirection(Module.Center, Distance * knockback.Direction.ToDirection(), 20.0f, 20.0f),
...
{
    public YmirPieceStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 1090u, NameID = 14569u, PrimaryActorOID = (uint)OID.YmirPiece, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Equilius (ported from BMR)")]
public sealed class YmirPiece(WorldState ws, Actor primary) : ModuleBase(ws, primary, new(120f, 0f), new ArenaBoundsSquare(20f))
{
