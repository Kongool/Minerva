...
namespace Minerva.Global.CrucibleOfTheUnbroken.FirstBoard.PiscodemonPiece;
...
sealed class VoidBlizzardIII(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.VoidBlizzardIIICircle, new AOEShapeCircle(5f));
...
sealed class VoidBlizzardIIIOne(ModuleBase module) : Components.SimpleExaflare(module, 5f, (uint)AID.VoidBlizzardIIIFirst, (uint)AID.VoidBlizzardIIIRest, 6f, 1.1d, 6, 2, true);
...
sealed class VoidFlareStar(ModuleBase module) : Components.ProximityAOEs(module, (uint)AID.VoidFlareStar1, 28f);

sealed class VoidThunderIII(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.VoidThunderIII, new AOEShapeCross(50f, 5f));

sealed class VoidAeroIII(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.VoidAeroIII, new AOEShapeDonut(5f, 60f));

sealed class PiscodemonPieceStates : StateMachineBuilder
{
    public PiscodemonPieceStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 1088u, NameID = 14535u, PrimaryActorOID = (uint)OID.PiscodemonPiece, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "wen (ported from BMR)")]

public sealed class PiscodemonPiece(WorldState ws, Actor primary) : ModuleBase(ws, primary, new(120f, 0f), new ArenaBoundsSquare(20f));
