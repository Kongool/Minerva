...
namespace Minerva.Global.CrucibleOfTheUnbroken.FirstMasterBoard.IceDragonPiece;
...
sealed class IcyTorment(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.IcyTorment, new AOEShapeRect(100.0f, 7.5f));
sealed class RimeWreath(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.RimeWreath, "Raidwide + Applies Frostbite");
sealed class IcyTormentCrystals(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.IcyTormentCrystals, new AOEShapeRect(100.0f, 7.5f));
sealed class WitheringEternity(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.WitheringEternity, 9.0f);
sealed class SheetOfIce(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.SheetOfIce, 5.0f);

sealed class IcePuddles(ModuleBase module) : Components.Voidzone(module, 9.0f, GetVoidzones) {
...
sealed class Cauterize(ModuleBase module) : ModuleComponent(module) {
...
sealed class IceDragonPieceStates : StateMachineBuilder {
    public IceDragonPieceStates(ModuleBase module) : base(module) {
        TrivialPhase()
...
[ModuleInfo(CFCID = 1091u, NameID = 14606u, PrimaryActorOID = (uint)OID.IceDragonPiece, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Equilius (ported from BMR)")]
public sealed class IceDragonPiece(WorldState ws, Actor primary) : ModuleBase(ws, primary, new(120f, 0f), new ArenaBoundsRect(20f, 20f)) {
