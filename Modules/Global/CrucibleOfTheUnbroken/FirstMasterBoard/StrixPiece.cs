...
namespace Minerva.Global.CrucibleOfTheUnbroken.FirstMasterBoard.StrixPiece;
...
sealed class UltimateFocus(ModuleBase module) : Components.Dispel(module, (uint)SID.MagicDamageUp, (uint)AID.UltimateFocus);
sealed class OnThePropertiesOfDarkness(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.OnThePropertiesOfDarkness);

sealed class Plummet : Components.SimpleAOEs
{
    public Plummet(ModuleBase module) : base(module, (uint)AID.Plummet, 10.0f, maxCasts: 6)
    {
        MaxDangerColor = 3;
    }
}

sealed class AeroIII(ModuleBase module) : Components.SimpleKnockbacks(module, (uint)AID.AeroIII, 25.0f)
{
    public override void AddHints(int slot, Actor actor, TextHints hints) { }
}
sealed class StrixPlume(ModuleBase module) : Components.Adds(module, (uint)OID.StrixPlume, 2)
{
    public override void AddHints(int slot, Actor actor, TextHints hints)
    {
        if (Actors.Count == 0)
...
sealed class OnThePropertiesOfQuakes(ModuleBase module) : Components.PersistentInvertibleVoidzoneByCast(module, 6.0f, GetVoidzones,
...
sealed class OnThePropertiesOfFloods(ModuleBase module) : Components.PersistentInvertibleVoidzoneByCast(module, 6.0f, GetVoidzones,
...
// Entering this voidzone will give you a buff with a timer
sealed class MagicalMalletTheory(ModuleBase module) : Components.PersistentInvertibleVoidzoneByCast(module, 6.0f, GetVoidzones, (uint)AID.MagicalMalletTheory)
{
    private BitMask affectedPlayers;
...
{
    public Overdue(ModuleBase module) : base(module, (uint)AID.Overdue, 15.0f, maxCasts: 4)
    {
        MaxDangerColor = 2;
    }
}
...
{
    public StrixPieceStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 1091u, NameID = 14596u, PrimaryActorOID = (uint)OID.StrixPiece, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Equilius (ported from BMR)")]
public sealed class StrixPiece(WorldState ws, Actor primary) : ModuleBase(ws, primary, new(120f, -420f), new ArenaBoundsCircle(20f))
{
