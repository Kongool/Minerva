...
namespace Minerva.Heavensward.Dungeon.D05GreatGubalLibrary.D051DemonTome;
...
class Repel(ModuleBase module) : Components.SimpleKnockbacks(module, (uint)AID.Repel, 20, true, kind: Kind.DirForward, stopAtWall: true);
class LiquefyCenter(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.LiquefyCenter, new AOEShapeRect(57.84f, 4));
class LiquefySides(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.LiquefySides, new AOEShapeRect(57.84f, 3.5f));
class Disclosure(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Disclosure, new AOEShapeRect(20.5f, 11f));

class DisclosureSpin(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnCastStarted(Actor caster, ActorCastInfo spell)
    {
        ...
        {
            Bounds = D051DemonTome.SpinArena;
    ...
    public override void OnEventCast(Actor caster, ActorCastEvent spell)
    {
        ...
        {
            _aoe = [];
            Bounds = D051DemonTome.DefaultArena;
        }
    }
}

class ThinIce(ModuleBase module) : Components.ThinIce(module, 15, stopAtWall: true);

class D051DemonTomeStates : StateMachineBuilder
{
    public D051DemonTomeStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 31u, NameID = 3923u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public class D051DemonTome(WorldState ws, Actor primary) : ModuleBase(ws, primary, DefaultArena.Center, DefaultArena)
{
