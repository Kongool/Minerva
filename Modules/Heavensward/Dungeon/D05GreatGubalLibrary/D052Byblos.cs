...
namespace Minerva.Heavensward.Dungeon.D05GreatGubalLibrary.D052Byblos;
...
class PageTear(ModuleBase module) : Components.Cleave(module, (uint)AID.PageTear, new AOEShapeCone(8f, 45f.Degrees()))
{
...
class HeadDown(ModuleBase module) : Components.BaitAwayChargeCast(module, (uint)AID.HeadDown, 4f);
class DeathRay(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.DeathRay, new AOEShapeRect(24.2f, 1.5f));
class Tomewind(ModuleBase module) : Components.Voidzone(module, 3f, GetVoidzones)
{
...
class TailSmash(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.TailSmash, new AOEShapeCone(12f, 45f.Degrees()));

class Bibliocide(ModuleBase module) : Components.BaitAwayTethers(module, 0f, (uint)TetherID.WhaleOil, activationDelay: 5f)
{
    public override void AddHints(int slot, Actor actor, TextHints hints)
    {
...
{
    public D052ByblosStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 31u, NameID = 3925u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public class D052Byblos(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
