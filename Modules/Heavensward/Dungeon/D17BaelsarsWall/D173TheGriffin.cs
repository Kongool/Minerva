...
namespace Minerva.Heavensward.Dungeon.D17BaelsarsWall.D173TheGriffin;
...
class RestraintCollar(ModuleBase module) : ModuleComponent(module)
{
...
class BigBoot(ModuleBase module) : Components.GenericKnockback(module, (uint)AID.BigBoot, stopAtWall: true)
{
...
class Corrosion(ModuleBase module) : Components.GenericAOEs(module)
{
...
class SanguineBlade(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.SanguineBlade, new AOEShapeCone(41.5f, 90f.Degrees()));
class ClawOfTheGriffin(ModuleBase module) : Components.SingleTargetCast(module, (uint)AID.ClawOfTheGriffin);
class BeakOfTheGriffin(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.BeakOfTheGriffin);
class Lionshead(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.Lionshead);
class FlashPowder(ModuleBase module) : Components.CastGaze(module, (uint)AID.FlashPowder);

class D173TheGriffinStates : StateMachineBuilder
{
    public D173TheGriffinStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
public class D173TheGriffin(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
    ...
    protected override void CalculateModuleAIHints(int slot, Actor actor, PartyRolesConfig.Assignment assignment, AIHints hints)
    {
        ...
        for (var i = 0; i < count; ++i)
        {
            ...
            e.Priority = e.Actor.OID == (uint)OID.BladeOfTheGriffin ? e.Actor.Position.AlmostEqual(Center, 5f) ? 2 : AIHints.Enemy.PriorityPointless
