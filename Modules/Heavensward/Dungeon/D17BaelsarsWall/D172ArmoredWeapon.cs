...
namespace Minerva.Heavensward.Dungeon.D17BaelsarsWall.D172ArmoredWeapon;
...
class Launcher(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.Launcher);
class AssaultCannon(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.AssaultCannon, new AOEShapeRect(40.94f, 1f));

class DiffractiveLaser(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.DiffractiveLaser1, (uint)AID.DiffractiveLaser2], 5f);
...
{
    public D172ArmoredWeaponStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
public class D172ArmoredWeapon(WorldState ws, Actor primary) : ModuleBase(ws, primary, new(116, 0), new ArenaBoundsSquare(19.5f))
{
