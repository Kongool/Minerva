...
namespace Minerva.Heavensward.Dungeon.D09SaintMociannesArboretum.D092QueenHawk;
...
sealed class StingerCell(ModuleBase module) : Components.Cleave(module, (uint)AID.StingerCell, new AOEShapeRect(8.4f, 2.5f), activeWhileCasting: false)
{
...
sealed class Apitoxin(ModuleBase module) : Components.VoidzoneAtCastTarget(module, 6f, (uint)AID.Apitoxin, GetVoidzones, 0.7d)
{
...
sealed class StraightSpindle(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.StraightSpindle, new AOEShapeRect(51.08f, 1.5f));
sealed class Crossfire(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Crossfire, new AOEShapeRect(50.5f, 7f));
sealed class StoneskinPhysical(ModuleBase module) : Components.InvincibleStatus(module, (uint)SID.StoneskinPhysical);

sealed class D092QueenHawkStates : StateMachineBuilder
{
    public D092QueenHawkStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 41u, NameID = 4656u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class D092QueenHawk : ModuleBase
{
