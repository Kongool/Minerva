...
namespace Minerva.Heavensward.Dungeon.D09SaintMociannesArboretum.D090TangledNarbrooi;
...
sealed class TheWoodRemembers(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.TheWoodRemembers, new AOEShapeCone(7.85f, 60f.Degrees()));
sealed class MindOfItsOwn(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.MindOfItsOwn, new AOEShapeCone(9f, 60f.Degrees()));
sealed class Canopy(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Canopy, new AOEShapeCone(7.7f, 60f.Degrees()));
...
{
    public D090TangledNarbrooiStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 41u, NameID = 4647u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class D090TangledNarbrooi : ModuleBase
{
