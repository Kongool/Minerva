...
namespace Minerva.Heavensward.Dungeon.D15Xelphatol.D150SiegeGobbue;
...
sealed class Overpower(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Overpower, new AOEShapeCone(7.08f, 45f.Degrees()));
sealed class Sneeze(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Sneeze, new AOEShapeCone(20.85f, 45f.Degrees()));
sealed class SneezeHint(ModuleBase module) : Components.CastInterruptHint(module, (uint)AID.Sneeze, true, true, showNameInHint: true);

sealed class D150SiegeGobbueStates : StateMachineBuilder
{
    public D150SiegeGobbueStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 182u, NameID = 5254u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class D150SiegeGobbue : ModuleBase
{
