...
namespace Minerva.Heavensward.Dungeon.D15Xelphatol.D150ChasmHarpeia;
...
sealed class FlashFlood(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.FlashFlood, new AOEShapeCone(8.16f, 60f.Degrees()));
sealed class LaboredLeap(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.LaboredLeap, 10.32f);
sealed class FallenRock(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.FallingRock, 4f);
sealed class WingsOfWoe(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.WingsOfWoe, 6f);

sealed class D150ChasmHarpeiaStates : StateMachineBuilder
{
    public D150ChasmHarpeiaStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 182u, NameID = 5253u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class D150ChasmHarpeia : ModuleBase
{
