...
namespace Minerva.Heavensward.Dungeon.D15Xelphatol.D150XelphatolSkycaller;
...
class TornadoHint(ModuleBase module) : Components.CastInterruptHint(module, (uint)AID.Tornado, true, true, showNameInHint: true);
class IxaliAeroIII(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.IxaliAeroIII);
class IxaliAeroIIIHint(ModuleBase module) : Components.CastInterruptHint(module, (uint)AID.IxaliAeroIII, true, true, showNameInHint: true);
class IxaliAeroII(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.IxaliAeroII, new AOEShapeRect(41.8f, 4f));
class Gust(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Gust, 5f);

class D150XelphatolSkycallerStates : StateMachineBuilder
{
    public D150XelphatolSkycallerStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 182u, NameID = 5264u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class D150XelphatolSkycaller : ModuleBase
{
