...
namespace Minerva.Heavensward.Dungeon.D13SohrKhai.D130Kargas;
...
class BreathWing(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.BreathWing);
class WingsOfWoe(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.WingsOfWoe, 6f);

class D130KargasStates : StateMachineBuilder
{
    public D130KargasStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 171u, NameID = 4939u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public class D130Kargas(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
