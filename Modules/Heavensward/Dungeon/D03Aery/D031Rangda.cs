...
namespace Minerva.Heavensward.Dungeon.D03Aery.D031Rangda;
...
class ElectricPredation(ModuleBase module) : Components.Cleave(module, (uint)AID.ElectricPredation, new AOEShapeCone(12.9f, 60.Degrees()));

class Electrocution(ModuleBase module) : Components.GenericBaitAway(module)
{
...
class IonosphericCharge(ModuleBase module) : Components.BaitAwayTethers(module, 0f, (uint)TetherID.Lightning, activationDelay: 10.1f)
{
...
class ElectricCachexia(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.ElectricCachexia, new AOEShapeDonut(8f, 60f));
class LightningBolt(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.LightningBolt, 3f);

class D031RangdaStates : StateMachineBuilder
{
    public D031RangdaStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 39u, NameID = 3452u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public class D031Rangda(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
