...
namespace Minerva.Heavensward.Dungeon.D06AetherochemicalResearchFacility.D061Regula;
...
class SelfDetonate(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.SelfDetonate);
class AetherochemicalGrenado(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.AetherochemicalGrenado, 8f);
class AetherochemicalLaser(ModuleBase module) : Components.BaitAwayTethers(module, new AOEShapeRect(50f, 2f), (uint)TetherID.BaitAway, (uint)AID.AetherochemicalLaser);
class AetherochemicalLaserAOE(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.AetherochemicalLaser, new AOEShapeRect(50f, 2f));

class JudgmentAOE(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.JudgmentAOE, 8f);
class MagitekSlug(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.MagitekSlug, new AOEShapeRect(61.65f, 2f));
class MagitekSpread(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.MagitekSpread, new AOEShapeCone(31.65f, 120f.Degrees()));

class D061RegulaStates : StateMachineBuilder
{
    public D061RegulaStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 38u, NameID = 3818u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus, LTS) (ported from BMR)")]
public class D061Regula(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
