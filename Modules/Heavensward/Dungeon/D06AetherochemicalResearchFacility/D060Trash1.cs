...
namespace Minerva.Heavensward.Dungeon.D06AetherochemicalResearchFacility.D060Trash1;
...
class PassiveInfraredGuidanceSystem(ModuleBase module) : Components.Cleave(module, (uint)AID.PassiveInfraredGuidanceSystem, new AOEShapeCircle(6f), [(uint)OID.Boss], originAtTarget: true);

abstract class HeadSpin(ModuleBase module, uint aid, OID oid) : Components.Cleave(module, aid, new AOEShapeCircle(5.225f), [(uint)oid])
{
...
class Headspin1(ModuleBase module) : HeadSpin(module, (uint)AID.Headspin1, OID.ScrambledPaladin);
class Headspin2(ModuleBase module) : HeadSpin(module, (uint)AID.Headspin2, OID.ScrambledEngineer);

class GrandSword(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.GrandSword, new AOEShapeCone(16f, 60f.Degrees()));
class TheHand(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.TheHand, new AOEShapeCone(7.5f, 60f.Degrees()));

class D060EnforcementDroid210States : StateMachineBuilder
{
    public D060EnforcementDroid210States(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 38u, NameID = 4390u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
...
{
    public D060ScrambledIronGiantStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 38u, NameID = 4337u, PrimaryActorOID = (uint)OID.ScrambledIronGiant, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public class D060ScrambledIronGiant(WorldState ws, Actor primary) : D060Trash1(ws, primary);

public abstract class D060Trash1(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
