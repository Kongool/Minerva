...
namespace Minerva.Heavensward.Dungeon.D06AetherochemicalResearchFacility.D060SixthLegionMagitekVanguardH1;
...
class CermetDrill(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.CermetDrill, new AOEShapeRect(8.8f, 2.5f));
class Heartstopper(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Heartstopper, new AOEShapeRect(3.5f, 1.5f));
class Stoneskin(ModuleBase module) : Components.CastInterruptHint(module, (uint)AID.Stoneskin, canBeStunned: true, showNameInHint: true);

class D060SixthLegionMagitekVanguardH1States : StateMachineBuilder
{
    public D060SixthLegionMagitekVanguardH1States(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 38u, NameID = 4341u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public class D060SixthLegionMagitekVanguardH1(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
