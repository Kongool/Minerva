...
namespace Minerva.Heavensward.Dungeon.D06AetherochemicalResearchFacility.D060CulturedShabti;
...
class Spellsword(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Spellsword, new AOEShapeCone(8.2f, 60f.Degrees()));
class DeathsDoor(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.DeathsDoor, new AOEShapeRect(22.2f, 1f));

class D060CulturedShabtiStates : StateMachineBuilder
{
    public D060CulturedShabtiStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
public class D060CulturedShabti(WorldState ws, Actor primary) : ModuleBase(ws, primary, IsArena1(primary) ? arena1.Center : ShabtiConjurer2Bounds.Arena.Center, IsArena1(primary) ? arena1 : ShabtiConjurer2Bounds.Arena)
{
