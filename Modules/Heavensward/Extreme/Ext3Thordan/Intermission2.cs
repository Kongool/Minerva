...
sealed class SwordShieldOfTheHeavens(ModuleBase module) : ModuleComponent(module)
{
...
sealed class SkywardLeap(ModuleBase module) : Components.GenericBaitAway(module, (uint)AID.SkywardLeap, centerAtTarget: true)
{
