...
namespace Minerva.Shadowbringers.Dungeon.D05MtGulg.D052ForgivenApathy;
...
class Sanctification(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Sanctification, new AOEShapeCone(12f, 45f.Degrees()));
class EarthShaker(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.EarthShaker2, new AOEShapeCone(60f, 30f.Degrees()));

class D052ForgivenApathyStates : StateMachineBuilder
{
    public D052ForgivenApathyStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 659u, NameID = 8267u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Malediktus (ported from BMR)")]
public class D052ForgivenApathy(WorldState ws, Actor primary) : ModuleBase(ws, primary, primary.PosRot.Z > -106f ? arena2.Center : arena1.Center, primary.PosRot.Z > -106f ? arena2 : arena1)
{
