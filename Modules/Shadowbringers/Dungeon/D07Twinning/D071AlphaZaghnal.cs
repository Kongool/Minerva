...
namespace Minerva.Shadowbringers.Dungeon.D07Twinning.D071AlphaZaghnal;
...
sealed class BeastlyRoar(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.BeastlyRoar);
sealed class Augurium(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Augurium, new AOEShapeCone(12f, 60f.Degrees()));

sealed class PounceErrant(ModuleBase module) : Components.GenericStackSpread(module, true)
{
    public override void OnEventIcon(Actor actor, uint iconID, ulong targetID)
    {
        if (iconID == (uint)IconID.PounceErrant)
        {
            Spreads.Add(new(actor, 10f, World.FutureTime(4.6d)));
        }
    }
...
sealed class ChargeEradicated(ModuleBase module) : Components.StackWithCastTargets(module, (uint)AID.ChargeEradicated, 8f, 4, 4);
sealed class ChargeEradicatedVoidzone(ModuleBase module) : Components.Voidzone(module, 8f, GetVoidzones)
{
...
sealed class ForlornImpact(ModuleBase module) : Components.GenericBaitAway(module)
{
    ...
    public override void OnEventIcon(Actor actor, uint iconID, ulong targetID)
    {
        ...
        {
            CurrentBaits.Add(new(Module.PrimaryActor, actor, rect, World.FutureTime(7.2d)));
        }
    }
...
{
    public D071AlphaZaghnalStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 655u, CFCID = 655u, NameID = 8162u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class D071AlphaZaghnal(WorldState ws, Actor primary) : ModuleBase(ws, primary, new(200f, 285f), new ArenaBoundsSquare(19.5f))
{
