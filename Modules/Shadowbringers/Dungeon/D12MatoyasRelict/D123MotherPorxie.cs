...
namespace Minerva.Shadowbringers.Dungeon.D12MatoyasRelict.D123MotherPorxie;
...
class TenderLoin(ModuleBase module) : Components.RaidwideCastDelay(module, (uint)AID.TenderLoinVisual, (uint)AID.TenderLoin, 0.8f);
class MincedMeat(ModuleBase module) : Components.SingleTargetCastDelay(module, (uint)AID.MincedMeatVisual, (uint)AID.MincedMeat, 0.9f);
class OpenFlame(ModuleBase module) : Components.SpreadFromIcon(module, (uint)IconID.Spreadmarker, (uint)AID.OpenFlame, 5f, 6.7f);
class MeatMallet(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.MeatMallet, 30f);
class BarbequeCircle(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.BarbequeCircle, 5f);
class BarbequeRect(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.BarbequeRect, new AOEShapeRect(50f, 2.5f));
class Buffet(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Buffet, new AOEShapeRect(40f, 3f));

sealed class MediumRearNeerDoneWell(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.MediumRear1, (uint)AID.MediumRear2, (uint)AID.NeerDoneWell], new AOEShapeDonut(5f, 40f))
{
...
class HuffAndPuff1(ModuleBase module) : Components.SimpleKnockbacks(module, (uint)AID.HuffAndPuff1, 15f, true, stopAtWall: true, kind: Kind.DirForward)
{
    public override void AddAIHints(int slot, Actor actor, PartyRolesConfig.Assignment assignment, AIHints hints)
    {
        if (Casters.Count != 0)
...
class HuffAndPuff2(ModuleBase module) : Components.GenericKnockback(module, stopAtWall: true)
{
    ...
    public override void OnCastStarted(Actor caster, ActorCastInfo spell)
    {
        ...
        else if (_kbCache.Length != 0 && spell.Action.ID == (uint)AID.NeerDoneWell)
        {
            ...
            KB = [new(kb.Origin, 50f, World.FutureTime(5.4d), null, kb.Direction, kb.Kind, ignoreImmunes: true)];
        }
    }
    ...
    public override void OnCastFinished(Actor caster, ActorCastInfo spell)
    {
        ...
        {
            ref readonly var kb = ref _kbCache[0];
            KB = [new(kb.Origin, 15f, World.FutureTime(10.9d), null, kb.Direction, kb.Kind, ignoreImmunes: true)];
        }
    }
...
class Barbeque(ModuleBase module) : Components.GenericAOEs(module)
{
...
{
    public D123MotherPorxieStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 746u, NameID = 9741u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public class D123MotherPorxie(WorldState ws, Actor primary) : ModuleBase(ws, primary, default, new ArenaBoundsSquare(19.5f))
{
