...
namespace Minerva.Shadowbringers.Dungeon.D02DohnMheg.D022Griaule;
...
sealed class FeedingTime(ModuleBase module) : Components.InterceptTether(module, (uint)AID.FeedingTime)
{
    private DateTime _activation;
    public override void OnActorCreated(Actor actor)
    {
        if (actor.OID == (uint)OID.PaintedSapling)
            _activation = World.FutureTime(10.9d);
    }
...
sealed class Tiiimbeeer(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.Tiiimbeeer);
sealed class Swinge(ModuleBase module) : Components.GenericAOEs(module)
{
...
{
    public D022GriauleStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 649u, CFCID = 649u, NameID = 8143u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class D022Griaule : ModuleBase
{
