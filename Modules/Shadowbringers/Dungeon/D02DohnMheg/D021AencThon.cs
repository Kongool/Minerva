...
namespace Minerva.Shadowbringers.Dungeon.D02DohnMheg.D021AencThon;
...
sealed class Landsblood(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.LandsbloodFirst, "Raidwides + Geysers");
sealed class CandyCane(ModuleBase module) : Components.SingleTargetCast(module, (uint)AID.CandyCane);
sealed class Hydrofall(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Hydrofall, 6f);
sealed class LaughingLeap(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.LaughingLeapAOE, 4f);
sealed class LaughingLeapStack(ModuleBase module) : Components.StackWithIcon(module, (uint)IconID.Stackmarker, (uint)AID.LaughingLeapStack, 4f, 5.1d, 4, 4);

sealed class Geyser(ModuleBase module) : Components.GenericAOEs(module)
{
...
{
    public D021AencThonStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 649u, CFCID = 649u, NameID = 8141u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class D021AencThon : ModuleBase
{
