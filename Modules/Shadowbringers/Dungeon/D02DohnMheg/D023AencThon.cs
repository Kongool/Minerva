...
namespace Minerva.Shadowbringers.Dungeon.D02DohnMheg.D031AencThon;
...
sealed class VirtuosicCapriccio(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.VirtuosicCapriccio, "Raidwide + Bleed");
sealed class CripplingBlow(ModuleBase module) : Components.SingleTargetCast(module, (uint)AID.CripplingBlow);
sealed class ImpChoir(ModuleBase module) : Components.CastGaze(module, (uint)AID.ImpChoir);
sealed class ToadChoir(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.ToadChoir, new AOEShapeCone(19.5f, 75f.Degrees()));
sealed class BileBombardment(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.BileBombardment, 8f);

sealed class FunambulistsFantasia(ModuleBase module) : ModuleComponent(module)
{
    ...
    public override void OnCastFinished(Actor caster, ActorCastInfo spell)
    {
        ...
        {
            Bounds = new ArenaBoundsCustom(D033AencThon.GetUnion(), [.. D033AencThon.GetDifference(), new Rectangle(new(-128.5f, -244f), 20f, 10f)],
        ...
        {
            Bounds = D033AencThon.BuildArena().arena;
            chasmArena = false;
        }
    }
...
sealed class Finale(ModuleBase module) : Components.CastHint(module, (uint)AID.Finale, "Enrage, destroy the Liar's Lyre!", true);

sealed class CorrosiveBile(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class FlailingTentacles(ModuleBase module) : Components.GenericAOEs(module)
{
    private AOEInstance[] _aoe = [];
...
{
    public D033AencThonStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 649u, CFCID = 649u, NameID = 8146u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class D033AencThon : ModuleBase
{
