...
namespace Minerva.Shadowbringers.Quest.Job.Gunbreaker.SteelAgainstSteel;
...
class ScaldingTank(ModuleBase module) : Components.StackWithCastTargets(module, (uint)AID.ScaldingTank1, 6f);
class ToTheSlaughter(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.ToTheSlaughter, new AOEShapeCone(40f, 90f.Degrees()));
class Exsanguination1(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Exsanguination1, new AOEShapeDonutSector(2f, 7f, 90f.Degrees()));
class Exsanguination2(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Exsanguination2, new AOEShapeDonutSector(7f, 12f, 90f.Degrees()));
class Exsanguination3(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Exsanguination3, new AOEShapeDonutSector(12f, 17f, 90f.Degrees()));
class CaptiveBolt(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.CaptiveBolt, new AOEShapeRect(50f, 5f), 4);
class AetherochemicalGrenado(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.AetherochemicalGrenado, 8f);
class DiffractiveLaser(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.DiffractiveLaser, new AOEShapeRect(45f, 2f));
class SnakeShot(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.SnakeShot, new AOEShapeCone(20f, 120f.Degrees()));
class CullingBlade(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.CullingBlade1, new AOEShapeCone(60f, 15f.Degrees()));
...
{
    public VitusQuoMessallaStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.Quest, CFCID = 68802u, NameID = 8872u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "ported from BossmodReborn")]
public class VitusQuoMessalla(WorldState ws, Actor primary) : ModuleBase(ws, primary, new(-266f, -507f), new ArenaBoundsCircle(19.5f));
