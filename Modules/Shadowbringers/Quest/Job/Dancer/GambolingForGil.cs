...
namespace Minerva.Shadowbringers.Quest.Job.Dancer.GambolingForGil;
...
class Foxshot(ModuleBase module) : Components.BaitAwayChargeCast(module, (uint)AID.Foxshot, 2f);

class FoxshotKB(ModuleBase module) : Components.GenericKnockback(module, stopAtWall: true)
{
...
class Whirlwind(ModuleBase module) : Components.Voidzone(module, 6f, GetVoidzones)
{
...
class WarDance(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.WarDance, 5f);
class CharmingChasse(ModuleBase module) : Components.CastGaze(module, (uint)AID.CharmingChasse);
class HannishFire(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.HannishFire1, 6f);
class HannishWaters(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.HannishWaters, new AOEShapeCone(40f, 15f.Degrees()));
class RanaasFinish(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.RanaasFinish, 15f);

class RanaaMihgoStates : StateMachineBuilder
{
    public RanaaMihgoStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.Quest, CFCID = 68786u, NameID = 8489u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "ported from BossmodReborn")]
public class RanaaMihgo(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
