...
[SkipLocalsInit]
sealed class P4FateCalibrationBetaDebuffs(ModuleBase module) : P4ForcedMarchDebuffs(module)
{
...
[SkipLocalsInit]
sealed class P4FateCalibrationBetaJJump(ModuleBase module) : Components.GenericBaitAway(module, centerAtTarget: true)
{
...
[SkipLocalsInit]
sealed class P4FateCalibrationBetaOpticalSight(ModuleBase module) : Components.UniformStackSpread(module, 6f, 6f, 4, 4)
{
    ...
    public void Show()
    {
        ...
        {
            case Mechanic.Stack:
                AddStacks(_stackTargets, World.FutureTime(6.1d));
                break;
            case Mechanic.Spread:
                AddSpreads(Raid.WithoutSlot(true, true, true), World.FutureTime(6.1d));
                break;
        }
    }
...
[SkipLocalsInit]
sealed class P4FateCalibrationBetaRadiantSacrament(ModuleBase module) : Components.GenericAOEs(module)
{
