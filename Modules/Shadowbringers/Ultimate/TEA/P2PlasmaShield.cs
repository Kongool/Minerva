...
[SkipLocalsInit]
sealed class P2PlasmaShield(ModuleBase module) : Components.DirectionalParry(module, [(uint)OID.PlasmaShield], forbiddenPriority: AIHints.Enemy.PriorityInvincible)
{
...
class P2CCInvincible(ModuleBase module) : Components.InvincibleStatus(module, (uint)SID.Invincibility);
