...
[SkipLocalsInit]
sealed class P1JagdDolls(ModuleBase module) : ModuleComponent(module)
{
    ...
    public override void DrawArenaForeground(int pcSlot, Actor pc)
    {
        foreach (var doll in ActiveDolls)
        {
            ...
            var tether = World.Actors.Find(doll.Tether.Target);
            if (tether != null)
    ...
    private void AssignDolls()
    {
        ...
        var relSouth = (south!.Position - Center).ToAngle();
        ...
        {
            var dollRel = (doll.Position - Center).ToAngle();
