...
[SkipLocalsInit]
sealed class P3Inception4Cleaves(ModuleBase module) : Components.GenericBaitAway(module, (uint)AID.AlphaSwordP3)
{
...
sealed class P3Inception4Hints(ModuleBase module) : ModuleComponent(module)
{
