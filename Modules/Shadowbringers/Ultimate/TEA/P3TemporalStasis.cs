...
[SkipLocalsInit]
sealed class P3TemporalStasis(ModuleBase module) : Components.GenericBaitAway(module, (uint)AID.FlarethrowerP3)
{
    ...
    private WPos SafeSpot(int slot, Actor actor)
    {
        ...
        var bjLeft = BJ()?.PosRot.X < Center.X;
        return Center + _playerMechanics[slot] switch
        {
