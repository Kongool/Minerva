...
namespace Minerva.Shadowbringers.TreasureHunt.ShiftingOubliettesOfLyheGhiah.DaenOseTheAvariciousTyphon;
...
sealed class AChoo(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.AChoo, new AOEShapeCone(12f, 45f.Degrees()));
sealed class FellSwipe(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.FellSwipe, new AOEShapeCone(8f, 60f.Degrees()));
sealed class WindShot(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.WindShot, new AOEShapeRect(40f, 3f));
sealed class LingeringSnort(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.LingeringSnort, 20f);
sealed class UnpleasantBreeze(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.UnpleasantBreeze, 6f);
sealed class Fireball(ModuleBase module) : Components.StackWithCastTargets(module, (uint)AID.Fireball, 6f, 8, 8);

sealed class SnortsaultKB(ModuleBase module) : Components.SimpleKnockbacks(module, (uint)AID.SnortsaultKB, 20f, stopAtWall: true);
sealed class SnortsaultCircle(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnActorCreated(Actor actor)
    {
        if (actor.OID == (uint)OID.DaenOseTheAvaricious2)
        {
            ...
            _aoe = [new(circle, pos, default, World.FutureTime(14.3d), shapeDistance: circle.Distance(pos, default))];
        }
    }
...
sealed class Snortsault(ModuleBase module) : Components.GenericRotatingAOE(module)
{
    ...
    public override void OnActorCreated(Actor actor)
    {
        ...
        void AddSequences(bool isClockwise)
        {
            ...
            void AddSequence(Angle offset) => Sequences.Add(new(cone, Center.Quantized(), actor.Rotation + offset, rotationIncrement, World.FutureTime(14.5d), 1.1d, 31, 9));
        }
    }
...
{
    public DaenOseTheAvariciousTyphonStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CFC, GroupID = 745u, CFCID = 745u, NameID = 9808u, PrimaryActorOID = (uint)OID.DaenOseTheAvariciousTyphon, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
