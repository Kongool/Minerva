...
sealed class OrbsAOE(ModuleBase module) : Components.GenericAOEs(module)
{
    private readonly DetermineArena _arena = module.FindComponent<DetermineArena>()!;
    private readonly List<(Actor Orb, AOEShape Shape)> orbs = [];
    ...
    public override void OnActorCreated(Actor actor)
    {
        ...
        if (shape != null)
        {
            ...
            {
                AddAOE(shape, actor, World.FutureTime(11d));
            }
        }
    }
}
...
sealed class Magnetism(ModuleBase module) : Components.GenericKnockback(module)
{
    ...
    private void InitIfReady()
    {
        ...
        void AddSource(int slot, WPos position, bool isKnockback) => _sources[slot] = new(position, 30f, World.FutureTime(8.2d), kind: isKnockback ? Kind.AwayFromOrigin : Kind.TowardsOrigin, ignoreImmunes: true);
    }
