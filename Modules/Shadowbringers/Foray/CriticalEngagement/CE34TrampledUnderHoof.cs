...
namespace Minerva.Shadowbringers.Foray.CriticalEngagement.CE34TrampledUnderHoof;
...
sealed class ArenaChange(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnCastFinished(Actor caster, ActorCastInfo spell)
    {
        ...
        {
            _aoe = [new(donut, Center, default, Module.CastFinishAt(spell, 6d))];
        }
    }
    ...
    public override void OnActorCreated(Actor actor)
    {
        ...
        {
            Bounds = new ArenaBoundsCircle(20f); // default arena got no extra collision, just a donut aoe
...
sealed class BullHorn(ModuleBase module) : Components.SingleTargetDelayableCast(module, (uint)AID.BullHorn);
sealed class BalefulGlint(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.BalefulGlint, 8f);
sealed class ArrestingGaze(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.ArrestingGaze, new AOEShapeCone(40f, 45f.Degrees()));

sealed class GlimmerInTheDark(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnActorCreated(Actor actor)
    {
        ...
        {
            _aoes.Add(new(circle, actor.Position.Quantized(), default, World.FutureTime(4.9d)));
        }
    }
...
sealed class DemonEye(ModuleBase module) : Components.GenericGaze(module)
{
...
sealed class AccursedLight(ModuleBase module) : Components.StackWithCastTargets(module, (uint)AID.AccursedLight, 8f, 8);

sealed class CE34TrampledUnderHoofStates : StateMachineBuilder
{
    public CE34TrampledUnderHoofStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CriticalEngagement, GroupID = 735u, CFCID = 735u, NameID = 11u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class CE34TrampledUnderHoof(WorldState ws, Actor primary) : ModuleBase(ws, primary, startingArena.Center, startingArena)
{
