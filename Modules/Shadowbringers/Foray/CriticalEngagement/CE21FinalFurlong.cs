...
namespace Minerva.Shadowbringers.Foray.CriticalEngagement.CE21FinalFurlong;
...
sealed class GraspingRancor : Components.SimpleAOEs
{
    ...
    public GraspingRancor(ModuleBase module) : base(module, (uint)AID.PurifyingLight, 12f)
    {
...
sealed class HatefulMiasma(ModuleBase module) : Components.StackWithCastTargets(module, (uint)AID.HatefulMiasma, 6f);
sealed class PoisonedWordsStepsOfDestruction(ModuleBase module) : Components.SimpleAOEGroups(module, [(uint)AID.PoisonedWords, (uint)AID.StepsOfDestructionAOE], 6f);

sealed class CoffinNails : Components.SimpleAOEs
{
    public CoffinNails(ModuleBase module) : base(module, (uint)AID.CoffinNails, new AOEShapeCone(60f, 45f.Degrees()))
    {
        MaxDangerColor = 2;
        MaxRisky = 2;
    }
...
sealed class Stab(ModuleBase module) : Components.SingleTargetCast(module, (uint)AID.Stab);
sealed class GripOfPoison(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.GripOfPoison);

sealed class CE21FinalFurlongStates : StateMachineBuilder
{
    public CE21FinalFurlongStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.CriticalEngagement, CFCID = 735u, NameID = 6u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Malediktus (ported from BMR)")] // bnpcname=9405
public sealed class CE21FinalFurlong(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
