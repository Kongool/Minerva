...
namespace Minerva.Shadowbringers.Foray.TheDalriada.DAL04thLegionColossusRubricatus;
...
sealed class MagitekSlash(ModuleBase module) : Components.GenericRotatingAOE(module)
{
...
sealed class CeruleumVent(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.CeruleumVent);

sealed class DAL04thLegionColossusRubricatusStates : StateMachineBuilder
{
    public DAL04thLegionColossusRubricatusStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.TheDalriada, GroupID = 778u, CFCID = 778u, NameID = 9432u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "The Combat Reborn Team (Malediktus) (ported from BMR)")]
public sealed class DAL04thLegionColossusRubricatus(WorldState ws, Actor primary) : ModuleBase(ws, primary, arena.Center, arena)
{
