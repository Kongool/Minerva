...
sealed class MobileHaloCrossray(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnCastStarted(Actor caster, ActorCastInfo spell)
    {
        ...
        if (shape != null)
        {
            ...
            _aoe = [new(shape, (Center + dir).Quantized(), default, Module.CastFinishAt(spell, 2.1d))];
        }
    }
