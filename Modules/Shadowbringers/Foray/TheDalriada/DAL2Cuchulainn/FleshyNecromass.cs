...
sealed class FleshNecromass(ModuleBase module) : Components.GenericAOEs(module)
{
...
sealed class FleshNecromassJumps(ModuleBase module) : Components.GenericAOEs(module)
{
    ...
    public override void OnEventCast(Actor caster, ActorCastEvent spell)
    {
        ...
        if (id is (uint)AID.FleshyNecromassJump1 or (uint)AID.FleshyNecromassJump2)
        {
            ...
            _aoe = [new(circle, spell.TargetXZ, default, World.FutureTime(1d))];
        }
