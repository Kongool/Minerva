...
namespace Minerva.Shadowbringers.Raid.E05Ramuh.E05Ramuh;
...
sealed class CripplingBlow(ModuleBase module) : Components.SingleTargetCast(module, (uint)AID.CripplingBlow);
sealed class Impact(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Impact, 3f);
sealed class JudgmentJolt(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.JudgmentJolt, 22f);
sealed class JudgmentVolts(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.JudgmentVolts);
sealed class DivineJudgmentVolts(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.DivineJudgmentVolts);
sealed class DeadlyDischarge(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.DeadlyDischarge, new AOEShapeRect(40f, 4f))
{
...
sealed class DeadlyDischargeKnockback(ModuleBase module) : Components.SimpleKnockbacks(module, (uint)AID.DeadlyDischarge, 10f)
{
...
sealed class Gallop(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.Gallop, new AOEShapeRect(50f, 2.5f));
sealed class ShockStrike(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.ShockStrike, 3f);
sealed class VoltStrike(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.VoltStrike, 5f);
sealed class Stormcloud(ModuleBase module) : Components.Voidzone(module, 8f, GetVoidzones)
{
...
sealed class SurgeOrb(ModuleBase module) : ModuleComponent(module)
{
...
{
    public RamuhStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(CFCID = 715u, NameID = 9281u, PrimaryActorOID = (uint)OID.Ramuh, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "gynorhino (ported from BMR)")]
public sealed class Ramuh(WorldState ws, Actor primary) : ModuleBase(ws, primary, new(100f, 100f), new ArenaBoundsRect(19.5f, 14.5f));
