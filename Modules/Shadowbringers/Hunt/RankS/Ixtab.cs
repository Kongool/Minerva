...
namespace Minerva.Shadowbringers.Hunt.RankS.Ixtab;
...
class DualCastTartareanFlameThunder(ModuleBase module) : Components.GenericAOEs(module)
{
...
class TartareanTwister(ModuleBase module) : Components.CastInterruptHint(module, (uint)AID.TartareanTwister);
class TartareanBlizzard(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.TartareanBlizzard, new AOEShapeCone(40f, 22.5f.Degrees()));
class TartareanQuake(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.TartareanQuake);

class TartareanAbyss(ModuleBase module) : Components.BaitAwayCast(module, (uint)AID.TartareanAbyss, 6f, tankbuster: true);

class TartareanFlare(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.TartareanFlare, 18f);
class TartareanMeteor(ModuleBase module) : Components.StackWithCastTargets(module, (uint)AID.TartareanMeteor, 10f, 8);
class ArchaicDualcast(ModuleBase module) : Components.CastHint(module, (uint)AID.ArchaicDualcast, "Preparing In/Out or Out/In AOE");

class Cryptcall(ModuleBase module) : Components.BaitAwayCast(module, (uint)AID.Cryptcall, new AOEShapeCone(38.24f, 60f.Degrees()))
{
...
class CryptcallHint(ModuleBase module) : Components.CastHint(module, (uint)AID.Cryptcall, "Cone reduces health to 1 + applies Doom");
...
{
    public IxtabStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.Hunt, CFCID = 0u, NameID = 8890u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Malediktus (ported from BMR)")]
