...
namespace Minerva.Shadowbringers.Hunt.RankA.Huracan;
...
sealed class SpringBreeze(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.SpringBreeze, new AOEShapeRect(80f, 5f));
sealed class SummerHeat(ModuleBase module) : Components.RaidwideCast(module, (uint)AID.SummerHeat);
...
{
    public HuracanStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.Hunt, CFCID = 0u, NameID = 8912u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Malediktus (ported from BMR)")]
