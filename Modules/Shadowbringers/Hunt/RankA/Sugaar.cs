...
namespace Minerva.Shadowbringers.Hunt.RankA.Sugaar;
...
class BodySlam(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.BodySlam, 11f);
class NumbingNoise(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.NumbingNoise, NumbingNoiseTailSnapRotating.ShapeNumbingNoise);
class TailSnap(ModuleBase module) : Components.SimpleAOEs(module, (uint)AID.TailSnap, NumbingNoiseTailSnapRotating.ShapeTailSnap);

class NumbingNoiseTailSnapRotating(ModuleBase module) : Components.GenericRotatingAOE(module)
{
...
class NumbingNoiseTailSnapAttract(ModuleBase module) : Components.GenericKnockback(module)
{
...
{
    public SugaarStates(ModuleBase module) : base(module)
    {
        TrivialPhase()
...
[ModuleInfo(Group = ModuleGroup.Hunt, CFCID = 0u, NameID = 8902u, PrimaryActorDeathEndsEncounter = true, Maturity = ModuleMaturity.WIP, Contributors = "Malediktus (ported from BMR)")]
